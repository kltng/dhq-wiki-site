...
In his WWW2012 presentation Stefan Gradmann raised the question **Thinking in the graph: will Digital Humanists ever do
                        so?**#gradmann2012#berners2001#cyganiak2014#berners2009#berners2010
...
Gradmann’s example of humanities materials in his talk are rather data-oriented
                    ...
                    on structured prosopography (see #bradley2004#pasin2015*digital humanities**the humanities**digital*
...
Our ideas here grow out of our work on the **Pliny**#pliny2009**Pliny****Pliny**
...
We offer this article, then, as a kind of thought piece about the connection
                    ...
                    discussion not so much 
                        about infrastructure but about
                            epistemological foundations#gradmann2012*the definitive**approach*
...
As we have said above, for most humanists it is probably true that the work of
                    ...
                    with the formal structures of systems like the Semantic Web. We have, in #Bradley2014a narrative prose
                        discourse*because*
                        imprecise and slippery#bodenhamer2008#louch1969#rüsen1987#Bradley2014
...
In contrast to this, however, as Guetzkow *et al***What is Originality in the
                        Humanities and the Social Sciences?**#guetzkow2004*new*perhaps*et al*
                        [h]umanists and historians
                            clearly privilege originality in approach#guetzkow2004
                        panelists described originality
                            ...
                            researcher (who is bringing a fresh
                                perspective#guetzkow2004*own*if*in part*
...
Work on the **Pliny**#pliny2009**Pliny***process***Pliny****Pliny****Pliny**thinking#bradley2012


Instead, then, of the **Pliny****Pliny****Pliny****Pliny**#gradmann2012**Pliny****Pliny**


Some of the early thinking that led to **Pliny**#bradley2003*could**et al***Scholarly Work in the Humanities**#brockman2001#blair2003#blair2004central but often hidden phase in
                        the transmission of knowledge#blair2004
...
A first lesson one finds in studies of what goes on in conventional scholarship
                    ...
                    of notetaking when he observes that reading was not a mere collection of datagenerates reactionssubsequently
                        describe or explain#lavagnino1997*taking**subsequently*
...
In this light we can see a problem with much of the current work on digital
                    ...
                    commentary to a text for teaching purposes (see discussion in this vein in #bessette2015#dean2015textual**Semantic Annotation**#grassi2013simple textsemantic
...
An early article about **Pliny**#bradley2008**Pliny***reading**exploring**developing**writing***Pliny**personal
                        space#bradley2012
...
Finally, when the time is right (and presumably after significantly more than 2
                    ...
                    were developed in the interpretation. Although **Pliny****Pliny**#bradley2009
...
In **Pliny****Pliny****Pliny****Pliny****Pliny**#bradley2012
...
One way to think about this process is as a gradual increase in structure: the
                        **Pliny****Pliny****Pliny**uses of space
                        for study#bradley2008*process**uses of space for
...
In each figure in this sequence we have deliberately named each stage to echo
                    some aspects of the language of **Scholarly
                        Primitives**#unsworth2000*annotating*#palmer2009
...
About annotations: in order to explore the annotation functions like those in
                    ...
                    ontology (#OA2013#sanderson2013#jackson2010**Pliny****Pliny**
...
The fragment labelled A*PDF object* (elsewhere defined as a subclass of a Pliny
                    ...
                    annotation, which is here an area on a page in the PDF file. We use the
                        fragment selector#sanderson2013`RelatesTo``RelatesTo`*reference types* that the user has defined, and is
...
First, as #bradley2008**Pliny**#cyganiak2014**subject predicate object**concept spacesannotation spaces*Visualisation* concept shown in Figure 7 is
...
First we can see in Figure 10 our **Pliny****semantic
                        annotation****DBPedia**#bradley2008**New Science,**
...
We built a prototype tool for this that suggests how this somewhat more radical
                    engagement with linked data and the Semantic Web might work: see [Figure 11](#figure11)**Pliny**
...
Having discussed the place of 2D space in the annotation parts of Pliny, we need
                    ...
                    (but others too: see the discussion in #bradley2008
...
First, work has been done in the area of teaching of mathematics to explore how
                    ...
                    example, #gravemeijer1999#lange2008**Personal Knowledge Models**#völkel2011#elleström2014#eide2015#nersessian2008
...
If one uses **Pliny***uses* example
                        ...
                        RDFS #brickley2014#OWL2012**Pliny****Pliny****Pliny**relationship types`subPredicate`**Pliny****Pliny**
...
Much of this work on **Pliny****Pliny**#brockman2001


One such model is CIDOC-CRM’s CRMInf (#CRMInf2015#doerr2011
...
One possible problem with the use of CRMInf to support writing in the
                        ...
                        approach would ever help a
                            literary critic make sense … of Shakespeare’s Sonnet 116#mueller2015#vanzundert2014tend to reason
                            abductively


As far as **Pliny****Pliny****Pliny****Augmentation**#engelbart1962*antecedents*, and his approach does
...
The issue of private vs public material has been worked on in connection with
                        ...
                        picture, beyond annotation alone, of **Pliny****Exploring the relationship
                            between personal and public annotations**#marshall2004#congleton2009#congleton2009
...
Not all Pliny’s materials are annotations, but nonetheless, we assume here
                        ...
                        public will be similar to that shown in the annotation studies. Hence, for
                            **Pliny****Pliny***named graphs* (see #carroll2004
...
One curious tension in RDF is that in a world of continued changing
                        ...
                        to them. RDF’s reification#nguyen2014


Of course, although **Pliny****Pliny****Pliny**


Changes in the Semantic Web over time is still a research topic. #khurana2012#davis2009#halpin2014*et al* explores evolving data in the context
                        of versioning of documents, borrowing ideas from software versioning systems
                        and content management systems such as VCS #vandesompel2010**Pliny***Pliny*, if properly
...
With this paper we hope to start some discussions about aspects of how the
                    ...
                    it turns out, although not originally conceived of in Semantic Web terms, **Pliny**graph part**Pliny**


**Pliny***process*thinking in the graph


In fact, we think that **Pliny****Pliny***also*


**Pliny****Pliny**#gradmann2012scholarly use of semantic technologybeyond emulation of
...
Nguyen, V.,
                    Bodenreider, O., Sheth A. **Don’t like RDF Reification?
                        Making Statements about Statements Using Singleton Property****Proceedings of the WWW ’14 conference**
