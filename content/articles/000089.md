...
In the decade since the Final Report was issued, a tremendous amount of
                    ...
                    work described above (textual studies,[W]hen
                        composition begins,#shelley1903inspiration is already on the decline, and the most
                        glorious poetry that has ever been communicated to the world is probably a
                        feeble shadow of the original conceptions of the poet.intentions#tanselle1989
                        Photocopying a manuscript book or a printed book
                            creates a new document, the latest in the series of attempted
                            reproductions of the work its text represents...#tanselle1989
...
The first phase of our project, which we have recently completed, has examined
                    ...
                    an unusual choice for a project concerned with digital preservation, but as #thibodeau2002
                        In order to preserve a digital object we must be able
                            to identify and retrieve all of its digital components#thibodeau2002pretty good
...
FRBR is, at first glance, a promising mechanism for representing this twisty
                    ...
                    discriminating among changes to the substance or content**Hamlet**#shakespeare1878#ledecky2000
...
In addition to defining the basic relationships between Group 1 entities
                    ...
                    relationships that may exist between Group 1 entities. [Table 1](#table01)[http://doom.wikia.com](http://doom.wikia.com)The
                        Rock
...
In the case of an electronic object, the complications proliferate almost
                    exponentially #renear2006Work,Expression,Manifestation,Item.xexamineManifestationsExpressions
...
The game's wide distribution and immense popularity in the early days of
                    ...
                    its structure to add new puzzles, monsters and territory. [Figure 1](#figure01)[^: The information in this figure is based on a listing of
                        ][Figure 1](#figure01)[^: It should be noted that the
...
This typology of changes highlights one of the unique features about interactive
                    ...
                    of a source code text
                        the modification of a work involves a significant
                            ...
                            viewed, for the purposes of this study, as a new work#ifla1997
...
A closer examination of some of the specific instances of the game ADVENTURE
                    ...
                    named advf4.77-03-11 and advdat.77-03-11. Research by #jerz2007[Table 2](#table02)
...
Our discussion so far has somewhat glossed over the fact that our hypothetical
                    ...
                    states that 
                        Inasmuch as the form of expression is an inherent
                            ...
                            another) result in the production of a new expression#ifla1997
...
This gives us at least some basis for considering the three versions of the game
                    ...
                    single work, as seen in [Figure 2](#figure02)
...
Unfortunately, an alternative in which we claim that all three source code
                    ...
                    entities in the FRBR model. [Figure 3](#figure03)#ifla1997
...
The description of computer games within the FRBR model provides a reasonably
                    ...
                    descriptive banner for the purposes of retrieval. As [Figure 1](#figure01)#svenonius2000modding[^: Modding refers to taking an
                        existing game and making mod][Figure 5](#figure05)[^: Image taken from http://www.fileplanet.com/31773/90004/section/DOOM-Series on Oc]
...
One final comment should be made about the FRBR model and its application to
                     ...
                     **W1** Franz Schubert's Trout quintet     *e1* the composer's
                     ...
                     #ifla1997[^: The language of FRBR with regards to Item/Group 2 entity
                       ]
...
Our work with ADVENTURE and other computer games, however, does highlight two
                    ...
                    As #smiraglia1992
                        Bibliographic families can be as complex as human,
                            ...
                            the same time#smiraglia1992#ifla1997#samuels1989
...
## Notes & References
                    ...
                    Renear, Allen**Is An XML Document a FRBR Manifestation or a FRBR
                        ...
                        Quebec, August 7-11, 2006.**2006[http://idealliance.org/papers/extreme/Proceedings/html/2006/Renear01/EML2006Renear01.html#tod0e5](http://conferences.idealliance.org/extreme/html/2006/Renear01/EML2006Renear01.html)
