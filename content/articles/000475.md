...
In a TED conference in 2009 Tim Berners-Lee gave a presentation entitled **The Year open data went worldwide**#bernerslee2010governments, scientists and institutionsLinked
...
Berners-Lee has a scientific background, so perhaps it was not surprising that he didn't seem
                ...
                motivation in the premise behind the workshop **Linked Data for
                    Digital Humanities**#nurmikkofuller2016**RDF and
                    Linked Open Data**#smith2017
...
**Digital Prosopography of the Roman Republic***VIAF*#viaf2010*Pelagios*#pelagios
...
*Linked*#bradley2017a**the People of Medieval
                        Scotland**#poms2014**Prosopography of Anglo-Saxon
                        England**#pase2016global graph#broughton1951**Real-Encyclopaedie der classischen
                        Altertumswissenschaft**#pauly1893#mouritsenetal2017[Bibliography](http://www.romanrepublic.ac.uk/bibliography/)
...
To take DPRR's materials in its relational database and to turn it into LOD
                    ...
                    Web too, in adapting the Resource Description Framework (RDF) #rdf2014the glue of the
                        data web#bizer2008four
                        rulespart of
                        a single global data space#bizeretal2009[O]ne of
                        the main driving forces for the Semantic web has always been the expression,
                        on the Web, of the vast amount of relational database information#bernerslee1998


In the online descriptive material I have provided about the DPRR RDF server #bradley2017b*d2rq*#d2rqnd*rdf4j*#rdf4j2017#bradley2017b[Using DPRR's RDF
...
- The server meets the Linked Data requirements outlined in #bizeretal2009
...
Although both DPRR's RDF server and browser-oriented search engine interact with
                    ...
                    comparison, [Figure 1](#figure01)**Person Search**
...
Contrast this with the front screen one sees (shown in [Figure 2](#figure02)query
...
Now let us turn our
                    ...
                    describe it in their 2009 article that was mentioned earlier: #bizeretal2009
...
For example, [http://romanrepublic.ac.uk/rdf/entity/Person/2072](http://romanrepublic.ac.uk/rdf/entity/Person/2072)[Figure 3](#figure03)*rdf4j*wrapper<subject> <predicate>
...
It is important to grasp the fact that DPRR's other non-RDF browser
                        oriented*also*[http://www.romanrepublic.ac.uk/person/2072/](http://www.romanrepublic.ac.uk/person/2072/)[Figure 4](#figure04)browser friendly
...
Although the RDF URI for Cicero's data caused the RDF server to respond with the
                    ...
                    the mechanisms recommended in the W3C's specification for RDF servers #speicheretal2015**application/rdf+xml***HTTP request header*formatrdf[http://romanrepublic.ac.uk/rdf/entity/Person/2072?format=rdf](http://romanrepublic.ac.uk/rdf/entity/Person/2072?format=rdf)[Figure 5](#figure05)
...
This pure RDF is perhaps even more difficult for a human reader to read (especially
                    ...
                    standard Turtle format #beckettetal2014
...
For example, Cicero is recorded in DPRR as having held a post of consul in the
                    year 66 BCE. This kind of assertion is what in DPRR is called a **Post Assertion**[http://romanrepublic.ac.uk/rdf/entity/PostAssertion/5439](http://romanrepublic.ac.uk/rdf/entity/PostAssertion/5439)[Figure 6](#figure06)*all*[http://romanrepublic.ac.uk/rdf/entity/Office/3](http://romanrepublic.ac.uk/rdf/entity/Office/3)[Figure 7](#figure07)ConsulshiphasOffice
...
In order to make good use of the different kinds of interconnected data that the
                    ...
                    what is there and how it is organised. This is a place where an
                        *rdf4j*types[http://romanrepublic.ac.uk/rdf/repositories/dprr/types](http://romanrepublic.ac.uk/rdf/repositories/dprr/types)[Figure 8](#figure08)
...
Clicking on, say, **vocab:SecondarySource****vocab:SecondarySource****vocab:SecondarySource**A
                        ...
                        and 21st century scholarship.[http://romanrepublic.ac.uk/rdf/entity/SecondarySource/1](http://romanrepublic.ac.uk/rdf/repositories/dprr/explore?resource=%3Chttp%3A%2F%2Fromanrepublic.ac.uk%2Frdf%2Fentity%2FSecondarySource%2F1%3E&limit_explore=100&show-datatypes=show-dataypes)[Figure 9](#figure09)**Broughton MRR
...
This kind of browsing through RDF data is typical of one of the main uses of the
                        *rdf4j**ontology*#owl2012Classes#bradley2017b[The DPRR Ontology](http://romanrepublic.ac.uk/rdf/doc/ontology.html)
...
Most of those people in the digital humanities who are currently working on the
                    challenges of LOD focus on work that is often described as enriching the
                        global graph*different***Pelagios**#pelagios**SNAP-DRGN**#snapdrgnenriching the global graph


Berners-Lee's first conception of the Semantic Web was described in the early
                    2001 **Scientific American****The Semantic Web**#bernersleeetal2001


#bernersleeetal2001Heterogeneous
                        Datasets#freitasetal2012intuitive user


Consider Google as an example of an existing service which is also conceived of
                    as serving an intuitive user*et al*#noyetal2019
...
Freitas *et al*structured querycrispcrispnessprecise answers#freitasetal2012*et al*crispprecise
...
The SPARQL query presented here in this article is given in the context of an
                    ...
                    receive the result. To do so, push the Execute[here](#figure10)
...
(A screen capture of the beginning of the display generated by the query
                            is shown in the appendix as [Figure 11](#figure11)
                        ...
                        technical skills needed to interact with the data directly, is
                            *exactly*user friendly
                            One is User Experience (UX) based. The assumption behind much UX
                                ...
                                principle [d]on't make me think#krug2014semantic juiceThe second reason is that the results have to also be presented in
...
(A screen capture of the beginning of the display generated by this
                                query is shown in the appendix as [Figure 12](#figure12)
...
I also have received news recently of an example of DPRR's RDF data working
                        ...
                        at #johansonetal2019[http://hvwc.etc.ucla.edu/funerals-rostra](http://hvwc.etc.ucla.edu/funerals-rostra)[the Shape of Roman History](https://dh-199-the-shape-of-roman-history.github.io/)
...
Finally, Berners-Lee's TED talk shows that, as in his water plant example, it
                        ...
                        contemporary data could have contemporary *political**is*#guetzkowetal2004**What is Originality
...
The representation of historical materials as data (rather than text) and the
                        ...
                        misuse) of statistics in the *Time on the Cross*#fogelandengerman1974#wiess2001a book that has not been ignored**People of Medieval Scotland****Prosopography of Anglo-Saxon
                            England**
...
Furthermore, recent work with data in a sister data-oriented prosopography
                        ...
                        Leverhulme Trust, the data *behind*#hammondandjackson2017#sql2018
...
As mentioned earlier, most of those people in the digital humanities who are
                    ...
                    described as enriching the global graph*different*aggregationSameAs`owl:sameAs`#viaf2010Virtual International
                        ...
                        making that information available on the Web[https://viaf.org/viaf/78769600/](https://viaf.org/viaf/78769600/)`owl:sameAs`[http://romanrepublic.ac.uk/rdf/entity/Person/2072](http://romanrepublic.ac.uk/rdf/entity/Person/2072)#worldcat
...
Much of the work done in the DH that involves linking to authorities like VIAF
                    ...
                    not from a *text*#seaborneetal2013AAA
...
So far in this section we have focused on DPRR's historic persons as the centre
                    ...
                    called *provinces***Pelagios**#pelagios
...
King's Digital Lab (KDL) is now the unit at King's responsible for hosting most
                    ...
                    development: see [this
                        KDL web page](https://www.kdl.kcl.ac.uk/our-work/archiving-sustainability/)#smithiesetal2019
