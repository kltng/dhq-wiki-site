...
The processing of sign languages usually involves requires a form of textual
          representation #dreuw2008#johnston2010
...
Recent developments in sign language recognition illustrate the advantages of machine and
          deep learning for tasks related to recognition and classification #agha2018#cao2017#pigou2015


Additionally, current approaches in sign language automatic annotation need manual
          annotation of the hands and body joints for the training of the recognizer models #aitpayev2016#dreuw2008#kumar2017#pigou2015
...
In this study, a pre-trained deep learning pose estimation library developed by Cao et
          al. #cao2017#andriluka2014#lin2014
...
An additional motivation behind Sign Language Recognition (SLR) is to build automatic
            ...
            the deaf and hearing community #fang2004#kelly2009


There are numerous studies dealing with the automated recognition of sign languages as
            clearly presented by Cooper et al. #cooper2007#aitpayev2016#pigou2015#zhang2013


Recently, computer vision techniques have been applied to sign language recognition to
            overcome the aforementioned limitations. Roussos et al. #roussos2012#cooper2007#buehler2009#cooper2007#farhadi2007#starner1998
...
Human pose estimation has been extensively studied due to its numerous applications on
            a number of different fields #moeslund2006#felzenszwalb2005#ramanan2007#sivic2006#eichner2009#eichner2012#johnson2009#sapp2010#felzenszwalb2005#yang2011#charles2014


In general, most of the vision-based approaches developed for sign language recognition
            tasks utilizing pose estimation, have used the RWTH-PHOENIX-Weather data set #forster2012
...
OpenPose is a real-time, open-source library for academic purposes for multi-person
              2D pose estimation. It can detect body, foot, hand and facial keypoints #cao2017
...
The first tool is a temporal segmentation method to predict the begin and end frames of
            ...
            applications #agha2018Area under the Receiver Operating Characteristic (ROC)
...
Since the output of OpenPose contains the raw x, y pixel positions for the different
              ...
              location is at the origin. [Figure 1](#figure01)#pedregosa2011#chollet2015
...
All classifiers performed adequately well, apart from the Support Vector Machines (AUC:
            0.80) ([Table 1](#table01)[^: eta: 0.23, gamma: 3, lambda: 2, max. delta step: 4,
              max. depth: 37][Figure 2](#figure02)[Table 2](#table02)
...
Once all the frames have been classified, the "cleaning up" and annotation phase
            ...
            the stage for the annotation step. Using the PyMpi python library #lubbers2013#sloetjes2008[Figure 3](#figure03)
...
In order to understand the distribution of the different handshapes presented in a
            ...
            joint coordinates for all the frames at once ([Figure 7a](#figure07)[Figure 7b](#figure07)[Figure 7c](#figure07)
...
The most striking observation to emerge from our methodology is that there is no
          ...
          using neural networks for sign language recognition #aitpayev2016#pigou2015#zhang2013
