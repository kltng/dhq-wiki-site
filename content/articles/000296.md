...
that goes beyond simple lookup*exploration*
...
respectively denote the Dirichlet and multinomial distribution (see*η **α**β **k* is defined as a probability distribution over the
...
account. These include e.g. the Author-Topic model-zvi2005*d*s) and a topic-term matrix
...
quality of the models' results is a research field on its own (e.g.,-graber2009

### Related Work

Traditional linguistic approaches such as the vector space model

Closely related to our approach is that of*and*snyder2013
...
words' relevances using a tf-idf
...
Stasi. Die geheimen Berichte an die SED-Führung **[^: Literally,
Stasi abbreviates STAatsSIcherheit, i.e. ][^: see http://www.textcreationpartnership.org/tcp-ecco/][^: http://www.openwalnut.org][^: http://neuro.debian.net/][^: https://www.virtualbox.org/]
