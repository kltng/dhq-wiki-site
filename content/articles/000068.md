...
Information seems to be essential for our lives. Humans get information everywhere,
               ...
               Internet is a mine**Semantic Web****RDF****OWL**#stevens2000#farrar2002#gomez2004#lungen2007#renear2006#smith2007
...
There are some criticisms of ontologies #veltman2004#shirky2005
...
Since their initiation in philosophy, ontologies, with their methods of subsumption
               ...
               information about an ontology can be obtained using logic reasoning #baader2003a#noy2003
...
In Section 2.1, an introduction to ontologies, especially the way they are used in
               ...
               characters and the application of logic reasoning to this ontology is presented #zw2006a**Racer****Prolog****Racer****Prolog**
...
The term ontology, which originates from philosophy and contains the study of
                  being or existence in general, was introduced by Aristotle #pl1991What
                     is existence?
                     An ontology is a formal, explicit
                        specification of a shared conceptualisation#gruber1993domain
                     An ontology defines a common vocabulary
                        for researchers who need to share information in a domain#noy2001#noy2001**Web Ontology Language****Resource Description Framework Schema**#antoniou2003#ziegler2004
...
Briefly, several theories of literary characters #jannidis2004#nieragden1995#zw2006b#jannidis2004#propp1968#greimas1971[Figure 1](#figure01)#zw2006a#zw2006b
...
In general, conclusions drawn from logic reasoning can be inferred from given
                  ...
                  conclusion. The methods induction #charniak1985#charniak1985
...
Logic reasoning is one possible application for ontologies. It is probably helpful
                  ...
                  ontology and in the phase of using it #baader2003a
...
Especially in the humanities, where textual data is often crucial, applications
                  ...
                  terms contained in both sources, in text annotations/web pages and an ontology
                     #baader2003a#puppe2000#benjamins1999
...
In addition, the human user should be focused when testing logic reasoning. In
                  ...
                  similar to the queries given in linguistic approaches #lungen2007
...
The ontology used in this contribution was implemented in **OWL
                     Description Logic**#antoniou2003**Description
                     Logic****TBox****ABox**[Figure 2](#figure02)


As Nardi and Brachman explain, these methods are usually a variant of first-order
                  predicate calculus (cf. #nardi2003#tsarkov2006#sirin2007#haarslev2004[http://​www.swi-prolog.org/](http://www.swi-prolog.org/)
...
Here, we investigate whether Racer (**Renamed ABox and
                        Concept Expression Reasoner Professional**#racer2005
...
According to the concepts of an ABox and TBox in DL, the classes and
                     individuals are presented and inferred separately (cf. [Figure 3](#figure03)**nRQL**#racer2005#haarslev2004
...
Another possibility for drawing inferences is to use a programming language
                     ...
                     predicate calculus #fisher2006Prolog fact base
...
As mentioned, an ontology consists of a set of objects, concepts, and further
               entities, which are related to each other #noy1997#noy2001#nieragden1995
...
In principle, drawing inferences can retrieve implicit and hidden information. The
               ...
               cannot be expressed in logical terms #berthold2003#zw2008#cimiano2006
...
More generally, when comparing literature studies and computer systems, one has to
               ...
               in machine-to-machine learning #veltman2004#mccarty2005#shirky2005
...
Both offer options to draw inferences, but the usage requests a good comprehension of
               ...
               analysis, other approaches are more suitable (for example #meister1999**Tractatus**#zw2007b
...
At the moment, to the author’s knowledge, only few such approaches, especially in
               ...
               demonstrated to its limits. Existing approaches (for example #farrar2002#lungen2007#zw2006b
...
| Querying hierarchies: | rdf_has(SUBCLASS,'http://www.w3.org/2000/01/rdf-schema#subClassOf',SUPERCLASS),
...
| Query for sibling classes: | rdf_has(SUBCLASS1,'http://www.w3.org/2000/01/rdf-schema#subClassOf',SUPERCLASS),
