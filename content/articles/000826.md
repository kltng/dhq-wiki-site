...
In 2022, with the increasing centrality of global optimization algorithms such as the
               ...
               intelligence is described, for example, as a black boxnever know#kemper_2019
...
This paper will examine the early history of code as the history of the repression of
               ...
               critical code studies #marino_2020#marino_2014
...
Critical code studies is particularly well suited to the analysis of ideology, the
               ...
               studies #montfort_2009#fuller_2008*ideological*
...
This procedural episteme provided the basis for the formation of code, but
               ...
               was stored #heide_2009#campbell-kelly_2014#ibm_1956
...
In analogy to the parallel divide and conquer approach of a group of human computers,
               ...
               devices transmitting numerical constants. These were programmed**master programmer**#haigh_2016#haigh_2016
...
Because at the time an electronic computer could operate at a speed beyond the
               ...
               choices #eckert_1945objectivity
...
This self-modifying coding system was never implemented, but it appears in John von
               Neumann’s **First Draft of a Report on the EDVAC**#von-neumann_1993**First
...
> A further necessary operation is connected with the need to be able to sense the
               ...
               second one of two given numbers,
                  \(u\)\(v\)\(x\)\(y\)\(u\)\(v\)forms\(u\)\(x ≥ y\)forms\(v\)#von-neumann_1993
...
In the first actual implementation of this coding scheme, a conditional branch
               instruction was used instead of a conditional substitution #clippinger_1948#wilkes_1951
...
It is important to pause here and emphasize that while code, state, and information
               ...
               instantiation, this is nevertheless still a form of representation#hayles_2005*almost* obviate any need to attend to that
...
At the start of the modern code paradigm, the branch address is explicit and
               machinic. Hence, the EDSAC code accomplishes the branch with an instruction, `E 106``106`#wilkes_1951[^: As one writer
...
With the A programming languages and Fortran, this address is transformed into a
               ...
               #hopper_1955acompilepseudo-instruction#hopper_1955a#hopper_1955b`1CN 000 000 002``002`
...
While the A-2 addressing system distances the code from the peculiarities of the
               ...
               #sammet_1969#backus_1979#ibm_1954*symbolic*
...
In the transition from the machinic addresses of the EDSAC to the conditional block
               ...
               Considered Harmful**#dijkstra_1968to shorten the conceptual gap between
               ...
               possible#dijkstra_1968our
               intellectual powers#dijkstra_1968`GO TO`
...
But in adapting the practice of programming to grammatical structure, the web of
               ...
               relationship between code and state variables**structured program theorem**#bohm_1966textual place in the codestate variables


This can be clearly seen in one of Dijkstra’s own examples. Dijkstra presents two
               programs which test each member of two collections for equality #dijkstra_1970
...
In this moment (2022), it seems that the most powerful agents within the field of
               ...
               of our daily experience #pasquale_2015*possibility* for the responsibility
