...
Optical Character Recognition, or OCR, is a ubiquitous element of intellectual
                    ...
                    machine-readable type. Defined on Wikipedia as the
                        ...
                        into machine-encoded text,#wikipedia2015


Dirty OCR[Table 1](#table01)noisiness
                        Dirty OCR of facsimile pages of historical documents taken from
                            ...
                            Title page to an 1823 edition of **Gulliver’s Travels**full text#swift1823Blank page opposite the title page to a 1780 edition of John
                                Milton’s Areopagitica, with accompanying full
                                    text#blackburne1780Title page from the **Remarks on Johnson’s life
                                    of Milton**full
                                    text#blackburne1780
...
Imperfect OCR output can have consequences for corpus analytics, affecting
                    ...
                    considered using OCR output for their study, but found that The issues of OCR accuracy and a lack of disclosure about accuracy
                        rates#lorang2012#eder2012good enough
...
Dirty OCR can also affect other kinds of reading. A student searching for the
                    ...
                    Here, for example, is a page from a French edition of the **Annales de Domingo Francisco de San Anton Muñon Chimalpahin
                        ...
                        o — M r^ -^ v^SO |>»00 Cv O — « r^ -«t- «^\o r-^oo
                            Oso — r^ #chimalpahin1889**New York
                        Tribune**
                        reading and comprehending the text from the OCR
                            transcription alone is practically impossible#lorang2012
...
This paper offers a close analysis of dirty OCR: that frustrating gibberish that
                    ...
                    printed texts. It takes as a predecessor Whitney Anne Trettien’s **A Deep History of Electronic Textuality,****Areopagitica**#trettien2013**Primeros
...
In these moments, the methods of close reading modeled by N. Katherine Hayles and
                    ...
                    transcription #hayles2002#kirschenbaum2012
...
This article addresses this mandate by seeking to push against the reduction of
                    ...
                    by the #DHPOCO movement spearheaded by Roopika Risam and Adeline Koh, which 
                        brings critiques of colonialism, imperialism, and
                            ...
                            and disability to bear on the digital humanities#risam2012
...
Absent from the method applied in this paper is collaborative work with the
                    ...
                    preliminary efforts to apply it to printed books.[^: Since this article was
                        composed, the OCR prototype descr]#christen2012
...
This article takes as a case study Ocular, an OCR tool developed by Taylor
                    ...
                    documents #berg-kirkpatrick2013**Primeros Libros****Primeros Libros****Primeros Libros**


#### The Primeros Libros Collection


The **Primeros Libros****Primeros Libros**#mcdonough2014**Primeros Libros**
...
The two books that will be featured as examples in this article both center
                        on indigenous language, culture, and history, though in different ways. The
                            **Advertencias para los confessores de los
                            ...
                            Cruz****Advertencias****Sermonario**#christensen2013[^: For more about the
                                Advertencias, refer to Mark
 ]


The second book featured in this study is Antonio Rincón’s **Arte Mexicana.****Arte Mexicana**[^: The
                            other two are Andrés de Olmos’ Arte para aprende]#mignolo1995The
...
We chose Ocular as our preferred tool for transcribing the **Primeros Libros**[^: This article does not consider other
                            prominent OCR s]font model,language model,#berg-kirkpatrick2013
...
Ocular is uniquely effective because it pays particular attention to the
                        ...
                        example, in a passage from Rincón’s **Arte
                            ...
                            verbos que ſignifican quietud o mouimiẽto v.g. *ni
                                tetlaçotlatica*, eſtoy amando, *nitetlaçotlatiuitz*. vengo amando…#rincón1595[^: The gerund, endo, is also used in two ways. The
                                ]
...
Like language usage, sixteenth-century orthography was not consistent even
                        ...
                        for a single word, including common letter substitutions (a uv**Primeros
                            Libros****Natural
                            Language Processing for Historical Texts**#piotrowski2012
...
To handle these challenges, we modified Ocular by developing a multilingual
                        ...
                        can be found in the **Proceedings of NAACL 2015**#garrette2015[^: A technical discussion of further
                            modifications to O]
...
Most histories of OCR begin in the nineteenth century, when innovators in the
                    ...
                    what Mara Mills, in her important work on OCR, describes as the assistive pretext#mills2013#schantz1982
...
Transcription has long played an essential role in the reproduction of texts, and
                    ...
                    of antiquity #ehrman2012#wakelin2014
...
Some of this practice was carried into early colonial Spain, where indigenous
                    ...
                    Baird has written in the case of the pictorial transcriptions, 
                        The artists’ own history and their life in the present
                            ...
                            manner in which they chose to represent it#baird1993**Primeros Libros**
                        blended, composite agency#burns2010
...
In colonial Mexico transcription existed alongside the printing press, rather
                    ...
                    copies, such as Carlos María de Bustamante’s 1830 edition of Sahagún’s **Historia general****Historia
                        de los Indios de la Nueva España**#bustamante1830#icazbalceta1858
...
Today, OCR requires neither the presence of a written document (a page, an
                    ...
                    the process, human readers disappear entirely #schantz1982#google2016#aytes2013#wen2014
...
Importantly, the goal in this section is not to prove machine-learning systems
                    like Ocular aren’t neutral. As recent reports in popular media about biased algorithms#angwin2016#cainmiller2015#oneill2016**Primeros Libros****Primeros
                        Libros**
...
As the brief history of the **Primeros Libros**h#lockhart2001


Facsimile image of a page from the Advertencias #bautista1600
...
Consider, for example, the facsimile shown in Figure 1. This page from
                        ...
                        which signifies *todas tres personas son el
                            ...
                            This amphibology does not exist in Latin because
                                the ending [of the word] is different#bautista1600
...
The process of automatic transcription can pose a translation problem that is
                        ...
                        is a simple n-gram model based on language data[Table 2](#table02)**Advertencias**
...
A closer consideration of the Nahuatl case shows how this homogenization or
                        ...
                        it sought to reflect the styles of the original documents #lockhart2001qz,jelly**Primeros Libros**
...
In this case, the decision to draw on Lockhart’s documentation in our
                        ...
                        Lockhart writes, 
                            when left to themselves […] Nahua writers had a
                                ...
                                borders#lockhart2001hnm**Primeros
                            Libros**
...
This preference for the ultra-diplomatic model was not always duplicated by
                        ...
                        form of a table of results, summarized in Table 4 #garrette2015
...
Our results show an improvement over Ocular, which in turn showed an
                        improvement over Tesseract, Google’s popular and freely available OCR tool
                            #berg-kirkpatrick2013progressive momentum**Digital
                            Humanities Quarterly**
                            the digital humanities domain reflects the
                                non-progressiveness of the humanities disciplines#flanders2009
...
This effect is compounded when we consider the history of the Nahuatl
                        ...
                        standard, such that one Franciscan was able to remark 
                            the Mexican language lacks seven letters#mignolo1995
...
There are several ways that language tagging can open new interpretive
                    ...
                    each of these forms of analysis expects a monolingual corpus #piotrowski2012
