...
title: "Seeking Information
               in Spanish Historical Newspapers: The Case of"
id: 000735
authors: ["Eva Sánchez-Salido", "Antonio Menta", "Ana García-Serrano"]
volume: 017
issue: 4
date: 2024-02-07
type: article
keywords: ["#nlp", "#information_retrieval", "#machine_learning", "#transcription", "#digitization", "#history"]
author_keywords: []
language: en
word_count: 10494
source: raw/articles/000735.xml
---
...
**Volume 017, Issue 4** (2024-02-07) | article | 10,494 words
...
Corpora construction is a laborious task (#gruszczynski_etal2021#ruizfaboetal2017#wissleretal2014#davies_parodi2022#gebruetal2021#torruellacasanas2017#aldamaetal2022#nakayama2021#calvotello2019#kabatek2013#rojo2010


Corpus-based research has been dominated by statistical and neural models (#morenosandoval2019#nieuwenhuijsen2016#rojo2016#vaswanietal2017#grishman_sundheim1996
...
Early NER systems made use of algorithms based on hand-built rules, lexicons and
               ...
               producing domain-specific resources that this entails #lietal2022#nadeau_sekine2007#bikeletal1997#asahara_matsumoto2003#mccallum_li2003#borthwicketal1998#sekine1998


Starting with #collobert_etal2011#yadav_bethard2018#lampleetal2016#akbik_blythe_vollgraf2018**Attention Is All You
                  Need**#vaswanietal2017#devlin_etal2019#liuetal2019[^: https://www.bne.es/es/noticias/1111-el-primer-sistema-masivo-de-inteligencia-art][^: https://www.iic.uam.es/inteligencia-artificial/procesamiento-del-lenguaje-natura]


In the domain of Digital Humanities (DH), applying NER models to historical documents
               poses several challenges, as shown by other works in the domain (#chastang_torresaguilar_tannier2021#kettunenetal2017#piotrowski2012#terras2011#borosetal2020
...
Another challenge is related to the transfer of knowledge to new domains or
               ...
               languages to old languages (#baptisteetal2021#bollmann2019#detoni_etal2022#hintz_biemann2016#pruksachatkunetal2020#zophetal2016#blouinetal2021#rubinstein_shmidman2021


Recent initiatives have been launched, such as the creation and annotation of
               datasets (#ehrmannetal2022#neudecker2016**Identifying Historical
                  People, Places and other Entities**#ehrmannetal2020a#rivero2022#merinorecalde2022#garcia-serrano_castellanos2016#calle-gomez_garcia-serrano_martinez2006
...
This paper is organized starting with a section dedicated to the corpus creation,
               ...
               HIPE2020 corpus containing historical OCR texts in French, English and German #ehrmannetal2020b


### 2. Creation of the corpus CLARA-DM


A major goal of the CLARA-HD[^: CLARA-HD project (PID2020-116001RB-C32) is funded
                  by MCIN - AE][^: https://impresso-project.ch]#molinamartin2021#camara_molina_vazquez2020#molina_vega2018#menta_garcia-serrano2022#sanchez-salido2022#menta_sanchez-salido_garcia-serrano2022#garcia-serrano_menta-garuz2022#campillos-llanosetal2022#morenosandovaletal2018
...
The starting point of the CLARA-HD project was the analysis of the art historians’
               interest in the digitized collection of newspapers called **Diario
                  de Madrid**[^: https://hemerotecadigital.bne.es/hd/card?oid=0001510462]
...
There are different tools to deal with any process in corpus management, from the
               ...
               we use Transkribus[^: https://readcoop.eu/transkribus][^: https://tagtog.com][^: https://huggingface.co]
...
The first step building the corpus is the transcription of the texts, which we
                  carried out using the Transkribus tool #menta_sanchez-salido_garcia-serrano2022[^: https://aws.amazon.com/es/textract][^: https://github.com/tesseract-ocr/tesseract]#kirmizialtin_wrisley2022#arandagarcia2022#ayusogarcia2022#bazzacoetal2022#alrasheed_rao_grieco2021#derrick2019#perdiki2022
...
Once we have carried out the structure recognition of the newspaper pages, the
                  ...
                  text with some quality. The "Spanish Golden Age Theatre Prints 1.0" model (#cuellar_vegagarcia-luengos2021#cuellar2021[^: https://readcoop.eu/transkribus/howto/how-to-transcribe-documents-with-transkrib]
...
We carried out several tests. In the first one we trained the model with 37
                  ...
                  to ours[^: See German Fraktur 19th-20th century
                        (https://readcoop.e]
...
![Hardcopy of an original page (left) and its automatic transcription with
                     CLARA-TM (right).](resources/images/figure01.png)


The human and computational resources spent for the development of our
                  ...
                  published (January 2023) for free use at the Transkribus tool and website[^: https://readcoop.eu/model/spanish-print-xviii-xix]
...
Once we have the transcribed corpus, we can move on to the manual annotation step,
                  ...
                  to carry out the task of manual annotation first to teach#rojo2010


To decide which annotation tool to use, an evaluation was made between four
                  current leading annotation tools: Prodigy[^: https://prodi.gy][^: https://doccano.herokuapp.com][^: http://brat.nlplab.org][^: https://www.tagtog.com/]

|  | Prodigy | Doccano | Brat | Tagtog |
| --- | --- | --- | --- | --- |
| General functionalities | tagging text, images and videos and train models with the tagged
                        data | text classification, sequence labelling, sequence-to-sequence
                        tasks | entity and relationship annotation, lookups and other NLP derived
                        tasks | entity and relationship annotation, document classification |
...
The process of the manual annotation of a corpus involves the construction of an
                     annotation guideline#campillos-llanosetal2021#morenosandovaletal2018
...
![Inter-Annotator Agreement for Person entity class automatically calculated
                     by the tool.](resources/images/figure02.png)


The first sub-corpus contains five newspapers with 28 pages, 928 sentences and
...
![Taxonomy of entities.](resources/images/figure03.jpeg)


Figure 4 shows an annotated text using the Tagtog tool that shares the colour
                  legend classes shown at Figure 3: **iglesia de san Luis***actores, coristas, bailarines*


![Tagtog tool: hardcopy of a manually annotated text (left) and an excerpt
                     codified in the IOB format (right).](resources/images/figure04.png)
...
- First, we experiment with the HIPE2020 dataset (notice that we can use the
                  ...
                  different labels than HIPE2020).
- In a similar approach, we then experiment with the CLARA-DM dataset. First, we
                  ...
                  and CLARA-DM datasets.
- Then we carry out a second evaluation step, in which we evaluate several
                  ...
                  guidelines to see the gain in performance.
...
The models used for the experiments are based on RoBERTa (monolingual) #liuetal2019[^: https://huggingface.co/xlm-roberta-base]#conneau_etal2020

- two Spanish: RoBERTa-BNE[^: https://huggingface.co/PlanTL-GOB-ES/roberta-base-bne]#gutierrez-fandinoetal2022[^: https://huggingface.co/bertin-project/bertin-roberta-base-spanish]#delarosa_etal2022
- one English: DistilRoBERTa[^: https://huggingface.co/distilroberta-base]#sanhetal2019
- one French: DistilCamemBERT[^: https://huggingface.co/cmarkea/distilcamembert-base]#delestre_amar2022
- one German: GottBERT[^: https://huggingface.co/uklfr/gottbert-base]#scheibleetal2020


On the other hand, we use models that have been trained for a general set of NER
               tags:

- one monolingual for Spanish: RoBERTa-BNE-NER-CAPITEL[^: https://huggingface.co/PlanTL-GOB-ES/roberta-base-bne-capitel-ner]
- and two multilingual ones, one for Spanish (XLM-RoBERTa-NER-Spanish[^: https://huggingface.co/MMG/xlm-roberta-large-ner-spanish][^: https://huggingface.co/Davlan/xlm-roberta-base-ner-hrl]
...
2) As the CLARA-DM dataset uses its specific set of tags, different from the HIPE2020
               ...
               few-shot learning set-up. Some experiments use the CAPITEL dataset[^: https://sites.google.com/view/capitel2020]
...
The HIPE2020 (**Identifying Historical People, Places and other
                     Entities**#ehrmannetal2020b#ehrmannetal2020c#rosset_grouin_zweigenbaum2011
...
The first experiments consist of fine-tuning on the HIPE2020 dataset. When
                     ...
                     configured. The number of epochsbatch sizelearning rate
...
The model is first evaluated on HIPE2020 without training (the so-called
...
With the insights we have extracted from the results of previous experiments, we
                  ...
                  the majority vote method. After a pre-processing phase carried out using the spaCy[^: https://spacy.io]
...
The distribution of the tags in these documents is shown in Table 4. The class
...
We find that in both cases the monolingual models are slightly better. In the
...
Even if we consider the corpus very small in comparison with the HIPE2020 one,
...
This is the only case in which the performance of monolingual and multilingual
                     ...
                     domains. CAPITEL[^: https://plantl.mineco.gob.es/tecnologias-lenguaje/comunicacion-formacion/eventos]
...
- in Table 5, the tags for the experiment XLM-R-ner-spanish are general
                        ...
                        location, organization and others (in BIOES format instead of BIO),
- in Table 6 all the experiments have the labels of HIPE2020, except for
                        RoBERTa-bne-ner-capitel-fr, which has those of CAPITEL,
- in Table 7 the labels are those of CLARA-DM and
- in Table 8 the labels are those of HIPE2020 or CAPITEL, whichever comes
                        first.
...
Comparing this performance with that obtained when only training with CLARA-DM
...
In Tagtog, when several users annotate the same document, as a result, there are
                  ...
                  promotes a version to master) or automatic[^: https://docs.tagtog.com/collaboration.html#automatic-adjudication]
...
With RoBERTa-BNE model the F1 measure improves from 0.46 to 0.52, accuracy from
...
##### 3.4.2. Progress of annotation guidelines and availability of more training
                     data
...
![Final label taxonomy for CLARA-DM.](resources/images/figure05.jpeg)


In intermediate steps, some different ways of labelling were evaluated. For
                     example, at some point we agreed to annotate the profession of a person within
                     the person**Sr. D. Josef de la Cruz y Loyola, Gobernador de dicho Real
                        Sitio**
...
While the results of the first fine-tuning had a performance of around 50% in
...
If we take a look at the performance per entity class as in Table 13, one
...
- **Digitization:** The first step is to digitize the historical
                  ...
                  this work.
- **Optical Character Recognition (OCR):** Once the documents
                  ...
                  Transkribus to obtain the text.
- **Annotation guidelines:** The initial stage in training a NER
                  ...
                  recognize.
- **Annotation:** The entities to be recognized by the NER
...
- **Training the model:** The final step is to train a named
                  ...
                  the model several times with different hyperparameters.
- **Evaluation:** The performance of the NER process should be
                  evaluated using appropriate metrics such as precision, recall, and F1-score. This
                  helps to identify areas for improvement and guide future work.
...
This work has been supported by the Spanish Government and funded under the CLARA-HD
               project (PID2020-116001RB-C32, [https://clara-nlp.uned.es/home/dh/](https://clara-nlp.uned.es/home/dh/)


We would like to acknowledge the support of the UNED art history professors Álvaro
               Molina and Alicia Cámara, research directors of the CARCEM[^: https://dimh.hypotheses.org/author/dimh]
...
Two essential stages in deep learning are pre-training and training/fine-tuning.
               ...
               popular approach in Deep Learning called transfer learning (#malte_ratadiya2019#ruderetal2019
...
Akbik,
               A., Blythe, D., and Vollgraf, R. (2018) **Contextual String
                  Embeddings for Sequence Labeling****Proceedings of the
                  27th International Conference on Computational Linguistics**[https://aclanthology.org/C18-1139](https://aclanthology.org/C18-1139)
Aldama, N., Guerrero, M.,
               Montoro, H., and Samy, D. (2022) **Anotación de corpus
                  ...
                  (IIC)**
Alrasheed, N., Rao, P. and Grieco, V. (2021) **Character
                  Recognition Of Seventeenth-Century Spanish American Notary Records Using Deep
                  Learning****DHQ**[https://dhq.digitalhumanities.org/vol/15/4/000581/000581.html](https://dhq.digitalhumanities.org/vol/15/4/000581/000581.html)
Aranda García, N. (2022)
                  **Humanidades Digitales y literatura medieval española: La
                  integración de Transkribus en la base de datos COMEDIC****Historias Fingidas**[https://doi.org/10.13136/2284-2667/1107](https://doi.org/10.13136/2284-2667/1107)
Asahara, M., and
               Matsumoto, Y. (2003) **Japanese Named Entity Extraction with
                  Redundant Morphological Analysis****Proceedings of the
                  2003 Human Language Technology Conference of the North American Chapter of the
                  Association for Computational Linguistics**[https://aclanthology.org/N03-1002](https://aclanthology.org/N03-1002)
Ayuso García, M. (2022) **Las ediciones de Arnao Guillén de Brocar de BECLaR transcritas con
                  ayuda de Transkribus y OCR4all: Creación de un modelo para la red neuronal y
                  posible explotación de los resultados****Historias
                  Fingidas, 0**[https://doi.org/10.13136/2284-2667/1102](https://doi.org/10.13136/2284-2667/1102)
Baptiste, B., Favre, B.,
               Auguste, J., and Henriot, C. (2021) **Transferring Modern Named
                  Entity Recognition to the Historical Domain: How to Take the Step?****Workshop on Natural Language Processing for Digital Humanities
                  (NLP4DH)**[https://hal.archives-ouvertes.fr/hal-03550384](https://hal.archives-ouvertes.fr/hal-03550384)
Bazzaco, S., Ruiz, A. M. J.,
               Ruberte, Á. T., and Molares, M. M. (2022) **Sistemas de
                  ...
                  redonda (s. XV-XVII)****Historias Fingidas**[https://doi.org/10.13136/2284-2667/1190](https://doi.org/10.13136/2284-2667/1190)
Bikel, D. M., Miller, S.,
               Schwartz, R., and Weischedel, R. (1997) **Nymble: A
                  High-Performance Learning Name-finder****Fifth
                  Conference on Applied Natural Language Processing**[https://doi.org/10.3115/974557.974586](https://doi.org/10.3115/974557.974586)
Blouin, B., Favre, B., Auguste,
               J., & Henriot, C. (2021). Transferring Modern Named Entity Recognition to the
               Historical Domain: How to Take the Step? **Proceedings of the
                  Workshop on Natural Language Processing for Digital Humanities**[https://aclanthology.org/2021.nlp4dh-1.18](https://aclanthology.org/2021.nlp4dh-1.18)
Bollmann, M. (2019) **A Large-Scale Comparison of Historical Text Normalization
                  Systems.****Proceedings of the 2019 Conference of the North American Chapter
                  of the Association for Computational Linguistics: Human Language Technologies,
                  Volume 1 (Long and Short Papers)**[https://doi.org/10.18653/v1/N19-1389](https://doi.org/10.18653/v1/N19-1389)
Boros, E., Hamdi, A., Linhares
               Pontes, E., Cabrera-Diego, L. A., Moreno, J. G., Sidere, N., and Doucet, A. (2020)
                  **Alleviating Digitization Errors in Named Entity Recognition
                  for Historical Documents.****Proceedings of the 24th Conference on Computational Natural
                  Language Learning**[https://doi.org/10.18653/v1/2020.conll-1.35](https://doi.org/10.18653/v1/2020.conll-1.35)
Borthwick, A., Sterling,
               J., Agichtein, E., and Grishman, R. (1998). **NYU: Description of
                  the MENE Named Entity System as Used in MUC-7.****Seventh Message Understanding Conference (MUC-7): Proceedings of
                  a Conference Held in Fairfax, Virginia, April 29 - May 1, 1998**[https://aclanthology.org/M98-1018](https://aclanthology.org/M98-1018)
Calle-Gómez, Javier;
               García-Serrano, Ana and Martínez, Paloma. (2006). **Intentional
                  processing as a key for rational behaviour through Natural Interaction****Interacting With Computers**[10.1016/j.intcom.2006.05.002](https://doi.org/10.1016/j.intcom.2006.05.002)
Cámara, Alicia; Molina, Álvaro y Margarita A. Vázquez. (2020). Manassero (eds.).
                  **La ciudad de los saberes en la Edad Moderna**[http://e-spacio.uned.es/fez/view/bibliuned:404-Amolina-1011](http://e-spacio.uned.es/fez/view/bibliuned:404-Amolina-1011)
Calvo Tello, J. (2019). **Diseño de corpus literario para análisis cuantitativos.****Revista de Humanidades Digitales****4**[https://doi.org/10.5944/rhd.vol.4.2019.25187](https://doi.org/10.5944/rhd.vol.4.2019.25187)
Campillos-Llanos, L., Terroba Reinares, A. R., Zakhir Puig, S., Valverde-Mateos, A.,
               and Capllonch-Carrión, A. (2022) **Building a comparable corpus
                  and a benchmark for Spanish medical text simplification.****Proceedings of the Annual Conference of the Spanish Association
                  for Natural Language Processing 2022: Projects and Demonstrations (SEPLN-PD
                  2022)**
Campillos-Llanos, L., Valverde-Mateos, A., Capllonch-Carrión, A. et al. (2021)
                  **A clinical trials corpus annotated with UMLS entities to
                  enhance the access to evidence-based medicine.**[https://doi.org/10.1186/s12911-021-01395-z](https://doi.org/10.1186/s12911-021-01395-z)
Chastang, P., Torres Aguilar, S.,
               and Tannier, X. (2021). **A Named Entity Recognition Model for
                  Medieval Latin Charters.****DHQ**[https://dhq.digitalhumanities.org/vol/15/4/000574/000574.html](https://dhq.digitalhumanities.org/vol/15/4/000574/000574.html)
Collobert, R., Weston,
               J., Bottou, L., Karlen, M., Kavukcuoglu, K., and Kuksa, P. (2011) **Natural Language Processing (Almost) from Scratch.****Natural Language Processing**
Conneau, A., Khandelwal, K.,
               ...
               L., and Stoyanov, V. (2020) **Unsupervised Cross-lingual
                  Representation Learning at Scale**[http://arxiv.org/abs/1911.02116](http://arxiv.org/abs/1911.02116)
Cuéllar, Álvaro. (2021). **Spanish Golden Age Theatre Manuscripts (Spelling Modernization)
                  1.0**
Cuéllar, Álvaro and Vega García-Luengos,
               Germán. (2021) **ETSO. Estilometría aplicada al Teatro del Siglo
                  de Oro.**[etso.es](https://etso.es/)
Davies, M., and Parodi,
               G. (2022) **Constitución de corpus crecientes del español.****Lingüística de corpus en español**[https://doi.org/10.4324/9780429329296-3](https://doi.org/10.4324/9780429329296-3)
De la Rosa, J.,
               Ponferrada, E. G., Villegas, P., Salas, P. G. de P., Romero, M., and Grandury, M.
               (2022) **BERTIN: Efficient Pre-Training of a Spanish Language
                  Model using Perplexity Sampling**[http://arxiv.org/abs/2207.06814](http://arxiv.org/abs/2207.06814)
De Toni, F., Akiki, C., De La
               Rosa, J., Fourrier, C., Manjavacas, E., Schweter, S., and Van Strien, D. (2022)
                  **Entities, Dates, and Languages: Zero-Shot on Historical Texts
                  with T0.****Proceedings of BigScience Episode #5 — Workshop on Challenges
                  and Perspectives in Creating Large Language Models**[https://doi.org/10.18653/v1/2022.bigscience-1.7](https://doi.org/10.18653/v1/2022.bigscience-1.7)
Delestre, C., and Amar,
               A. (2022) **DistilCamemBERT: A distillation of the French model
                  CamemBERT**[https://doi.org/10.48550/arXiv.2205.11111](https://doi.org/10.48550/arXiv.2205.11111)
Derrick, T. (2019) **Using Transkribus For Automated Text Recognition of Historical Bengali
                  Books****British Library Digital Scholarship Blog**[https://blogs.bl.uk/digital-scholarship/2019/08/using-transkribus-for-automated-text-recognition-of-historical-bengali-books.html](https://blogs.bl.uk/digital-scholarship/2019/08/using-transkribus-for-automated-text-recognition-of-historical-bengali-books.html)
Devlin, J., Chang, M.-W., Lee,
               K., and Toutanova, K. (2019) **BERT: Pre-training of Deep
                  Bidirectional Transformers for Language Understanding**[http://arxiv.org/abs/1810.04805](http://arxiv.org/abs/1810.04805)
Ehrmann, M., Romanello, M.,
...
Ehrmann, M., Romanello, M.,
               Clematide, S., Ströbel, P. B., and Barman, R. (2020b) **Language
                  Resources for Historical Newspapers: The Impresso Collection.****Proceedings of the 12th Language Resources and Evaluation
                  Conference**[https://aclanthology.org/2020.lrec-1.121](https://aclanthology.org/2020.lrec-1.121)
Ehrmann, M., Watter, C.,
               Romanello, M., and Clematide, S. (2020c). **Impresso Named Entity
                  Annotation Guidelines**[https://doi.org/10.5281/zenodo.3604227](https://doi.org/10.5281/zenodo.3604227)
Ehrmann, M., Romanello, M.,
...
García-Serrano, A. and Castellanos, A.
               (2016) **Representación y organización de documentos digitales:
                  detalles y práctica sobre la ontología DIMH****Revista
                  de Humanidades Digitales**[https://doi.org/10.5944/rhd.vol.1.2017.17155](https://doi.org/10.5944/rhd.vol.1.2017.17155)
García-Serrano, A., and Menta-Garuz, A
               (2022). **La inteligencia artificial en las Humanidades Digitales:
                  dos experiencias con corpus digitales.****Revista de Humanidades Digitales**
Gebru, T., Morgenstern, J.,
               Vecchione, B., Vaughan, J. W., Wallach, H., Iii, H. D., and Crawford, K. (2021)
                  **Datasheets for datasets.****Communications of the ACM**[https://doi.org/10.1145/3458723](https://doi.org/10.1145/3458723)
Grishman, R.,
               and Sundheim, B. (1996) **Message Understanding Conference-6: A
                  ...
                  - Volume 1**[https://doi.org/10.3115/992628.992709](https://doi.org/10.3115/992628.992709)
Gruszczyński, W.,
               Adamiec, D., Bronikowska, R., Kieraś, W., Modrzejewski, E., Wieczorek, A., and
               Woliński, M. (2021) **The Electronic Corpus of 17th- and
                  18th-century Polish Texts.****Language Resources and Evaluation**[https://doi.org/10.1007/s10579-021-09549-1](https://doi.org/10.1007/s10579-021-09549-1)
Gutiérrez-Fandiño, A., Armengol-Estapé, J., Pàmies, M., Llop-Palao, J.,
...
Hintz, G., and Biemann,
               C. (2016). **Language Transfer Learning for Supervised Lexical
                  Substitution.****Proceedings of the 54th Annual Meeting of the Association for
                  Computational Linguistics (Volume 1: Long Papers)**[https://doi.org/10.18653/v1/P16-1012](https://doi.org/10.18653/v1/P16-1012)
Kabatek, J. (2013) **¿Es posible una lingüística histórica basada en un corpus representativo?****Iberoromania**[https://doi.org/10.1515/ibero-2013-0045](https://doi.org/10.1515/ibero-2013-0045)
Kettunen, K., Mäkelä, E.,
               Ruokolainen T., Kuokkala J. and Löfberg, L. (2017) **Old Content
                  ...
                  Newspaper Collection 1771–1910.****DHQ**[https://dhq.digitalhumanities.org/vol/11/3/000333/000333.html](https://dhq.digitalhumanities.org/vol/11/3/000333/000333.html)
Kirmizialtin, Suphan and David Joseph Wrisley. (2022) **Automated
                  Transcription of Non-Latin Script Periodicals: A Case Study in the Ottoman Turkish
                  Print Archive.****DHQ**[https://dhq.digitalhumanities.org/vol/16/2/000577/000577.html](https://dhq.digitalhumanities.org/vol/16/2/000577/000577.html)
Lample, G., Ballesteros, M.,
               Subramanian, S., Kawakami, K., and Dyer, C. (2016) **Neural
                  Architectures for Named Entity Recognition**[https://doi.org/10.48550/arXiv.1603.01360](https://doi.org/10.48550/arXiv.1603.01360)
Li, J., Sun, A., Han, J., and Li, C.
               (2022) **A Survey on Deep Learning for Named Entity
                  Recognition.****IEEE Transactions on Knowledge and Data Engineering**[https://doi.org/10.1109/TKDE.2020.2981314](https://doi.org/10.1109/TKDE.2020.2981314)
Liu, Y., Ott, M., Goyal, N., Du, J.,
               Joshi, M., Chen, D., Levy, O., Lewis, M., Zettlemoyer, L., and Stoyanov, V. (2019)
                  **RoBERTa: A Robustly Optimized BERT Pretraining
                  Approach**[https://doi.org/10.48550/arXiv.1907.11692](https://doi.org/10.48550/arXiv.1907.11692)
Malte, A., and
               Ratadiya, P. (2019). **Evolution of transfer learning in natural
                  language processing**[https://doi.org/10.48550/arXiv.1910.07370](https://doi.org/10.48550/arXiv.1910.07370)
McCallum, A., and Li, W.
               (2003) **Early results for Named Entity Recognition with
                  Conditional Random Fields, Feature Induction and Web-Enhanced Lexicons.****Proceedings of the Seventh Conference on Natural Language
                  Learning at HLT-NAACL 2003**[https://aclanthology.org/W03-0430](https://aclanthology.org/W03-0430)
Menta, A.,
               and García-Serrano, A. (2022) **Controllable Sentence
                  Simplification Using Transfer Learning.**
Menta, A., Sánchez-Salido, E.,
               and García-Serrano, A. (2022) **Transcripción de periódicos
                  históricos: Aproximación CLARA-HD****Proceedings of the
                  Annual Conference of the Spanish Association for Natural Language Processing 2022:
                  Projects and Demonstrations (SEPLN-PD 2022)**[https://ceur-ws.org/Vol-3224/paper17.pdf](https://ceur-ws.org/Vol-3224/paper17.pdf)
Merino Recalde, David.
               (2022) **El sistema de personajes de las comedias urbanas de Lope
                  ...
                  para el estudio del teatro del Siglo de Oro**[http://e-spacio.uned.es/fez/view/bibliuned:master-Filologia-FILTCE-Dmerino](http://e-spacio.uned.es/fez/view/bibliuned:master-Filologia-FILTCE-Dmerino)
Molina Martín, Á. (2021)
                  **Cartografías del adorno en las residencias nobiliarias de la
                  corte de Carlos IV: redes y modelos de buen gusto y distinción****Magallanica. Revista de Historia Moderna**
Molina, Á., and Vega, J.
               (2018) **Adorno y representación: escenarios cotidianos de vida a
                  finales del siglo XVIII en Madrid**
Moreno Sandoval, A.
               (2019). **Lenguas y computación**
Moreno
               Sandoval, A., Díaz García, J., Campillos Llanos, L., and Redondo, T. (2018) **Biomedical Term Extraction: NLP Techniques in Computational
                  Medicine**[https://doi.org/10.9781/ijimai.2018.04.001](https://doi.org/10.9781/ijimai.2018.04.001)
...
Nadeau, D., and Sekine,
               S. (2007) **A Survey of Named Entity Recognition and
                  Classification****Lingvisticae Investigationes**[https://doi.org/10.1075/li.30.1.03nad](https://doi.org/10.1075/li.30.1.03nad)
Nakayama, E. (2021) **Implementación de un corpus comparable de español y japonés de
                  acceso abierto para la traducción especializada**
Neudecker, C. (2016) **An Open Corpus for Named Entity Recognition in Historic
                  Newspapers****Proceedings of the Tenth International
                  Conference on Language Resources and Evaluation (LREC’16)**[https://aclanthology.org/L16-1689](https://aclanthology.org/L16-1689)
Nieuwenhuijsen, D. (2016)
                  **Notas sobre la aportación del análisis estadístico a la
                  lingüística de corpus****Notas sobre la aportación del
                  análisis estadístico a la lingüística de corpus**[https://doi.org/10.1515/9783110462357-011](https://doi.org/10.1515/9783110462357-011)
Perdiki, Elpida. (2022) **Review of Transkribus: Reviewing HTR training
                     on (Greek) manuscripts.****RIDE 15**[https://ride.i-d-e.de/issues/issue-15/transkribus/](https://ride.i-d-e.de/issues/issue-15/transkribus/)
Piotrowski, M. (2012). **Natural Language Processing for Historical Texts**
Pruksachatkun,
               Y., Phang, J., Liu, H., Htut, P. M., Zhang, X., Pang, R. Y., Vania, C., Kann, K., and
               Bowman, S. R. (2020). **Intermediate-Task Transfer Learning with
                  Pretrained Language Models: When and Why Does It Work?****Proceedings of the 58th Annual Meeting of the Association for
                  Computational Linguistics**[https://doi.org/10.18653/v1/2020.acl-main.467](https://doi.org/10.18653/v1/2020.acl-main.467)
Rivero, Manuel. (2022) **Italian Madrid: Ambassadors, Regents, and Courtiers in the Hospital
                  de San Pedro y San Pablo****Culture & History
                  Digital Journal**[https://doi.org/10.3989/chdj.2022.003](https://doi.org/10.3989/chdj.2022.003)
Rojo, G. (2010) **Sobre
                  codificación y explotación de corpus textuales: Otra comparación del Corpus del
                  español con el CORDE y el CREA****Lingüística**
Rojo, G. (2016) **Los
                  corpus textuales del español****Enciclopedia
                  lingüística hispánica**[https://www.researchgate.net/publication/294407007_Los_corpus_textuales_del_espanol](https://www.researchgate.net/publication/294407007_Los_corpus_textuales_del_espanol)
Rosset, S., Grouin, C., and Zweigenbaum,
               P. (2011) **Entités nommées structurées: Guide d’annotation
                  Quaero.**[http://www.quaero.org/media/files/bibliographie/quaero-guide-annotation-2011.pdf](http://www.quaero.org/media/files/bibliographie/quaero-guide-annotation-2011.pdf)
Ruiz Fabo, P., Bermúdez
               Sabel, H., Martínez-Cantón, C. and Calvo Tello J. (2017) **Diachronic Spanish Sonnet Corpus (DISCO)**[https://github.com/pruizf/disco](https://github.com/pruizf/disco)
Rubinstein,
               A., and Shmidman, A. (2021). **NLP in the DH pipeline:
                  Transfer-learning to a Chronolect.****Proceedings of the Workshop on Natural Language Processing for
                  Digital Humanities**[https://aclanthology.org/2021.nlp4dh-1.12](https://aclanthology.org/2021.nlp4dh-1.12)
Ruder, S., Peters, M. E.,
               Swayamdipta, S., and Wolf, T. (2019). **Transfer Learning in
                  Natural Language Processing.****Proceedings of the 2019 Conference of the North American Chapter
                  of the Association for Computational Linguistics: Tutorials**[https://doi.org/10.18653/v1/N19-5004](https://doi.org/10.18653/v1/N19-5004)
Sánchez-Salido, Eva.
               (2022) **Reconocimiento de entidades en corpus de dominios
                  específicos: experimentación con periódicos históricos**
Sanh, V., Debut, L., Chaumond, J.,
               and Wolf, T. (2019) **Distilbert, a distilled version of BERT:
                  smaller, faster, cheaper and lighter**[abs/1910.01108](abs/1910.01108)
Scheible, R., Thomczyk, F.,
               Tippmann, P., Jaravine, V., and Boeker, M. (2020) **GottBERT: A
                  pure German Language Model**[https://doi.org/10.48550/arXiv.2012.02110](https://doi.org/10.48550/arXiv.2012.02110)
Sekine, S. (1998) **Description of the Japanese NE System Used for MET-2,****Seventh Message Understanding Conference (MUC-7): Proceedings of
                  a Conference Held in Fairfax, Virginia, April 29 - May 1, 1998**[https://aclanthology.org/M98-1019](https://aclanthology.org/M98-1019)
Terras, M. M. (2011) **The Rise of Digitization****Digitisation Perspectives**[https://doi.org/10.1007/978-94-6091-299-3_1](https://doi.org/10.1007/978-94-6091-299-3_1)
Torruella Casañas, J.
               (2017) **Lingüística de corpus: Génesis y bases metodológicas de
                  los corpus (históricos) para la investigación en lingüística.**
Vaswani, A., Shazeer, N.,
               Parmar, N., Uszkoreit, J., Jones, L., Gomez, A. N., Kaiser, L., and Polosukhin, I.
               (2017) **Attention Is All You Need**[https://doi.org/10.48550/arXiv.1706.03762](https://doi.org/10.48550/arXiv.1706.03762)
Wissler, L., Almashraee, M.,
               Monett, D., and Paschke, A. (2014) **The Gold Standard in Corpus
                  Annotation**[https://doi.org/10.13140/2.1.4316.3523](https://doi.org/10.13140/2.1.4316.3523)
Yadav, V., and Bethard,
               S. (2018) **A Survey on Recent Advances in Named Entity
                  Recognition from Deep Learning models****Proceedings of
                  the 27th International Conference on Computational Linguistics**[https://aclanthology.org/C18-1182](https://aclanthology.org/C18-1182)
Zoph, B., Yuret, D., May, J., and
               Knight, K. (2016). **Transfer Learning for Low-Resource Neural
                  Machine Translation.****Proceedings of the 2016 Conference on Empirical Methods in
                  Natural Language Processing**[https://doi.org/10.18653/v1/D16-1163](https://doi.org/10.18653/v1/D16-1163)