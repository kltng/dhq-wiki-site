...
Corpora construction is a laborious task (

Corpus-based research has been dominated by statistical and neural models (
...
producing domain-specific resources that this entails

Starting with **Attention Is All You
Need**[^: https://www.bne.es/es/noticias/1111-el-primer-sistema-masivo-de-inteligencia-art][^: https://www.iic.uam.es/inteligencia-artificial/procesamiento-del-lenguaje-natura]

In the domain of Digital Humanities (DH), applying NER models to historical documents
poses several challenges, as shown by other works in the domain (
...
languages to old languages (

Recent initiatives have been launched, such as the creation and annotation of
datasets (**Identifying Historical
People, Places and other Entities**-serrano_castellanos2016-gomez_garcia-serrano_martinez2006
...
HIPE2020 corpus containing historical OCR texts in French, English and German

### 2. Creation of the corpus CLARA-DM

A major goal of the CLARA-HD[^: CLARA-HD project (PID2020-116001RB-C32) is funded
by MCIN - AE][^: https://impresso-project.ch]-serrano2022-salido2022-salido_garcia-serrano2022-serrano_menta-garuz2022-llanosetal2022
...
carried out using the Transkribus tool -salido_garcia-serrano2022[^: https://aws.amazon.com/es/textract][^: https://github.com/tesseract-ocr/tesseract]
...
text with some quality. The "Spanish Golden Age Theatre Prints 1.0" model (-luengos2021[^: https://readcoop.eu/transkribus/howto/how-to-transcribe-documents-with-transkrib]
...
to carry out the task of manual annotation first to teach
...
annotation guideline-llanosetal2021
...
The models used for the experiments are based on RoBERTa (monolingual) [^: https://huggingface.co/xlm-roberta-base]

- two Spanish: RoBERTa-BNE[^: https://huggingface.co/PlanTL-GOB-ES/roberta-base-bne]-fandinoetal2022[^: https://huggingface.co/bertin-project/bertin-roberta-base-spanish]
- one English: DistilRoBERTa[^: https://huggingface.co/distilroberta-base]
- one French: DistilCamemBERT[^: https://huggingface.co/cmarkea/distilcamembert-base]
- one German: GottBERT[^: https://huggingface.co/uklfr/gottbert-base]
...
promotes a version to master) or automatic[^: https://docs.tagtog.com/collaboration.html-adjudication]
...
popular approach in Deep Learning called transfer learning (
