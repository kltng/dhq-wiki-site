...
The concept of literary genre is considered highly complex for several reasons. First,
          ...
          theme, personnel, structure, and style (for an introduction, see #schoech2017#herrmann2015#hempfer1973#schaeffer1989
...
In this contribution, Topic Modeling is used to analyze a collection (further described
          ...
          poetics, see, for example, #scherer2001#mazouer2010
...
The data used in this study comes from the **Théâtre
            classique**#fievre2007**Guidelines**#burnard2014*comédie héroique**tragédie**opéra-ballet*
...
The plays' distribution over the time period covered by this study is shown in [Figure 1](#figure01)**Théâtre classique**
...
Topic Modeling is an unsupervised method used to discover latent semantic structure in
            large collections of texts (for an introduction, see #blei2012
...
The most commonly used implementation of Topic Modeling uses an algorithm called
            Latent Dirichlet Allocation (#blei2003#mccallum2002#rehurek2010#riddell2014b#blei2004#ramage2009#graham2012#riddell2014a#blevins2010#rhody2012#jockers2013
...
Topic Modeling has been performed as part of a larger processing workflow described in
            this section (see [Figure 2](#figure02)[^: The tmw toolchain is being
...
Lemmatization and morpho-syntactic tagging have been performed using TreeTagger (#schmid1994#presto2014[^: The PRESTO language model and tagset have been developed for sixteenth- and
    ]
...
There are many parameters influencing the result of the modeling process, but the
            ...
            document, respectively; see #wallach2009#buntine2014#schoch2016[^: Optimizing the parameters by optimizing some measure of model quality
          ][Figure 3](#figure03)[^: Apart from the model selection process described here, the effect of the
       ]
...
An initial inspection of the 60 topics obtained with their top-40 words, visualized as
            ...
            (subjective) coherence. A first selection of topic word clouds is shown in [Figure 4](#figure04)*coeur**amour**aimer**oser**madame**secret**connaître**craindre**cacher**apprendre**vers**auteur**pièce**beau**esprit**mal**monsieur**médecin, guérir**malade***L'amour médecin****Élomire hypocondre, ou les médecins vengés**
...
The selection of topics in [Figure 5](#figure05)*père**enfant**ciel**monsieur**argent**bon**payer**écus*
...
What, then, are topics characteristic for this collection of plays, what are the
            themes most commonly found in them? [Figure 6](#figure06)*mourir**mort**douleur**vivre**vie**fils**père**mère**frère**enfant**beau**berger**bois**arbre**lieu**lettre**lire**écrire**billet**main*topictopics*types**degree*#roeder2015
...
In a small number of cases, several topics are related to very similar semantic
            ...
            or as clusters.[^: This has not been assessed here systematically and could be
              invest]*amour**coeur*[Figure 7](#figure07)*ingrat**trahir**perfide**venger**crime**aimer**âme**beau**yeux**doux*
...
As can be seen, each subgenre has several distinctive topics, i.e. topics which in one
            ...
            The two most distinctive topics for comedies, with their top-ranked words, are topic 14
                (*madame**aimer**monsieur**bon**monsieur**beau**sang**mort**main**seigneur**soin**lieux**amour**beau**yeux**amour**coeur**aimer*love*amour**aimer**coeur*love[Figure 7](#figure07)
...
Overall, while many topics do not show strong changes in importance over the course of
            ...
            topic) and obviously related to tragedy (see [Figure 9](#figure09)
...
Several approaches to this clustering task can be taken, for example Principal
            ...
            that has already undergone a similar procedure (#joliffe2002loadings


[Figure 10](#figure10)[^: PCA has been performed using the sklearn package for Python. In our case,
      ]
...
Overall, we see that there are two major, well-defined groups of tragedies and
            ...
            that can be realized in more or less complete ways (see e.g. #hempfer2014
...
However impressive these results may be, the question remains whether topic-based
            ...
            particularly in authorship attribution (for an overview, see #stamatatos2009[Figure 3](#figure03)
...
This result is surprising, because both methods rely on different views of the
            ...
            frequency spectrum (see e.g. #rybicki2011#kestemont2012#schoch2013
...
It would be tempting to finish this paper on such an optimistic note. However, it seems
          ...
          practicing "sequential LDA" (#du2010#politz2015#ramage2009#blei2008#blei2004[section Data](#data)**Théâtre classique**
