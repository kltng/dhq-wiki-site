...
of digital analyses of literary style across fields (see stylistics
...
role ascribed to subjectivity and context (cf.
...
method-mixing for a long time (see, e.g., reading
reading-fashionedperilousparadigm
wars

My suggestion for DH is not to fortify an either-or vs. distantqualitative vs. quantitativeexplanatory vs.
...
labeled as middle-distance reading reading-sized data setsbig data*size **research
process*Scaling
...
the tests shuttling algorithmic analysis and hermeneutic close
...
approach alone[^: Within mixed-method approaches, interpretation is being
]*in either form*gius2015
...
non-numerical data*numbers derived from aggregations of words/texts **(elements of) meaningful textual
...
Kafka’s ** The Judgment ** Variable-approachescase-approaches
...
replicable, and have greater flexibility-endedopening up the discussion
...
complementary strengths and non-overlapping weaknesses.[^: Recently, scholars like
Symonds & Gorard have emphas]
...
readingmachine learning algorithmserror analysis
...
stylistic method*rigorous*based on an explicit framework of analysis*retrievable*organised through explicit terms and criteria,
...
For quantitative analysis, style
operations
effectgenretime. of the stylistic signalstylistic signal[^: See , whose article on the
...
archivearchive textsspoken passages[^: Retrievable under http://www.aclweb.org/anthology/W/W15/#0700][^: Scholars like
Manovich (2015) and Anderson (2008) take a]big data
...
unde]styleDelta
- *Quantitative Exploration.*keynessnormstylistically marked
- *Qualitative Text Analysis.*** The Judgment)** KWIC ** Key Word in Context **
...
only unique, but even solitary everyday languageobjective*external **internal*engel2010, confusing, and threatening
Each sentence says 'interpret me', and none will
permit it[^: It is an open (empirical) question how much of this effect of
]
...
I used cluster analysisbootstrap consensus treesstylo package[^: See https://sites.google.com/site/computationalstylistics/corpora][^: Texts by
...
Figure 2 shows a bootstrap consensus tree.[^: The lower margin was set to 800 mfw in
accordance wi]
...
Mitteln der europäischen Erzähltraditionrealistic
...
approach that has to take a prioriblack boxcherry picking
...
first study thus formed a Kafka corpussouthern German language continuum poemsdisengaged
...
Using the software tool AntConc
...
author-corpus rendered a number of interesting findings (see also
...
frequency of lemmas that may perform modalgenreQuantitative Hypothesis Testingmodal adverbs

#### Study 3: Qualitative Text Analysis

The third step of my project breaks down the complexity of the broad list of
modal*ja **doch*herrmann2016
...
everyday language ** Metamorphosis **
...
a Corpus of Literary Modernism
...
accelerates the growth of a third culture in the sense of Snow
...
Biber, D. (2011). ** Corpus linguistics and the study of literature: Back to the future?** Scientific Study of Literature **[10.1075/ssol.1.1.02bib](https://benjamins.com//journals/ssol.1.1.02bib/details)
Biber, D., & Reppen, R.
