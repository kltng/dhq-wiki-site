...
Agent-based modeling, sometimes called individual-based
                    modeling, is a comparatively new method of computational
                        ...
                        other and their environment locally#railsback2012
...
In this way, agent-based modeling is closely associated with
                    ...
                    consumers, and voters — emerge into new collective
                        ...
                        The remarkable thing about social
                            ...
                            decompose, and complexity ensues#miller2007
                        it is not the emergent macroscopic
                            object per se that is surprising, but the generative
                            sufficiency of the simple local rules#epstein1996all that is really
                        happening#epstein1996
...
The basic work of agent-based modeling involves writing the
                    ...
                    packages, Cynthia Nikolai and Gregory Madey point out that
                        ...
                        toolkit#nikolai2009[^: Two oft-compared platforms
...
Without presuming to recommend (even implicitly) one toolkit
                    ...
                    and became popular in primary and secondary education #harvey1997turtlesprocedurespatches,
                        **Diffusion Graphics.**
...
This ability to visualize the behaviors of many turtles as
                    ...
                    the **Virtual Culture Laboratory**[Figure 2](#figure02a)Taking the baroque as a cultural
...
ABM differs from gaming in three key respects, however.
                    ...
                    definite goal #manovich2001*play**play with*[^: My phrasing here is meant
...
However, if we are to simulate responsibly, the above
                    ...
                    a leading voice.[^: Alan Liu summarizes McCarty’s
                        ...
                        the view]#morrison1999*models don’t represent the world —
...
Consider fashion models. It doesn’t seem right to say they
                    ...
                    cases they might not even exist #morgan1999a[^: Morgan and Morrison describe models as
                        mediating entitie]#poovey2013[^: Poovey and Brine
...
These different forms of symbolization may have more in
                    ...
                    say that models represent ideas rather than things.[^: One might ask if any form of representation could escape
                        ...
                        generic (and genetic) relationships#creager2007conclusions.
...
In the cases of a 3D mechanical replicas or computer
                    ...
                    in economics #morgan1999b#morgan2004#poovey2013[^: Morgan describes the intellectual payoff
                        of Fisher’s mod]#colander2011
...
Some of these humanistic models are more amenable to
                    ...
                    Bourdieu’s idea of the field of
                        cultural production[Figure 4](#figure04)
                       **The Field of Cultural
                                Production**#bourdieu1993[Figure 5](#figure05)
                        **The Communications
                                Circuit.**#darnton2006
...
Book historians have also collected a large amount of data
                    ...
                    annually from the earliest years of the hand-press era. (See
                        ...
                        **Annual Totals
                                ...
                                Book in Britain: vol. 4.**media revolution,#smith1994
...
What relation is there between diagrammatic models like
                    ...
                    practitioner of microhistory,everyday life#brewer2010#darnton1984validated
...
In this respect, the diagrammatic models often drawn by
                    ...
                    the field of complexity science, explanation is
                        ...
                        generative, kind of social science#epstein1996What
...
The task of converting Darnton’s model into a functioning
                    ...
                    turtle-types (called breedsjobs,[Figure 7](#figure07)
...
Throne concedes that the homogeneous
                        ...
                        unrealistic,#throne2011**Asteroids**to buy-book
...
Given its level of abstraction, what relation does this
                    ...
                    describes the procedure as an activity that may be thought of as reading, purchasing, or
                        borrowing#throne2011imaginative*may be thought of as*[^: In
...
The most salient difference between agent-based simulations
                    ...
                    games applies to ABM as well: like games, simulations are an
                        action-based medium#galloway2006comprise a practical means of playing out the
                        consequences of an idea#mccarty2008[^: Throne concludes, My exploration suggests that for the
                         ]
...
Happily, agent-based models are easy to modify and extend
                    ...
                    observed over a 225-year period in my version (See [Figure 8](#figure08)[Figure 6](#figure06)[^: Dan Dixon calls this intellectual
...
Readers curious about the model itself are encouraged to
                    ...
                    constraints and feedback loops modify agent behavior ([http://modelingcommons.org/browse/one_model/4004](http://modelingcommons.org/browse/one_model/4004)Bookshops[http://modelingcommons.org/browse/one_model/4002](http://modelingcommons.org/browse/one_model/4002)**The Paranoid Imaginarium of Roger
                        L’Estrange**[http://modelingcommons.org/browse/one_model/4003](http://modelingcommons.org/browse/one_model/4003)#sack2013#sack2013[http://modelingcommons.org](http://modelingcommons.org)
