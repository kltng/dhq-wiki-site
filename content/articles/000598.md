...
This article is based on the understanding that sort political texts can be a
               ...
               political text can be seen as an act of politicalisation #palonen2007breality#koller2014#shim2015
...
The empirical results of this article suggest that New Year’s speeches offer a
               ...
               important and becomes politicised #palonen2007a
...
A known challenge with political speeches is that such texts normally tackle several
               ...
               gain understanding about where different words appear in the original text #hearst1994


#jelveh2014thematic recycling
...
Thus far most studies dealing with the problem of identifying topics across documents
               ...
               Dirichlet Allocation (LDA) #blei2003document,#light2014
...
Although identifying different topics is an interesting challenge of explorative text
               ...
               similar statements glue#busse2013
...
The analysis presented in the next section is an application of Text Network Analysis
               ...
               discover repetitive patterns derived from the text’s structure,
                  ...
                  only criteria for their belonging together#paranyushkin2011#shim2015to identify salient words and concepts in order to extract
...
One key difference of TNA compared to more traditional tools and techniques of text
               mining is that TNA understands its input as network data consisting of
                  nodes*vertices**edges*#paranyushkin2011#ruohonen2013#scott2013#paranyushkin2011a strong subjective (and
...
The empirical case study in this article is based on New Year’s speeches of the three
               German-speaking countries, Germany, Austria and Switzerland[^: Switzerland is in
                  fact a multilingual country with four offici]#jordan2005imagined
...
There exist only a small number of dedicated studies on New Year’s speeches #heikkinen2006#portman2014#purhonen2016#light2014#light2014
...
Another issue in this period was the outbreak of the sovereign debt crisis in the
               ...
               words like globalisierungwirtschaftarbeitslosigkeit#mullerbrandeckbocquet2010#janning2016#kundnani2016#bulmer2018#allen2005#maull2018
...
The results presented thus far indicate two main aspects. First, New Year’s addresses
               ...
               to five words apart #jelveh2014
...
- Node size is mapped to the node’s degree centrality value and node label size
                  ...
                  path linking two other nodes together, thus helping to identify nodes having
                     ...
                     shortest path between two randomly chosen vertices#hsu2013#prell2012shows the variety of contexts where
                     the word appears, while high degree shows the variety of words next to which
                     the word appears#paranyushkin2011#paranyushkin2011#shim2015#shim2015
- Node colour is mapped to the topic cluster the node belongs to. One of the
                  ...
                  community detection techniques.[^: For a summary, see]*within*#paranyushkin2011#shim2015Louvain method#blondel2008
...
Overall, the topics identified by the Louvain method seem appropriate and reliable in
               ...
               of #paranyushkin2011#light2014#shim2015#jelveh2014friedenfriedlichkriegsicherheitkrisegemeinschaftwirtschaftzukunftglueing
...
Second, results from the empirical analysis evidence the analytical power of the two
               computational methods applied. On the one hand, the rather traditional
                  tf-idf*the*#gabriel2003#goetschel2005
...
Third, although the results are encouraging both in empirical and methodological
               ...
               from text data, since these decisions could strongly influence
                  the structure of resulting networks#shim2015
