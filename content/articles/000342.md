...
over the years in one online search interface **Dorothea: 53 years of dreams**
...
automatic language identification step [^: We
used langid.py version 1.1.5 (github hash: e801bf][^: We
...
libsvm [^: http://scikit-learn.org/stable/modules/naive_bayes.html]
...
purchasingusing the
bathroomschool lifeinside the houseoutdoorcontinuity hypothesis
...
discourse marker in this experime] thenbecausesosince
...
Labovian Model of narrative  actioncodaresolution
