...
The genre of interactive fiction has enjoyed increasing critical attention over the past
          few years, particularly since the publication of Nick Montfort's **Twisty Little Passages: An Approach to Interactive Fiction**[^: Hereafter
            ...
            a turn-based program driven by textual input from
              ...
              involving a parser and a world model#eve2007
...
The distinction between the textual and the visual, or between the verbal and the visual
          ...
          distinctions are always already political: 
            Every theoretical answer to the questions,
              ...
              terms#mitchell1990sameimagereal
            pictorial images are inevitably conventional
              and contaminated by language#mitchell1990meaningThe image is the
              sign that pretends not to be a sign, masquerading as (or for the believer, actually
              achieving) natural immediacy and presence#mitchell1990#drucker2002*is*
...
This task becomes especially pressing in the present cultural moment. Ekphrastic
          ...
          mimetic power of images to text. As Murray Krieger argues, ekphrasis entails the defensive concession that language, as arbitrary
            ...
            the prideful confidence in language as a
              medium privileged by its very intelligibility#krieger1992
            The widespread presence of ekphrasis in
              ...
              a way of engaging and understanding their allure and force.#loizeaux2008
            further lost popular readership and its
              significant social role#loizeaux2008
...
For most IF critics, IF is a verbal, textual and literary medium whose closest affinities
          are with the tradition of ergodic textuality that extends from the **I
            Ching**
            a new type of literary artifact#aarseth1997**Deadline**#montfort2005**Somewhere Nearby is Colossal Cave,****Colossal Cave****Adventure**
            establish that Crowther's original was not only
              ...
              remediation of that site#jerz2007
...
From the reader's perspective, the principal textual components of IF are room
          ...
          Eve explains, in IF, 
            the physical world is generally modelled as a
              ...
              #eve2007adjacent spaces displayed
            one at a time#wolf2002[^: This spatial arrangement is the sixth item in
            ...
            adjacent spaces or rooms are displayed as a
              ...
              scrolling#wolf2002[^: Some IF games, such as the late Infocom game Arthur: The Quest for Excalibur (19]room descriptionabsent
...
Consider, for example, the following room description from **Zork I:
            The Great Underground Empire**
              You are in the living room. There is a doorway to the east, a wooden door with
                ...
                case, and a large oriental rug in the center of the room.Above the trophy case hangs an elvish sword of great antiquity.A battery-powered brass lantern is on the trophy case.#blank1980implemented.
...
The primacy of *seeing***Adventure****Adventure**
            as it is highly dangerous to wander around
              cave systems in the dark#douglass2007**Enlightenment****Hunter, in
            Darkness**#douglass2007
...
As translations of visual objects in the medium of language, IF room descriptions (and
          ...
          essay on Keats's **Ode on a Grecian Urn**#koelb2006
            [a] speech which leads one around (
                *periegematikos*
                *enargos*#koelb2006**Zork**
            *enargeia*brought
            ...
            [t]he totality of rooms in a given work of IF is
              often referred to as the *map*emphasis in original #eve2007
            probably because someone designing a work of IF
              ...
              often find it useful to draw schematic maps as they play#eve2007
...
When visualizability breaks down — that is, when room and object descriptions fail to
          ...
          the game successfully may be impeded.[^: I want to carefully distinguish here between
            ...
            can’t see any such thingI don’t see that here.It looks very clumsy if, having told the player that the room is
              decorated with striped wallpaper, the game responds with You see no such thing#eve2007[^: Eve probably chose to use wallpaper as an
...
My argument, thus, is that ekphrasis is the characteristic mode of visual representation
          ...
          comparative advantages over graphics. Graphical video games predate **Colossal Cave**#wikipedia2009show
...
Furthermore, text was far more cross-platform than graphics. Infocom games were designed
          for the Z-Machine, a software computer [which]
            ...
            microcomputers in the United States during the 1980s#montfort2005[^: The most sophisticated treatment of the text-rendering capabilities of
         ]
...
For these and other reasons, the use of ekphrasis rather than graphics made the
          ...
          however, IF's reliance on text was also the cause of its commercial decline.[^: IF still
            ...
            critiques]Images, especially moving images, are more powerful representations of spatial
              ...
              and inevitable#aarseth1997[^: See also Mark J.P. Wolf's
            observation, that 
              [p]art of]#bolter2003
...
The assumption here is that video game history follows a teleological progression from
          ...
          example of such a view is Julian Dibbell's dismissive description of **Adventure****Myst**
            It's hard to believe that that world once
              ...
              like **Myst****Adventure**#dibbell2001
            young, vigorous, if somewhat bland tradition
              of textual entertainment [...] was quickly overrun by the entertainment market#aarseth1997
            Only once in my life have I seen a wonderful
              medium effectively wiped out by new technologyqtd. in #douglass2007
...
The player's goal in this game is to remove all the objects from a house belonging to the
          ...
          introductory text of the game: 
              ...
              With the cantankerous Wizard of Wordplay evicted from his mansion, the worthless
                ...
                into the bed of his truck, type a few Zs, and arrive at the site, eager …#montfort2000**Z**wait**Ad
            Verbum**saursaurus
...
Other puzzles in the game do force the avatar to interact with rooms and objects, but in
          ...
          Most notably, the game contains several constrained rooms[figure 4](#figure04)**Wee Wardrobe.**
...
Montfort thereby demonstrates that the world represented in an IF game is dissimilar to
          ...
          which the ekphrastic poem calls attention to the artificiality of the artwork it describes
            ...
            the earth darkened behind [the ploughmen]
              and looked like earth that has been ploughed / though it was gold #heffernan2004the
...
But of course IF players perform an activity that readers of poetry typically don't. In
          ...
          to, and can be visualized as, the avatar performing that action. When I type take
            lanterntake lantern#nelson2001dust casingabecedarian booka mysterious force holds the book to the … shelves.[^: These two books allude to
...
A similar strategy is at work in many other more recent games that exploit the textual
          ...
          the same extent as **Ad Verbum****Violet****Violet**#gaudreault2009
...
The descriptions reproduced in [figure 5](#figure05)**Metamorphoses**
            In writing **Metamorphoses**#short2009


What happens instead in **City of Secrets**
            speaks of syntheses below the level of
              consciousness, which he calls passive syntheses#schwenger1999#mccloud1993[^: Douglass claims that closure operates in IF at
...
A more nuanced way to distinguish between readerly and graphical visuality might be to
          ...
          images affect the way in which he or she concretizes the text's descriptions: 
            [L]iterature consists of a steady stream of
              ...
              pictures, an obbligato of the unconscious, of memory and desire.#schwenger1999**Final Fantasy X***only*
            With **City of
                Secrets***Metamorphoses*#short2009
...
This effect is further complicated by Short's limited use of graphics. **City of Secrets**
            ambient illustrations#douglass2007[figure 5](#figure05)[^: Note also that these images
...
For a certain subset of the game's audience, **City of Secrets**feelies.feelies
            [m]ultimedia epitexts such as journals,
              maps, and artifacts, bundled to illustrate the IF work. Popularized by Infocom#douglass2007**Sorcerer****Leather Goddesses of Phobos**[feelies.org](http://feelies.org)
            
              [feelies.org](http://feelies.org)virtual feelies#loguidice2004**City of Secrets**[t]ourist guide to the City, including
          ...
          sake” is unnecessary and potentially harmful in IF, where ekphrasis is
            *prescriptive*[^: Excessive use of detail also tends to be
            ...
            Some of the most effective writers of mood
              ...
              inspected through a jeweler’s loupe.#short2008[^: A literal version of this process occurs
            in the science fiction film]
            motivated […] by the speaker’s emotional
              engagement with and amplification of his client’s plightqtd. in #koelb2006**City of Secrets**
...
Short, Emily. Comment in
          response to Nick Montfort's blog posting, **IF, Visuality, and Other
            Bits of DAC.**[http://nickm.com/post/2009/12/if-visuality-and-other-bits-of-dac/#comments](http://nickm.com/post/2009/12/if-visuality-and-other-bits-of-dac/#comments)
Wettlaufer,
