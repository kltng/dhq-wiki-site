---
title: "Linking Data and
               Disciplines: Interdisciplinary brokering in digital humanities research"
id: 000620
...
date: 2022-06-25
type: article
keywords: ["interdisciplinarity", "collaboration", "cs", "semantic web", "project report", "tools", "cultural heritage"]
author_keywords: []
language: en
word_count: 6977
source: raw/articles/000620.xml
---
...
**Volume 016, Issue 3** (2022-06-25) | article | 6,977 words

**Keywords:** [[collaboration-interdisciplinarity]], [[collaboration-interdisciplinarity]], cs, [[tools-infrastructure-dhq]], [[digital-humanities-dhq]], [[tools-infrastructure-dhq]], [[cultural-heritage]]
...
Productive interdisciplinary collaboration is high on research agendas of funding
               organisations, especially those organisations looking to stimulate digital humanities
                  research[^: For examples of calls for and reports on interdisciplinary research
            ]#vangorp2019


Interdisciplinariness#poole2018#hagedoorn2018practice of
                  interdisciplinary collaboration#vangorp2019
...
This article presents insights into such interdisciplinary digital humanities
               ...
               knowledge exchange, much like a boundary object#star1989


The tool that became the team’s boundary object, is the Linked Open Data (LOD)
               exploratory search browser DIVE+[^: See  https://diveplus.frontwise.com/.
                  DIVE+ is an exploratory,][^: https://mediasuite.clariah.nl]#martinez2017search narrativesdevelops,
               facilitates, and stimulates the use of Digital Humanities resources and
               infrastructures#clariah2022
...
As the title of this article suggests, brokering plays a key role in grasping the
               ...
               for collaboration. Admittedly borrowed from Innovation Studies #hargadon1997#allington2016#liu2012#nowviskie2016


In this case, brokering takes the shape of a brokering community practice #wenger1998#henry2012[negotiate] their own
               activities and identities, [while shaping] the relationships between their
               communities of practice#beddoes2011#allington2016
...
This article’s second goal is to connect our qualitative user studies’ insights to
               ...
               and how these may inform the development of research environments for digital
                  scholarship in the humanities#gradmann2015#bron2012
...
Digital humanities research is characterised as interdisciplinary, and works at
                  ...
                  all-encompassing processes of the datafication of modern society #schafer2017#vangorp2019#klein2015#hayles2012#masson2017#oldenziel2006#tabak2017#gradmann2015
...
Masson describes two trends in digital humanities research that relate to the core
                  ...
                  transdisciplinary, drawing into focus the work of creating a shared conceptual
                     framework#masson2017#klein2010fundamental epistemological shifts occur#austin2008
...
The research project did, however, rely on a shared material space: DIVE+, the
                  ...
                  #star1989working artefact#suchman2002both adaptable to different viewpoints
                     and robust enough to maintain identity across them#star1989


We work in line with Rieder and Rohle’s ([2012](#rieder2012)establish areas of collaboration between the
                  disciplines and to foster the development of practical solutions for interaction#rieder2012


Here, brokering work takes the shape of translation[^: In the sense that Callon
                     (1984) discusses translation of in]
...
Drawing out this brokering work shows how collaborators work across disciplines by
                  ...
                  the model reveals a search process in which a person is seeking meaning in the
                     course of seeking information#kuhlthau2017dipfit smoothly with
                     previously held constructs#kuhlthau2017#marchionini2006#mirizzi2010aim to solve complex
                  problemsopen-ended, persistent, and
                  multi-faceted[[White and Roth 2009|2009]]#sauer2016#wilson2017


In defining how to optimally support exploratory search, Marchionini ([[Marchionini 2006|2006]]
...
Facilitating data exploration by means of linked open data (LOD) allows users to
                  discover connections across linked data sets #pattuelli2017#bod2013#voskarides2018[^: Dimitrova et al.’s user study (2013) uses task-based experiments to understand
 ]


Recent digital humanities research has also focused on discovery by means of
                  exploratory search. Jähnichen et al. ([[Jähnichen 2017|2017]][[Muiser et al. 2017|2017]][[Lampert and Southwick 2013|2013]]
...
This article presents the results of our user study focused on exploratory search
                  ...
                  interlanguage and interactional expertise#klein2015
...
Digital humanities research is often project-based #tabak2017#hagedoorn2018
...
![Visualized search journey poster](resources/images/figure1.jpg)
...
Klein discusses the interactional expertise trading zoneinterdisciplinary
...
A similar discussion emerged about the idea of how DIVE+ was to be an ‘event-centric’
               ...
               referred to as the I-methodology#akrich1995designers consider
                  themselves as representative of the users#oudshoorn2004
...
Using DIVE+, users can explore relations between 1,231.688 entities from 4 digital or
               digitized heritage collections[^: The Tropenmuseum (a museum of world cultures),
                  Dutch newspaper]
...
The DIVE+ interface allows users to search for keywords, persons, and locations
               ...
               DIVE+, a sense of just diving in without knowing what you will end up withlets you see connections and thus shows you the
...
Connections are deemed valuable when they can be contextualized; researchers see the
               ...
               about the metadata than about the actual content*why*
...
The user-reported need to ground the data, whether within the context of collection,
               ...
               boyd and Crawford’s insights about Big Data analysis ([[Boyd 2012|2012]]The ability to represent relationships between people as a graph
                  does not mean that they convey equivalent information#boyd2012
...
![DIVE+ Exploration path. Searching for ‘Beatrix’ leads to an event ‘De bouw
               van het schip de ‘Prinses Beatrix’’ (construction of the ship ‘Princess Beatrix’)
               which is connected to the entity ‘Prinses Beatrix’ after whom the ship was named.
               Source figure: https://diveplus.frontwise.com/](resources/images/figure2.png)
...
However, as stated previously, referring to the collected search history as a
               ...
               meaning, relevance and to understand reality with more awareness and to transform itduring the process of collecting data, the narrative might
...
![Feature to annotate the exploration path. Source figure:  https://diveplus.frontwise.com/](resources/images/figure3.png)


![DIVE+ interface, showing how the keyword search ‘Beatrix’ provides search results from different collections, such as ‘Beeld en Geluid’, that the user can use to sort search results by collection. Source figure: https://diveplus.frontwise.com/](resources/images/figure4.png)
...
Overall, this then demands that researchers act in a self-reflexive manner throughout
               ...
               understandings. Masson’s observation that transdisciplinary work demands a shared
                  conceptual framework#masson2017
...
Yet, solely focusing on DIVE+ as a boundary object overlooks the important role
               ...
               matter within projects such as these. In the end, it’s not what the software does,
                  it’s what the user does#macleod2009
...
## Notes & References
 ...
 Akrich M. **User representations: Practices, methods and sociology.****Managing
               technology in society: The approach of constructive technology assessment**
 Allington D, Brouillette S and Golumbia, D. **Neoliberal tools (and archives): A
               political history of digital humanities**
 Austin W, Park C and Goble, E. **From interdisciplinary to transdisciplinary
               research: A case study.****Qualitative Health Research**
 Beddoes K. **Practices of brokering: Between STS and feminist
               engineering education research.**
 Bod R. **Who's Afraid of Patterns? The Particular versus the Universal and the
               Meaning of Humanities 3.0.****BMGN-Low Countries Historical
                  Review**
 ...
 Bron M, Van Gorp J, Nack F, et al. **A subjunctive exploratory search
               interface to support media studies researchers****Proceedings of
                  the 35th international ACM SIGIR conference,**
 Buzelin H. **Translation studies, ethnography and the production of knowledge.****In Translation Reflections,
                  Refractions, Transformations**
 Chan A, Chenhall R, Kohn T, et al. **Interdisciplinary Collaboration and
               Brokerage in the Digital Humanities.****Digital Humanities
                  Quarterly**
 De Boer V, Oomen J, Inel O, et al. **DIVE into the event-based browsing of
               linked historical media.****Web Semantics: Science, Services and
                  Agents on the World Wide Web**
 De Boer V, Melgar L, Inel O, et al. **Enriching Media Collections for
               Event-Based Exploration.****Research Conference on Metadata and
                  Semantics Research**
 Callon M. **Some elements of a sociology of translation: domestication of the
               scallops and the fishermen of St Brieuc Bay.****The Sociological
                  Review**
 CLARIAH. [https://www.clariah.nl/](https://www.clariah.nl/)
 Dimitrova V, Lau L, Thakker D, et al. **Exploring Exploratory Search: A User
               Study with Linked Semantic Data.****Proceedings of the 2nd International Workshop on Intelligent Exploration of Semantic
                  Data**
 Gradmann S, Hennicke S, Tschumpel G, et al. **Beyond Infrastructure! Modelling
               the Scholarly Domain**
 Hagedoorn, B., & Sauer, S. **The researcher as storyteller: using digital tools for search and storytelling with audio-visual materials.****VIEW Journal of European Television History and Culture**
 Hargadon A and Sutton RI. **Technology brokering and innovation in a product
               development firm.****Administrative science quarterly**
 Hayles NK. **How we think: Transforming power and digital technologies.****Understanding digital humanities**
 Henry A and Mackenzie S. **Brokering communities of practice: A model of
               knowledge exchange and academic-practitioner collaboration developed in the context
               of community policing.****Police practice and research**
 Jähnichen P, Oesterling P, Heyer G, et al. **Exploratory Search Through Visual
               Analysis of Topic Models.****Digital Humanities Quarterly**
 Kefalidou G and Sharples S. **Encouraging serendipity in research: Designing
               technologies to support connection-making.****International Journal of
                  Human-Computer Studies**
 Klein, JT. **A taxonomy of interdisciplinarity.****The Oxford handbook of
               interdisciplinarity,**
 Klein JT. **Interdisciplining****Digital Humanities - Boundary Work in an Emerging Field**
 Kuhlthau, C.C. **Information Search Process (ISP) Model.****Encyclopedia of Library and Information Sciences**
 Lampert CK and Southwick SB. **Leading to Linking: Introducing Linked Data to
               Academic Library Digital Collections.****Journal of Library
                  Metadata**[10.1080/19386389.2013.826095](https://doi.org/10.1080/19386389.2013.826095)
 Liu AY. **Where is cultural criticism in the digital humanities?**
 MacLeod, H. **Ignore Everybody: And 39 Other Keys to Creativity.**
 Marchionini G. **Exploratory search: from finding to understanding.****Communications of the ACM**
 Martínez Ortiz C, Ordelman R, Koolen M, et al. **From Tools to
               ‘Recipes’: Building a Media Suite within the Dutch Digital Humanities
               Infrastructure CLARIAH**
 Masson E. **Humanistic Data Research: An Encounter between Epistemic Traditions.****The datafied society: Studying
                  culture through data**
 Mirizzi R, Bari P, Orabona V, et al. **From Exploratory Search to Web Search and
               back.****Proceedings of the 3****workshop on
                  Ph.D. students in information and knowledge management****.**
 Muiser IEC, Theune M, De Jong R, et al. **Supporting the Exploration of Online
               Cultural Heritage Collections: The Case of the Dutch Folktale Database.****Digital Humanities Quarterly**
 Nowviskie B and McGann J. **Critiquing the Critique of the Digital Humanities.****The New Atlantis**
 Oldenziel R, De la Bruhèze AA and De Wit O. **Europe’s mediation junction:
               technology and consumer society in the 20th century.****History and
                  Technology**
 Oudshoorn, N., Rommes, E., & Stienstra, M. **Configuring the user as
               everybody: Gender and design cultures in information and communication
               technologies.****Science, Technology, & Human Values,**
 Pattuelli MC, Hwang K, and Miller M. **Accidental discovery, intentional inquiry:
               Leveraging linked data to uncover the women in jazz.****Digital
                  Scholarship in the Humanities**
 Poole, A. H., & Garwood, D. A. **Interdisciplinary scholarly collaboration
               in data-intensive, public-funded, international digital humanities project
               work.****Library & Information Science Research**
 Race TM and Makri S (Eds.). **Accidental Information
               Discovery: Cultivating Serendipity in the Digital Age**
 Rieder B and Rohle T. **Digital Methods: Five Challenges.****Understanding Digital Humanities.**
 Sauer, S., & de Rijke, M. **Seeking serendipity: A living lab approach to understanding creative retrieval in broadcast media production.****Proceedings of the 39th International ACM SIGIR conference on Research and Development in Information Retrieval**
 Sengers P. **The autonomous agency of STS: Boundary crossings between STS and
               Artificial Intelligence.****Social Studies of Science**
 Schäfer MT and Van Es KF. **The datafied society: Studying
               culture through data**
 Star SL and Griesemer JR. **Institutional Ecology, ‘Translations’ and Boundary
               Objects: Amateurs and Professionals in Berkeley ’s Museum of Vertebrate Zoology,
               1907-39.****Social Studies of Science**
 Suchman L, Trigg R. and Blomberg J. **Working artefacts: ethnomethods of the
               prototype.****The British journal of sociology**
 Tabak E. **A Hybrid Model for Managing DH Projects.****Digital
               Humanities Quarterly**
 Van Gorp, J., & Bron, M. **Building Bridges: Collaboration between Computer
               Sciences and Media Studies in a Television Archive Project.****DHQ: Digital Humanities
               Quarterly**
 Van Oost E, Verhaegh S and Oudshoorn N. **From Innovation Community to Community
               Innovation: User-initiated Innovation in Wireless Leiden.****Science
                  Technology, & Human Values**
 Voskarides N, Meij E, Reinanda R, et al. **Weakly-supervised Contextualization
               of Knowledge Graph Facts.****Proceedings of the 41****International ACM SIGIR Conference**
 ...
 Wilson ML. **The Tetris model of resolving information needs within the
               information seeking process.****Conference on Human Information
