...
DIVE+ is an exploratory,][^: https://mediasuite.clariah.nl] narrativesdevelops,
...
framework epistemological shifts occur
...
lead to tests and alterations of, and reflections on DIVE+ as a boundary object
 artefact adaptable to different viewpoints
and robust enough to maintain identity across them

We work in line with Rieder and Rohle’s ([2012]()establish areas of collaboration between the
...
course of seeking information smoothly with
previously held constructs to solve complex
problemsopen-ended, persistent, and
multi-faceted[2009]()

In defining how to optimally support exploratory search, Marchionini ([2006]()
...
discover connections across linked data sets [^: Dimitrova et al.’s user study (2013) uses task-based experiments to understand
]

Recent digital humanities research has also focused on discovery by means of
exploratory search. Jähnichen et al. ([2017]()[2017]()[2013]()
...
referred to as the I-methodology consider
...
boyd and Crawford’s insights about Big Data analysis ([2012]()The ability to represent relationships between people as a graph
