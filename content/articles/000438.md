...
These verifications can be done entirely separately from the DLL Review
                        ...
                        through which certificates can be reviewed, as seen in [Figure 3](#figure03)
...
A high-level illustration of anticipated interactions between the DLL Review
                        Registry and Client systems can be visualized below in [Figure 4](#figure04)
...
[Figure 5](#figure05)[LombardPress](http://lombardpress.org/)[LombardPress-Web](http://scta.lombardpress.org/)[Scholastic
...
Finally, [Figures 7](#figure07)[and 8](#figure08)[Figure 7](#figure07)[Linked Data Notifications](https://www.w3.org/TR/ldn/)[Mirador-LDN-Plugin](https://github.com/jeffreycwitt/mirador-ldn-plugin)[^: For more on the use of Linked Data
                            Notifications and][In Figure 7](#figure07)
