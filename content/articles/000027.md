...
date: 2009-02-26
type: article
keywords: ["users", "corpora", "medieval", "digitization", "markup", "information retrieval", "manuscripts"]
author_keywords: []
language: 
word_count: 3628
source: raw/articles/000027.xml
---
...
**Volume 003, Issue 1** (2009-02-26) | article | 3,628 words

**Keywords:** [[tools-infrastructure-dhq]], [[corpus-methods-dhq]], medieval, [[archives-access]], markup, information retrieval, manuscripts
...
Incunabula and other early printed works pose intriguing challenges and test cases
               for large-scale mass digitization projects such as [[Google Books]][^: ;][^: This discussion appeared in the original proposal, and was
                  sum]êenemqquequodpperpro


![Sample Brevigraphs](resources/images/figure01.jpg)
...
Sample Unclear Word DivisionSample Unclear Word Division from early Latin books
...
![Sample word break across line ending](resources/images/figure03.jpg)


These examples of the most common abbreviations only begin to describe an extremely
               complex typographic system. For example, the 1488 edition of the **Stultifera Navis****Vitae et Sententiae
                  Philosophorum**
...
These features of early typography occur at varying rates in different texts, but
               ...
               mechanics created a library of sixty texts printed between the years 1495 and 1691.[^: ;]**Legenda Aurea****Vitae et
...
- Image Books:
- Image Books With Minimal Structural Data:
- Image Front Transcriptions:
- Carefully Edited and Tagged Transcriptions:
...
Once the decision has been made to digitize the text rather than displaying page
               ...
               catalog of every brevigraph that appears in each printed book (illustrated in [Figure 4](#figure04)


![Sample Catalog of Brevigraphs](resources/images/figure04.jpg)
...
In this process, a unique entity identifier is assigned to each non-standard
               ...
               printed as follows: 
                  Sample Lines from Suetonius. **Vitae XII
                     Caesarum.**Sample Lines from Suetonius. Vitae XII Caesarum. Milan: Leonard Pachel.
                     1494
...
If the goal of this process is to create a carefully tagged TEI-conformant text that
               ...
               each different glyph[^: When this project was planned in 2004, we based our work on
                  th]


`patre<abbr type='e1'>m</abbr> amisit; seque<abbr
                  type='e2'>n</abbr>ntibus<abbr type='q1'>que</abbr> co<abbr
                  type='c1'>n</abbr>sulibus flamen dialis destinatus`
...
![Abbreviation Expansion Tool](resources/images/figure06.jpg)
...
![Unmarked Word Break Tool](resources/images/figure07.jpg)
...
![Unclear Word Division Tool](resources/images/figure08.jpg)
...
While this approach advances our ability to undertake a large scale project to
               ...
               links to dictionaries and grammars that facilitate further inquiry.[^: http://www.perseus.tufts.edu;
                     ; .]


![Sample Interface Showing Page Image and Transcription with Morphological
                  Links](resources/images/figure09.jpg)
...
How do we analyze the costs and benefits of this approach? The idea of just in
                  time conversion**Just in Time Conversion,
...
## Notes & References
               ...
               [http://archimedes.fas.harvard.edu/](http://archimedes.fas.harvard.edu/)

               [http://books.google.com/](http://books.google.com/)
Crane, G. **New Technologies for Reading: The Lexicon and the Digital
                  Library.****Classical World**
Crane, G. **Generating and Parsing Classical Greek.****Literary and Linguistic Computing**

               **Microsoft scans British Library BBC news online,**[http://news.bbc.co.uk/2/hi/technology/4402442.stm](http://news.bbc.co.uk/2/hi/technology/4402442.stm)

               [http://www.opencontentalliance.org](http://www.opencontentalliance.org)
Price-Wilkin, John. **Just-in-time Conversion, Just-in-case
                  Collections: Effectively leveraging rich document formats for the WWW.****D-Lib Magazine**[http://www.dlib.org/dlib/may97/michigan/05pricewilkin.html](http://www.dlib.org/dlib/may97/michigan/05pricewilkin.html)

               [http://zope.mpiwg-berlin.mpg.de/archimedes/archimedes_templates](http://zope.mpiwg-berlin.mpg.de/archimedes/archimedes_templates)
 Reddy, Sravana, and Gregory
               Crane. **A Document Recognition System for Early Modern
                  Latin.****Chicago Colloquium on Digital Humanities
                  and Computer Science: What Do You Do With A Million Books**

               Rydberg-Cox, Jeffrey A. **Automatic Disambiguation of Latin
                  Abbreviations in Early Modern Texts for Humanities Digital Libraries****Proceedings of the 2003 Joint Conference on Digital
                  Libraries**

               Rydberg-Cox, Jeffrey A. **Digital Libraries and the Challenges of
                  Digital Humanities**

               **Alliance Aims to Digitize Classic Books,****Seattle Times Books Section,**
