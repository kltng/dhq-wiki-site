...
Previous studies in the field of Digital Humanities have almost exclusively
                    ...
                    can thereby be provided in a digital reading environment #mccarty2002#smith2009#romanello2011#kalvesmaki2014**L’Année Philologique**
...
The first modelling choice that had to be made was to identify the named
                        ...
                        constituent components of a citation rather than as entities
                            themselves.[^: The former solution was the one adopted in  but further refinements to the annot]Ath.Pol.[Fig. 1](#figure01)
...
The example in [Fig. 1](#figure01)`REFAUWORK``REFSCOPE`Pliny,
...
How do we go from a plain text input to an output text that is annotated
                        ...
                        of annotation (see [Figure 3](#figure03)[^: The code I
...
In the third (and final) step the extracted named entities and relations are
                        ...
                        syntax specified by Canonical Text Services (CTS) protocol #smith2010#smith2012#smith2009[^: The Homer Multitext
...
CTS URNs are used within the annotated data to identify unambiguously
                        ...
                        for Vergil, the **Aeneid****Aen.**`urn:cts:latinLit:phi0690``urn:cts:latinLit:phi0690.phi003``urn:cts:latinLit:phi0690.phi003:6.851-6.853`[Fig. 1](#figure01)Aristophanes
...
Research in the field of citation network analysis has been focussing mainly on
   ...
   ]#wiberley2009#murai2005#murai2008
...
The approach I have taken to tackle this issue, inspired by a similar
                        approach developed by #schich2011
...
The macro-level network offers the most abstract view on the data and
                            ...
                            contained in a set of documents. [Figure 4](#figure04)[Table 1](#table01)
...
The meso-level network shown in [Figure 5](#figure05)Pliny, **nat.**Vergil, **georg.**compressed**Naturalis Historia****Vergil’s Georgics**
...
The highest degree of specificity and granularity is reached in the
                            micro-level network ([Figure 6](#figure06)Vergil, **georg.**
...
Finally, canonical citations extracted from journal articles and other secondary
                    ...
                    data was explored within the Hellespont project #romanello2012**Pentecontaetia**[^: GapVis for Hellespont, http://gapvis.hellespont.dainst.org/#book/1/read/89/.][fig. 7](#figure07)[^: A
