...
Traditionally, scholars have used their own experience and specialized training to supply these missing contextual data #emmanuel2021#niculae2014
...
As impressive as Ithaca is, deep neural network techniques
                    ...
                    inherent problem with using them is that they are black box#lecun2015
...
The **Inscriptions of Israel/Palestine**#satlow2022#satlow2022#elliott2006
...
The IIP dataset is converted into a single csv file
                    ...
                    very difficult problem #johnson2019Jerusalem
...
Penalization techniques are frequently used in digital
                    ...
                    example, Finegold et al. #finegold2016
...
Support Vector Regression (SVR) uses the same principle as
                    ...
                    machine learning techniques #drucker1996#argamon2009
...
We consider the performances of three kernels, linear,
                    ...
                    information about the SVR mechanism can be found in #drucker1996
...
Deep learning algorithms make predictions based on a
                    ...
                    #goodfellow2016#assael2022#brigato2021
...
We examine three different tree based machine learning
                    ...
                    considered to be the recommended tools to analyze tabular datasets #borisov2022#baledent2020#fragkiadakis2021
...
XGBoost is a tree ensemble machine learning algorithm that
                    ...
                    enables to learn from sparse data, and it can analyze data faster than other popular machine learning techniques #chen2016
...
Random forest can also be used to rank the predictor
                    ...
                    chosen to split the data #breiman2001#belgiu2016
...
To implement random forests, we only need to specify the
                    ...
                    result of variable importance #liaw2002#breiman2001#liaw2002
...
Metrics are used to quantify the accuracy of the machine learning model once we obtain the machine learning models. We will examine three commonly used metrics to evaluate the machine learning algorithm, root mean square error (RMSE), mean
                    ...
                    elements and use k-1 sets to train the model, while the remaining set is used to evaluate the model #hastie2009


#### 2.6 Programming


We use R version 4.1.3 to perform the data analysis and Python version 3.8.3 to obtain the XML dataset from the IIP database #satlow2022[https://github.com/daikitag/Inscriptions-of-Israel-Palestine](https://github.com/daikitag/Inscriptions-of-Israel-Palestine)
...
The results
                    ...
                    variables in the regression model are correlated with each other #alin2010#allen1997
...
In contrast, due to recent advances in machine learning
                    ...
                    with multicollinearity than traditional statistical techniques #chan2022
...
We describe the random forest model in detail, as it is
                    ...
                    as it is the default number of trees in R's randomForest package #liaw2002
...
Figure 5 (a) shows the variable importance plot of the random forest model. Variable importance is based upon the mean increase of mean squared error as a result of permuting a given variable #liaw2002
...
Our study also shows that linear models do not perform well compared with other methods
                    ...
                    The results also suggest that the predictability of neural network is not high compared with tree-based algorithms when we analyze tabular datasets. Many digital humanities datasets are tabular data and they are rarely large enough to effectively train
                        the deep learning
                        algorithm. Our results are consistent with the previous study by Shwartz-Ziv & Armon #shwartz-ziv2022
