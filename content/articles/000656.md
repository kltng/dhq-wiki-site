...
On April 14, 2003, the International Human Genome Sequencing Consortium, a
				...
				#bergeron2004Today we are learning the language in which God created life. We are
				...
				verge of gaining immense new power to heal#newyorktimes2000big data**Discriminating Data:
					Correlation, Neighborhoods, and the New Politics of Recognition**#chun2021
...
As with Chun’s previous contributions, **Control and Freedom****Programmed Visions****Updating to Remain the Same**We need to
				...
				the levels of procedure, prediction, and logic#chun2021
...
The monograph’s argument unfolds around four foundational concepts in computing:
				...
				based on their being like#chun2021sui generis correlation contains within it the seeds of manipulation,
					segregation and misrepresentation#chun2021microidentities
...
All three other foundational concepts are conceptually linked to correlation.
				...
				perpetuating those very biases in the name of comfort,#chun2021trained to be
					transparent#chun2021
...
Although Chun’s four foundational concepts might organize all computational
				...
				which users come to be authenticated and clustered #chun2021
...
For Chun, the transformation of society into an experimental lab is one which
				...
				embrace experimentation#chun2021
...
While Cambridge Analytica might have not been able to prove their claims, that has
				...
				practice in **Communicative Biocapitalism**#banner2017
...
As Hannah Arendt once argued, eugenics was able to find a home in German society,
				...
				institutional structures #arendt1963On the contrary in general the degree of responsibility
				increases as we draw further away from the man who uses the fatal instrument
				with his own hands#arendt1963
