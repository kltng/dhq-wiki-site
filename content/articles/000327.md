...
Over the past few decades, an ever-growing amount of cultural heritage
                    ...
                    overview of their contents #ruecker2011#whitelaw2015#trant2006
...
Whitelaw proposes to improve accessibility of online collections by designing
                    so-called generous interfaces, rich, browsable interfaces that reveal the
                        scale and complexity of digital heritage collections#whitelaw2015
                        a visual representation of every item in a given
                            collection, combined with tools for manipulating the display#ruecker2011
...
In this paper we demonstrate the use of a user-centred design approach for the
                    ...
                    different browsing tools to cater to their specific needs #stephenson1999
...
The Dutch Folktale Database is a good illustration of the accessibility problems
                    ...
                    is a preferred information seeking method for people working with folktales #labarre2012
...
In the project FACT (Folktales As Classifiable Texts), which forms the context
                    ...
                    database #nguyen2012#nguyen2013#trieschnigg2012#trieschnigg2013b#muiser2012accidental
...
One of the basic principles of user-centred design is to start by understanding
                    the users #gould1985#stephenson1999#preece2015
...
As a first step, we conducted a short poll among the website visitors of the
                    ...
                    The poll was similar to a survey on an earlier version of the website #trieschnigg2013aFor a school assignmentother
...
These findings by Trieschnigg et al. suggest that both casual and expert users
                    ...
                    restrictive #elbedweihy2012


An approach that seems suitable for meeting the information needs and search
                    preferences of both casual and advanced users is faceted search #english2002
...
Two dimensions of folktales, geographic location and date, were obvious choices
                    ...
                    tales came into existence #abello2012#tehrani2013
...
Geographical mapping as a principle can serve as a starting point for
                        ...
                        national collections, as advocated by Meder #meder2010donation
...
Similarity between folktales is of great interest to researchers who are
                        searching for the origins, kinship, variability and stability of tales #tehrani2013#nguyen2014#abello2012
...
Once a network has been built, it is possible to start exploring grouped
                        ...
                        with the frequently used Aarne-Thompson-Uther (ATU) folktale type-index #uther2004
...
We tested the usability of the new search interface using a Dutch translation
                        of the Standard Usability Test (SUS) #brooke1996I found
...
The results of the SUS test are calculated as described by Brooke #brooke1996
...
Given the complexity and size of the data that can be portrayed with maps,
                        ...
                        so that the interface remains clear and overseeable for users #harrower2008#jones2009#brown1999
...
We included the following filters: folktale subgenre (e.g., legends, jokes),
                        ...
                        for collectors than creators in the transaction logs analysed by #trieschnigg2013a
...
Participants were given three tasks that explored all the major elements and
                        ...
                        Usefulness, Satisfaction, and Ease of use (USE) questionnaire #lund2001
...
In this paper we have described our methodology for designing 'generous
                    interfaces' #whitelaw2015#ruecker2011#trieschnigg2013a
