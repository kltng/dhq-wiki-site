...
North.** ** Neon Wasteland.** ** Neon Wasteland.** ** Priya **devinenietal ** Priya ** Priya’s Mask.** ** Wonderscope **
...
Gunnar Liestøl (**textopia.** ** Modern
Polaxis **

Weedon et al.** Sherwood Rise ** Modern
Polaxis **signal the unexpected
and as a mechanism to narrate mystery, confusion, altered/distorted or magical
reality ** Sherwood Rise **was important to keep the
reader engaged across platforms ** Modern Polaxis **

### Theoretical perspectives

In AR literature, the reality of the
...
the internal organisation of storyworlds, which they described as entire modal universes consisting of multiple worlds central element is commonly interpreted as the actual world
...
transfictionality-gelais2005

Ryan fictional world system is an independent system whatever
...
many rules in the actual world can be broken in the TAW of the storyworld of minimal departure logical holes in the fabric of storyworlds
...
how actual and possible worlds relate within the storyworld. Umberto Eco
...
response-inviting structures devoid of any
connection with known reality would be incomprehensible literary text is
...
as the prisoners get to viewing reality[^: Modern Polaxis is written in capital letters only. For
readabi]
...
philosophical reference is the principle of time binding ** Modern Polaxis **the map is not the territory
...
** Modern Polaxis’s **[n]arratives that represent travel between different worlds in the
...
seen in connection to the fabula as a succession of states mediated by events with spiced rum
...
dedicated to the Polaxis of the future new reality begins
...
once, when the in-flight magazine says 2 July
...
appears as a dream triggered by the introduction of the concept of time binding. Time splits in two breakdown of cells
into light + Body transfer of the
future
...
airplane and bus seem to overlap position...Is not stable… fold psychoactive
...
layers than the time references. As Løvlie concept of placeplaces*Modern Polaxis*. It seems that the places in
...
believe in parallel worlds. Ryan stories could be credible for people who believe in
the occult.
...
monitor me of the first chemical agent to disrupt
Intafrag
...
fellow ancient keys to enter
Intafrag*Modern Polaxis*
...
According to Ryan every contradictory pair of propositions, one must be true
and another false in that world ** Modern
Polaxis **
...
the story. Physically, when reading ** Modern Polaxis **
...
what the text represents*** Modern
Polaxis ** Modern
Polaxis **

Regarding the question of how the interplay between worlds in AR literature may
affect the reader’s literary experience, we explore this through Iser’s effect*aísthēsis*
...
changes the visual style, in this case giving more emphasis to affect
...
starting point in the principle of minimal departure shapeshand-writtengutter
...
the reader, which is a prerequisite for immersion ** Modern Polaxis **

The narrative possibilities for tensions between the worlds in the case of ** Modern Polaxis ** devoted to difficult, non-immersive
works
...
can AR contribute beyond pop-up-like environments with sound effects

** Extension **adds new stories to the fictional world while respecting the facts
established in the original ** Wonderscope.** ** Modern
Polaxis **

In contrast to extension, modification ** Modern Polaxis ** Transposition
...
reality is unique to the AR experience ** Modern Polaxis **
...
While interactivity in ** Modern Polaxis **
...
The analysis of ** Modern Polaxis ** time for the most sake and set a wandering eye on different aspects of a place, idea or mood.** Modern Polaxis **
...
the story, as Helms points out ** Modern Polaxis **
...
AR fiction remind us of the challenges of interpretation. Iser between
