...
The ability to derive accurate information about human body poses and movements from
          ...
          digital humanities practice of "distant reading" of large collections of texts #arnold2019#wevers2019
...
Deep learning-based approaches tend to be faster and more accurate than prior computer
          ...
          and videos #elhayek2017#blok2018
...
K-pop gained considerable traction in the South Korean domestic entertainment market in
          ...
          1990s #kim2007#choi2014#lee2015a
...
The global ubiquity of online video sharing and streaming services, which accelerated
          ...
          promote South Korean cultural products globally #lie2012#unger2015#oh2015#messerlin2017#kim2015#han2017#jang2017#epstein2016#lee2015a#otmazgin2014#laurie2016#manietta2015#ota2015#oh2015#kim2017b#elfving2018#oh2015#jin2014#oh2014a#saeji2016
...
It is important to note that motion capture-based pose detection methods have been — and
          ...
          2010 respectively #reilly2013#sutil2015
...
The partial equivalence of deep learning pose estimation output to motion-capture data
          ...
          Notation in the 1940s as well as several other schemes #watts2015#rizzo2018#dong2017
...
One noteworthy motion-capture dance study, highly relevant to the present discussion, was
          ...
          Institute (ETRI), which also focused on K-pop dance #kim2017a#kim2017a[^: Such systems have yet to appear, though
            similar motion mimicry-based]#kim2018b#raptis2011
...
Many pose estimation models operate by collapsing the detected probabilistic "field" for,
          ...
          the first major open-source deep learning-based pose estimation project, OpenPose #cao2018#kumar2020#byeon2016#liu2019#mathis2018
...
When providing output coordinates for detected figures, human pose estimation models
          ...
          (Common Objects in Context) library #lin2015[Figure 1](#figure01)#cao2018
...
Other pose estimation models actually project the detected probabilistic body part fields
          ...
          "mesh" ([Figure 2](#figure02)#güler2018
...
Most pose estimation projects at present aspire to excel at figure detection and pose
          ...
          statistical "pose refinement" model to the output of other methods #moon2018#pavllo2019#andriluka2018
...
The accuracy of pose estimation models continues to improve as more varied training sets
          ...
          relationship to their environment #ahmadyan2020
...
Despite the relatively porous boundaries of K-pop vis-a-vis other forms of Korea-based
            ...
            production companies identified via online knowledge bases (Wikidata, MusicBrainz) #broadwell2016


We obtained the pose estimation data used in the case studies below by processing
            videos with software from the Open PifPaf project #kreiss2019[Figure 3](#figure03)[^: Computational image analysis techniques proceed at speeds much
              clo]
...
Solutions typically require devising a different "feature set" to describe the pose
            ...
            matrix" of the distances from each keypoint to every other keypoint ([Figure 4](#figure04)#giraldo2018
...
Another class of enhanced pose representation and comparison methods considers only
            ...
            calculating the Delaunay triangulation around the detected keypoints #delaunay1934[Figure 5](#figure05)#chung1997
...
A final obstacle is that most pose detection packages do not attempt to track the
            ...
            the duration of the video #xiu2018
...
Having chosen a set of methods that can represent a pose and quantify the similarity
            ...
            researchers as they move toward the "thick" analysis of dance at scale #geertz1973#börner2011
...
On a time-series correlation heatmap, repeated sections typically appear as dark lines
            ...
            here (highlighted in [Figure 6](#figure06)
...
Clustering necessarily sacrifices some precision, and requires judicious selection of
            ...
            we applied the OPTICS hierarchical density-based clustering algorithm #ankerst1999
...
The clustering analysis for this video found ten groups of poses using the settings
            ...
            pose in the cluster ([Figure 7](#figure07)[Figure 8](#figure08)
...
As visualized in [Figure 10](#figure10)
...
[Figure 12](#figure12)[Figure 10](#figure10)[Figure 11](#figure11)[Figure 11](#figure11)
...
Also present in Table 1 as well as Table 2 is an additional statistic that we were
            ...
            similarity time series, as visualized in [Figure 11](#figure11)[Figure 10](#figure10)
...
While our work has focused exclusively on K-pop videos, the encouraging results suggest
          ...
          allowing for the computational characterization of sub-genres #abello2012
