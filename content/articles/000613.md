...
transition*Daoxue ** Daoxue*cheng1942
...
and they were just different in specific methods of reform* Wengong ** Jinggong*luo1987
...
Hilde De Weerdt finds that *Daoxue*deweerdt1998GuanxueDaoxuethe monarch, the court, the local officials, the *shi *[^: A concept raised in the Zhou dynasty (1046–256 BCE) which was later explained as]*zuzong jiafa *invoked the image of a turning point in the Family Instructions
...
included in his academics opposition to *Xinxue *qiu1959*Xinxue*if Wang Anshi had not come into power or enacted a reform,
...
*i-th **j-th **lji **pji*bastian2009[^: The Louvain method is a heuristic method based on modularity optimization. Due t][^: The Laplacian dynamics is used to measure the quality of network partition. In b]
