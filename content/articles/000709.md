...
While the use of computational methods in corpus-level analysis has become
					...
					for traversing and exploring underlying documents in their collections.[^: Three examples of this style of tool are: JSTOR Labs Text Analyzer beta https://]#jo_etal2020#birhane_etal2022
...
**Project Quintessence**#bender_etal2021#chun2008
...
To that end, we have framed our project’s intervention as one of harnessing new
					...
					scale#whitmore2010#staley2015#gardenfors2014
...
The first strain of projects that influenced our approach are digital
						...
						techniques #gebru_etal2021#pechenick_etal2015#schmidt_etal2021
...
The third strain of influence upon our work has been projects specific to the
						...
						to encompass over 146,000 texts #mccollough_etal2019
...
Recent work in the digital humanities has rightly critiqued the over-reliance on
					spatial metaphors of analysis through terms like close-readingdistant-reading#da2019#bode2018**Quintessence**close readinghuman scalecomputational scale,**Quintessence**
...
Since the emergence of topic modeling in the toolkits of Digital
							...
							archetypal distant reading#meeks_etal2012**Project Quintessence**Topics
...
We trained a topic model with seventy-five topics on the EEBO-TCP corpus:
							the topics are displayed in [Figure 1](#figure01)#sievert_etal2014[^: Our proportion formula is:$$\frac{(\text{document length})\times(\text{document ][^: Due to the collapse of the
...
In addition to displaying the topic proportions for the archive, the
							...
							each topic – see [Figure 02](#figure02)
...
To the right of the topic visualization proper is another companion
							visualization ([Figure 03](#figure03)Relevance
							Metric,promisegod#sievert_etal2014
...
But again, the design of the topics page insists on a contextual
							understanding of each topic. The Info[Figure 04](#figure04)which print locations were printing herbals in
...
The EEBO-TCP archive contains texts from 1473-1700. We provide users
								...
								publication when analyzing topic composition #blei_etal2007#roberts_etal2019**Quintessence**
...
The animated view of the topic model depicted in [Figure 5](#figure05)
...
But due to the persistent nature of the subsetting function, one can
								...
								selected research archive ([Figure 07](#figure07)**Project Quintessence**
...
By training hundreds of word embeddings models on subsets of our corpus
							...
							search term quintessence[Figure 8](#figure08)#katricheva_etal2020
...
Due to their contextual specificity, word embeddings also emphasize
							...
							word actor[Figure 9](#figure09)Actorinstigator,plotterspectator
...
Another feature of Quintessence, due to the high number of smaller
							...
							idiosyncratic word usage. In [Figure 10](#figure10)Hamlet
...
Exploration of individual words in the corpus is also facilitated by
								...
								every instance of the chosen word in the corpus ([Figure 11](#figure11)tf-idf
...
Another function word embeddings allow for is the alignment of
								...
								historical archives, and is thus termed diachronic embedding#hamilton_etal2016**Project Quintessence**[Figure 12](#figure12)Similarity Score,


While recent empirical analyses of such embedding alignment methods
								have cast some doubt upon their reliability #hellrich_etal2018#hellrich2019
...
While idiosyncrasies found in the EEBO-TCP corpus are the norm for large
						...
						that bear little resemblance to those encountered in archival research #jo_etal2020
...
Our Document Viewer[Figure 13](#figure13)
...
As mentioned above, a project to produce a ground-up bidirectional encoding or
					...
					Distance**#wang_etal2018#gupta_etal2021#kusner_etal2015
