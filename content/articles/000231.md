...
aggregates of materials with an organic relationship**[^: For a further discussion of collection naming, see]
...
Encoding Initiative (TEI), of a very late-fourteenth century **Sentences****LombardPress**[http://lombardpress.org](http://lombardpress.org)[http://petrusplaoul.org](http://petrusplaoul.org)interactive dynamic editing
...
In the current prototype (an early incarnation of which can be found at [http://scta.info](http://scta.info)itemitem**Sentences**itemitemteiHeaderitemQuestion List listsitemitemitemitem
