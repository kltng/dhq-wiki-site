...
Amazing Adventures of Kavalier & Clay ** The Avengers **[^: Additional examples of
...
Culture ** English Language Notes ** Graphia: The Graphic Novel and Literary Criticism ** ImageTexT ** ImageTexT ** William Blake and Visual Culture,**
...
words — yet somehow in the shadow of both.,panels
...
The miniatures pictured in [Figure 2]()[Figure 3]()[Figure 3]()panels
...
By comics
Two pages from ** The Fantastic Four **
...
features of most comic books. While we typically say that we *watch **view **see **read*read
...
the text:panel[^: In this essay, XML elements are enclosed in angle brackets (<>) and
]cbml:paneldiv
...
sequence specified within a screen play or radio script[^: See for instance Johanna Drucker’s
...
`````cap``anon_man`teiHeaderteiHeaderanonymous man.teiHeaderteiHeader

In [Example 1]()anaana*analysis*,
...
transition types defined in his ** Understanding Comics **<interpGrp resp="" type="panelTransition">
<desc>
...
Dialogue is located in white balloons
...
distinctive balloons used to represent telepathic messages`<cbml:balloon type="telepathic">`audioaudio
An example, from ** The Amazing Spider-Man **audiosubtype-man_5
CBML code to represent the panel depicted in [Figure 9]()<cbml:panel characters="" n="3" xml:id="eg_ae1">
<cbml:balloon rendition="#uc" type="audio" subtype="telecast" who="" xml:id="eg_006">
...
realKablammo!*diegetic* is frequently used in film
...
marginalia and notes of various types. See [Figure 24]()[Figure 25]()
...
Digital Facsimiles](http://www.tei-c.org/release/doc/tei-p5-doc/en/html/PH.html#PHFAX)** TEI Guidelines **
...
Another option is to use the ana[above]()
...
[Figure 27]()renditionrenditionrend
...
prevalent.
A page from the Captain America feature in ** Tales of Suspense **
Two Golden Age examples of irregularly shaped panels. On the left is a page
by Carl Burgos from ** Marvel Mystery Comics ** Shelly ** Flash Comics **
...
comics narrative. In [Figure 30]()LEE STERANKO SINNOT ROSEN in Another Epic!** Tomorrow You Live Tonight I Die!,**
...
challenges for reading[Figure 31]()panels
One of many interesting examples from Will Eisner's influential
** Comics & Sequential Art **panels[Figure 31]()*and*panelspanelspanelpanelpanelcbml:panelanapanelsnote

In [Figure 26]()[Figure 32]()
A page from Simon and Kirby’s ** Captain America Comics **captain_america_1

[Figure 33]()** Marvel
Boy **[Figure 32]()[Figure 33]()interGrpinterpana
In Grant Morrison and J.G. Jone's ** Marvel Boy **
...
coming decades. Under current U.S. Copyright Law, ** Action Comics ** Fantastic Comics **fantastic_ ** Fantastic
