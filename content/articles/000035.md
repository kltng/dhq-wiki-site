---
title: "Conclusion: Cyberinfrastructure, the Scaife Digital Library and Classics in a
               Digital age"
id: 000035
...
date: 2009-02-26
type: article
keywords: ["classics", "cultural criticism", "corpora", "digitization", "data curation", "digital libraries", "infrastructure", "nlp", "publishing", "cultural heritage", "access"]
author_keywords: []
language: en
word_count: 21380
source: raw/articles/000035.xml
---

# Conclusion: Cyberinfrastructure, the Scaife Digital Library and Classics in a
               Digital age

**Authors:** [[Christopher_Blackwell]], [[Gregory_Crane]]

**Volume 003, Issue 1** (2009-02-26) | article | 21,380 words

**Keywords:** classics, [[media-studies-dhq]], [[corpus-methods-dhq]], [[archives-access]], [[archives-access]], digital libraries, [[tools-infrastructure-dhq]], nlp, [[publishing-dhq]], [[cultural-heritage]], [[archives-access]]


## Conclusion: Cyberinfrastructure, the Scaife Digital Library and Classics in a Digital
            Age
...
Emerson does not really define the title of his talk, but for those of us who
            ...
            Scaife embodied the best qualities that a phrase such as the **American Scholar**
...
A generation from now, the course that classical studies and the humanities in general
            ...
            such as Blackwell’s **Demos**[^: http://www.stoa.org/projects/demos/home]
...
In this conclusion, we synthesize some of the themes outlined and work described in the
            ...
            in the [introduction](/dhq/vol/3/1/000023/000023.html)**Phaedrus**[^: http://www.stoa.org/]
...
> And one day they taught Hesiod glorious song while he was shepherding his lambs
                     ...
                     Shepherds of the wilderness, wretched things of shame, mere bellies, we know
                        ...
                        we will, to utter true things.So said the ready-voiced daughters of great Zeus, and they plucked and gave me
                     ...
                     to sing of themselves both first and last.
...
The [introduction](/dhq/vol/3/1/000023/000023.html)
...
Consider a monolingual printed corpus such as English language newspapers in the
                  19th century United States. The 1869 **Rowell Newspaper
                     Directory**[^: George P. Rowell and Company’s American Newspaper Directory. New York: Geo.
    ]**Richmond Times Dispatch**[^: See http://www.perseus.tufts.edu/hopper/collection.jsp?collection=Perseus:collec]
...
Clearly we can begin to pursue topics that require analysis of much more data than
                  ...
                  Richard Dawkins coined the term memethoughts, ideas, theories, gestures, practices, fashions, habits,
                     songs and dances.[^: . The above is drawn from the Wikipedia entry on
                     the topic:]meme


While the term meme**Iliad**meme
...
The biological Plato, likewise, vanished more than two thousand years ago but his
                  ...
                  quotations and allusions that previous generations missed.[^: For more on the
                     eAQUA project, see their website http://www]
...
If we consider established genres of reference work such as lexica, grammars,
                  ...
                  memes that we could now begin to study. 
                     People and places: Any major person (Shakespeare, Abraham Lincoln) and
                        ...
                        beyond anything that we could analyze with traditional means.Languages: Few scholars study Latin much as they may wish to: no one can
                        ...
                        change in different genres and periods.Abstract concepts: Some concepts aggressively attempt to transcend
                        ...
                        metaphor for mathematical knowledge with its own history.Texts: The Greek texts of Plato’s **Republic****New Testament**
...
A memography contains elements that are deeply traditional in form and general
                  ...
                  materials so quantitatively broader in scope as to constitute a radical change.
                     **Demos****Demos****Demos****Overview of Greek Civilization**


A memography, in effect, applies the same principles to even larger topics and
                  immediately requires automated methods. **Demos**books**Demos**
...
Characteristics of a memography include: 
                        ...
                        Citation
                        Scale
                        Heterogeneity[^: http://archimedes2.mpiwg-berlin.mpg.de/archimedes_templates/project.htm;
       ]
...
> Socrates:When one says ironsilver
                        Phaedrus:Surely.
                        Socrates:What if he says justicegoodness
                        Phaedrus:Certainly.
...
In a famous paper, published in 1950, Alan Turing proposed what has been since
                  ...
                  whether we are conversing with a human or a machine.**Phaedrus**to which
                        *Alexander*what does this word mean?*oratio*speechprayer
...
Addressing Plato’s challenge has important implications for the problems that
                  ...
                  translated into English in 1981 as **Plato’s Pharmacy****Phaedrus****Phaedrus**


If we address the **Phaedrus**
...
In addressing Plato’s challenge, we focus less upon the 2% of instances where we
                  ...
                  concepts such as justicegoodness,iron*ἀρχή**ἀρχή*beginningempire.
...
The center of gravity for intellectual life in every developed or developing society
               ...
               workshop from which this collection emerges.[^: The NSF first began to use
...
Fifth, contemporary classical scholarship is multilingual. Many scientific
               ...
               results in at least four modern languages for which they are officially
                  responsible.[^: For a survey of recent work, see the Cross Language Evaluation
                 ]
...
Services define what we can accomplish. We develop collections in conjunction with
                  ...
                  up a particular passage by chapter and verse). We cannot call up Homer, **Iliad****Iliad***fecit**facio*to do, make*facio**fecit*[^: For a discussion of cyberinfrastructure and classical studies,
                 ]
...
Canonical text services allow us to call up canonical texts by standard
                     ...
                     in conjunction with Harvard’s **Center for Hellenic
                        Studies**[^: For
                        more on CTS, please see  and .]**Iliad**
...
Transcription captures the keystrokes. Page layout analysis captures the
                     logical structures implicit in the page.[^: For an overview of the state of
                        the art in this area, pl][^: Some promising initial work in table extraction from
                        dig]
...
Morphological analysis takes an inflected form (e.g, *fecit**3rd sg perfect
                        indicative active**facio*to do, make**Morph**[^: For more on Packard’s system, see , and for a discussion of Crane’s Morpheus, se]
...
Syntactic analysis identifies the syntactic relationships between words in a
                     ...
                     larger lexical patterns.[^: The development of the Latin treebank has been
                        documente]
...
Word sense discovery automatically identifies distinctive word usage in
                     ...
                     reveal words that are closely associated (e.g., phrases such as the English
                        ham and eggs[^: For some
                        relevant research in this area see , and for a
][^: The entry for the Latin word ira (anger) provides: 
                            ]*oratio*orationprayer.**Dynamic Lexicon for Greek and Latin**
...
Named entity identification provides semantic classification (e.g., is Salamis
                     ...
                     Salamis near Athens, Salamis in Cyprus or some other Salamis?).[^: For an
                        overview of named entity research, see  and for
 ][Advancing Knowledge
                        IMLS/NEH Digital Partnership](http://www.neh.gov/news/archive/20080826.html)[^: The named entity system for English has been
                        documented ]
...
Metrical analysis both discovers and analyzes the underlying metrical forms of
                     ...
                     canonical authors.[^: For recent work in metrical analysis see .]
...
Translation support aims at fluent translation of full text but can provide
                     ...
                     and phrases: e.g., given an instance of the Latin word *oratio*orationprayer[^: For
                        more on word sense disambiguation, please see ,
    ]list all Latin words that correspond to the English
...
Cross language information retrieval (CLIR) allows users to pose a query in one
                     ...
                     Arabic with an English query than if you searched with Arabic).[^: For some
                        recent overviews of the potential of CLIR for d]
...
Quotation identification can recognize where one text quotes — either precisely
                     ...
                     actionable citation information: e.g., it can recognize arma virumque
                        cano**Aeneid**[^: For more on plagiarism detection and quotation
                        identific][^: The results of this work can be found
                        in .]
...
Translation identification builds on both CLIR and quotation identification to
                     ...
                     that are on-line in large digital collections.[^: Recent work in translation
...
Text alignment services most commonly align translations with their source
                     texts and are components of word sense disambiguation systems.[^: For recent
                        work in text alignment see .]**Cybereditions Project**
...
Version analysis services can collate transcriptions of manuscript sources or
                     of different printed editions of the same work.[^: For relevant work in this
                        area, please see .][^: Influential work in this area that has greatly informed our
                    ]
...
The following describe some of the document types that we need in a digital
                  ...
                  editions and each contributes to the roles that textual data can play in a digital
                     environment.[^: The literature on the nature of digital editions is quite
                     e]
...
The contribution of [Dué and
                        Ebbott](/dhq/vol/3/1/000029/000029.html)
...
First, digital editions are designed from the start to include images of the
                     ...
                     after active work on the edition has ceased.[^: For further discussion of
                        this issue, see .]
...
Second, multitexts are versioned: they encode not only one reconstructed
                     ...
                     multiple editions.[^: For more on the importance of supporting versioned
                        multi]
...
The contribution of [Bamman and
                        Crane](/dhq/vol/3/1/000033/000033.html)
...
The contribution of [Bamman and
                        Crane](/dhq/vol/3/1/000033/000033.html)[^: http://wordnet.princeton.edu/; http://www.illc.uva.nl/EuroWordNet/][^: A bibliography of the
                        research publications using WordNe]
...
Treebanks are databases that label the syntactic role of each word in a set of
                     ...
                     can be used to analyze lexical, syntactic and even rhetorical patterns.[^: Bamman and Crane in this
                        collection; for sample Treebank]*ut* followed by a subjunctive.


Syntax is important but by no means the only subject of linguistic annotation.
                     Co-reference annotation maps pronouns to their referents (e.g., he[^: http://www.timeml.org/.]
...
The contribution by [Elliott and
                        Gillies](/dhq/vol/3/1/000031/000031.html)
...
The underlying principal of machine actionable indices is the same as that of
                     ...
                     headwords, hierarchical structures (e.g., Athens, (1) Religion …. (2)
                        Government …born at X,stood for consul in Y**Getty Thesaurus of Geographic Names****Thesaurus Linguae Graecae Canon**[^: See http://www.getty.edu/research/conducting_research/vocabularies/tgn/;
       ]
...
Such propositional reasoning rapidly becomes computationally complex. More
                     ...
                     began converting print reference works such as the **Oxford
                        English Dictionary**[^: .]


The Historical Event Markup and Linking (HEML) which [Bruce Robertson](/dhq/vol/3/1/000026/000026.html)[^: See http://heml.mta.ca/heml-cocoon/; http://www.tei-c.org/release/doc/tei-p5-doc]A has property B*Arma virumque cano, Troiae qui primus ab oris**fecit* has-language Latin and *fecit*
                     has-morphological-analysis; archê-in-passage-X has-sense empire.*agricola* is-a noun and *agricola* is-subject-of
                     ...
                     places and events in time.[^: http://cidoc.ics.forth.gr/]
...
Popular conceptions of institutions such as libraries evolve along with the
                  ...
                  longer inherently limited to physical locations.[^: For more on this theme see
                         and .][^: This issue
...
The passage quoted attributes to an intellectual of the second century CE the
                  ...
                  to library*bibliôn ktêsis*possession of books*diatêrêsanta*
...
In the past decade, the academic library system has quietly shifted again. The
                  ...
                  foundational data. The **Biodiversity Heritage Library**[^: See http://www.biodiversitylibrary.org/][^: American Museum of
                     Natural History (New York, NY); The Fiel]
...
But just because information is on-line does not mean that that information has
                  ...
                  which does not invest any significant sums in the research that it publishes.[^: and . For other on-line
                     sources on the serials crisis, see ][^: Crane first heard a report about the
                     serials crisis and a p][^: At http://www.library.cornell.edu/nihmandate/index.html, Cornell
               ]
...
The massive library collections at Harvard University have been a magnet for
                  ...
                  the Boston Library Consortium is often described as everyone but Harvard.to give the
                     ...
                     articles are not sold for a profit.[^: Harvard University News Release, February 12, 2008: http://www.fas.harvard.edu/h]request a waiver of the license
                     for particular articles where this is preferableThe goal of university research is the creation,
...
Google may ultimately solve the problem of access to the earlier print record.
                  ...
                  (and a striking amount of 19th century classical scholarship).[^: See http://books.google.com/]number over 7 million volumes, covering
                     thousands of years of civilization, from papyri to reports of the latest
                     advances in science and medicine.[^: http://www.lib.umich.edu/mdp/: accessed August 16, 2008; http://www.lib.umich.ed]searching free to the
                     publicno direct cost to end users.[^: Searching Free to the Public: Google agrees that to the extent that it or
      ][^: Google’s approach to mass digitization and open access has been
                ]
...
Classicists have already begun taking steps to make their core primary materials
                  ...
                  for the first thousand years of classical Greek, including at least one version of every Greek text known to us from
                     ...
                     through roughly the third century CE.[^: http://chs.harvard.edu/, accessed
                     September 30, 2008.][^: For
                     example, we have started to have a number of early edit]
...
First, the content must be of interest to someone other than its producers. In
                  ...
                  should not confuse the instrument of peer review with its purpose.[^: For a look
                     at how institutional repositories could help to ]
...
Third, the content must have at least one reliable long-term home. In print
                  ...
                  2008 reach more than half a billion machines.[^: The Internet Systems Consortium
                     published for January 2008 ]**D-Lib Magazine**#mccown2005[^: For more on the growing recognition of the importance of
                     in]
...
Fourth, the content can circulate freely — it is, indeed, truly public and thus
                  ...
                  Research Libraries invested more than 1.1 billion dollars in their
                     collections.[^: ARL Statistics 2005-06: http://www.arl.org/bm~doc/arlstats06.pdf, accessed Septe]


Peer review, the **Digital Humanities Quarterly**
...
The SDL contains durable digital objects that satisfy the four criteria of digital
               publication outlined above: 
                  The content has been judged worth preserving. Peer review is the most
                     established mechanism to establish this judgment. The content is in a defined, approved format suited for preservation over
                     long periods of time. Examples include XML documents encoded according to the
                     Guidelines of the TEI and of EpiDoc.[^: http://epidoc.sourceforge.net/; see also Hugh Cayless’ piece in
                     ...
                     objects in the SDL.  Each object is available under an open license. Where authors create
...
Finally, the SDL is an organization designed to produce new content. The production
               ...
               particular third party (e.g., **DHQ**
...
The SDL does not, however, provide services for end users. The SDL may include the
               ...
               preservation systems (such as LOCKSS) and in thousands of informal
                  collections.[^: LOCKSS stands for Lots of Copies Keeps Stuff Safe a
                  program ba]
...
> Master Tyndale happened to be in the company
                  ...
                  these blasphemous words, We were better to be without God's laws than the
                     pope's.I defy the pope, and all his laws,If God spared him life, ere many years he would cause a boy that driveth
...
The papers in this collection have focused upon the practices of scholarship. In this
               ...
               eyes of many, more closely resemble the bullying Theban Herald of Euripides’ **Suppliants***turannos polis*, a city-state in which
...
Professional academics have played, insofar as we can tell, almost no direct role
               ...
               worse than those of conventional, centralized reference works.[^: See  (also available at http://chnm.gmu.edu/resources/essays/d/42) and .]
...
No one knows how much labor the various language versions of Wikipedia have absorbed
               ...
               of 4.6 million dollars for 2007-2008.[^: See http://wikimediafoundation.org/wiki/Budget/2005 and http://wikimediafoundati]
               ...
               We now see a world emerging with much lower barriers for entry. 
                        ...
                        **Tangible contributions**. Automated methods can do an
                        ...
                        essays by [Blackwell and
                           Martin](/dhq/vol/3/1/000024/000024.html)[Elliott
                           and Gillies](/dhq/vol/3/1/000031/000031.html)[Bamman and Crane](/dhq/vol/3/1/000033/000033.html)When given a particular set of tags and relationships most readers will
                        ...
                        **Undergraduate research**. Once we have large databases of
                        ...
                        patterns were visible despite the noise of a 50% error rate.[^: .]New sources of data open up possible research topics to which our advanced
                        ...
                        practical before (e.g., the semantics of words for power
...
The seeds of these new organizations are visible in the Digital Knowledge Center in
               ...
               universal access.[^: In the public information Google reports (http://books.google.com/googlebooks/hi]
...
> I see here the spirit of my dead mother; she sits in silence near the blood,
                        ...
                        prince, how she may recognize that I am he.[145] So I spoke, and he straightway answered, and said: Easy is the word
                        ...
                        but whoever you refuse, he surely will go back again.[150] So saying the spirit of the prince, Teiresias, went back into the house
                     of Hades, when he had declared his prophecies; but I remained there steadfastly
                     until my mother came up and drank the dark blood. At once then she knew me.
...
> Fifty sons I had, when the sons of the Achaeans came; nineteen were born to
                        ...
                        reach forth my hand to the face of him that hath slain my sons.So he spoke, and in Achilles he roused desire to weep for his father; and he
                     took the old man by the hand, and gently put him from him. So the two thought
                     of their dead, and wept.
...
A new, digital infrastructure provides the explicit subject for this collection of
               ...
               a quarter century ago.[^: In 1982, the Harvard Classics Department paid $34,000 for
                  a 66]
...
Atkins, Daniel E., et al.
                  **Revolutionizing Science and Engineering Through
                  Cyberinfrastructure: Report of the National Science Foundation Blue-Ribbon
                  Advisory Panel on Cyberinfrastructure**[http://www.nsf.gov/od/oci/reports/atkins.pdf](http://www.nsf.gov/od/oci/reports/atkins.pdf)
Bamman, D. and G. Crane.
                  **Building a Dynamic Lexicon from a Digital Library.****Proceedings of the 8th ACM/IEEE-CS joint conference on
                  Digital libraries**
Bamman, D. and G. Crane.
...
Bamman, D. and G. Crane.
                  **The Design and Use of a Latin Dependency Treebank.****TLT 2006: Proceedings of the Fifth International Treebanks
                  and Linguistic Theories Conference**
Bankier, J.-G., and I.
               Perciali. **The Institutional Repository Rediscovered: What can a
                  University do for Open Access Publishing.****Serials Review**
Berti, M. and V. Costa.
                  **Alexandria and the Mirage of a Million Book Library.****The World's Greatest Libraries:
                  From Ancient Alexandria to the 21st Century.**
Byrne, K. **Named Entity Recognition in Historical Archive Text.****ICSC 2007: International Conference on Semantic
                  Computing**
Campbell, J. D.
                  **Changing a Cultural Icon: The Academic Library as a Virtual
                  Destination.****Educause Review**[http://connect.educause.edu/Library/EDUCAUSE+Review/ChangingaCulturalIconTheA/40602?time=1195059427](http://connect.educause.edu/library/educause+review/changingaculturaliconthea/40602?time=1195059427)
Cardey, S. et al. **The Development of a Multilingual Collocation Dictionary.****Proceedings of the Workshop on Multilingual Language
                  Resources and Interoperability,**[http://www.aclweb.org/anthology-new/W/W06/W06-1005.pdf](http://www.aclweb.org/anthology-new/w/w06/w06-1005.pdf)
Carpuat, M. and D. Wu.
                  **Word Sense Disambiguation vs. Statistical Machine
                  Translation.****ACL '05: Proceedings of the 43rd
                  Annual Meeting on Association for Computational Linguistics**
Crane, G. **Generating and Parsing Classical Greek.****Literary & Linguistic Computing**
Crane, G. and A. Jones.
               2005. **The Perseus American Collection 1.0.**[http://dl.tufts.edu//view_pdf.jsp?urn=tufts:facpubs:gcrane-2006.00001](http://dl.tufts.edu//view_pdf.jsp?urn=tufts:facpubs:gcrane-2006.00001)
Crane, G. and A. Jones.
                  **The Challenge of Virginia Banks: An Evaluation of Named
                  Entity Analysis in a 19th Century Newspaper Collection.****Proceedings of JCDL 2006**[http://dl.tufts.edu/view_pdf.jsp?pid=tufts:PB.001.001.00007](http://dl.tufts.edu/view_pdf.jsp?pid=tufts:pb.001.001.00007)
Dawkins, R. **The Selfish Gene**
Dekhtyar, A. et al.
                  **Support for XML Markup of Image-Based Electronic
                  Editions.****International Journal on Digital Libraries**
Deng, Y., et al. **Segmentation and Alignment of Parallel Text for Statistical Machine
                  Translation.****Natural Language Engineering**
Derrida, J. **Plato's Pharmacy.****Dissemination**
Eder, M. **How Rhythmical is Hexameter: A Statistical Approach to Ancient Epic
                  Poetry.****Digital Humanities 2007**[http://www.digitalhumanities.org/dh2007/abstracts/xhtml.xq?id=137](http://www.digitalhumanities.org/dh2007/abstracts/xhtml.xq?id=137)
Emerson, Ralph Waldo.
                  **The American Scholar.****The
                  Collected Works of Ralph Waldo Emerson, Volume 1: Nature, Addresses, and
                  Lectures**[http://www.apstudent.com/ushistory/docs1801/amrschol.htm](http://www.apstudent.com/ushistory/docs1801/amrschol.htm)
Ernst-Gerlach, A. and G. Crane. **Identifying Quotations in
                  Reference Works and Primary Materials.****Proceedings
                  of the 12th European Conference on Research and Advanced Technology for Digital
                  Libraries (ECDL 2008)**
Feng, S. and R. Manmatha.
                  **A Hierarchical, HMM-based Automatic Evaluation of OCR
                  Accuracy for a Digital Library of Books.****JCDL '06:
                  Proceedings of the 6th ACM/IEEE-CS joint conference on Digital libraries**
Foxe, John. **Acts and Monuments**[http://en.wikisource.org/wiki/The_Book_of_Martyrs/Chapter_XII](http://en.wikisource.org/wiki/the_book_of_martyrs/chapter_xii)
Giles, J. **Internet Encyclopaedias go Head to Head.****Nature**
Grafton, A. **Future Reading: Digitization and Its Discontents.****New Yorker**[http://www.newyorker.com/reporting/2007/11/05/071105fa_fact_grafton?currentPage=all](http://www.newyorker.com/reporting/2007/11/05/071105fa_fact_grafton?currentpage=all)
Hahn, Karla L. 2008. **Talk About Talking About New Models of Scholarly
                  Communication.****Journal of Electronic Publishing**[http://hdl.handle.net/2027/spo.3336451.0011.108](http://hdl.handle.net/2027/spo.3336451.0011.108)
Hockx-Yu, H. **Digital Preservation in the Context of Institutional
                  Repositores.****Program: Electronic Library & Information Systems**
Ide, N., and J. Veronis. **Introduction to the Special Issue on Word Sense Disambiguation: the
                  State of the Art.****Computational Linguistics**
Johnson, R. K. **In Googles Broad Wake: Taking Responsibility for Shaping the Global
                  Digital Library.****ARL: A Bimonthly Report on Research Library Issues and Actions
                  from ARL, CNI, and SPARC**[http://www.arl.org/bm~doc/arlbr250digprinciples.pdf](http://www.arl.org/bm~doc/arlbr250digprinciples.pdf)
Jones, G, et al. **Multilingual Search for Cultural Heritage Archives via Combining
                  Multiple Translation Resources.****Proceedings of the
                  Workshop on Language Technology for Cultural Heritage Data (LaTeCH 2007)**[http://www.aclweb.org/anthology/W/W07/W07-0911](http://www.aclweb.org/anthology/w/w07/w07-0911)
Kaufman, P. and J.
               Ubois. **Good Terms Improving Commercial-Noncommercial
                  Partnerships for Mass Digitization.****D-Lib Magazin**[http://www.dlib.org/dlib/november07/kaufman/11kaufman.html](http://www.dlib.org/dlib/november07/kaufman/11kaufman.html)
Liu, Y, et al. **TableSeer: Automatic Table Metadata Extraction and Searching in
                  Digital Libraries.****Proceedings of JCDL
                  2007**
Lu, X., et al. **Intelligent Parsing of Scanned Volumes for Web Based Archives.****ICSC 2007:International Conference on Semantic Computing**
Marchionini, G. and G. Crane. **Evaluating Hypermedia and
                  Learning: Methods and Results from the Perseus Project.****ACM Transactions on Information Systems**
Marchionini, G., R. Scaife, et al. **1997-2000 Final Evaluation
                  Report on the Perseus Project Publication Model,**[http://ils.unc.edu/~march/perseus/final_report.pdf](http://ils.unc.edu/~march/perseus/final_report.pdf)
Martin, T. R. **Ancient Greece: From Prehistoric to Hellenistic Times**
McCown, F., S. Chan, et
               al. **The Availability and Persistence of Web References in D-Lib Magazine.****Proceedings of the 5th International Web Archiving Workshop and
                  Digital Preservation (IWAW'05)**
Mobley, E. R. **Ruminations on the Sci-Tech Serials Crisis.****Issues in Science and Technology**[http://www.library.ucsb.edu/istl/98-fall/article4.html](http://www.library.ucsb.edu/istl/98-fall/article4.html)
...
Nadeau, D. and S. Sekine.
                  **A Survey of Named Entity Recognition and
                  Classification.****Lingusticae Investigationes**
Packard, D. W. **Computer-Assisted Morphological Analysis of Ancient Greek.****Proceedings of the 5th Conference on Computational
                  Linguistics**
Panitch, J. M. and S.
               Michalak. **The Serials Crisis.****UNC-Chapel Hill Scholarly Communications Convocation**[http://www.unc.edu/scholcomdig/whitepapers/panitch-michalak.html](http://www.unc.edu/scholcomdig/whitepapers/panitch-michalak.html)
Pantel, P. and D. Lin.
                  **Discovering Word Senses from Text.****Proceedings of the eighth ACM SIGKDD International conference on
                  Knowledge Discovery and Data Mining**
Parrott, J. **The Crisis in Scholarly Publishing**[http://www.lib.uwaterloo.ca/society/crisis.html](http://www.lib.uwaterloo.ca/society/crisis.html)
Petrelli, D., et
               al. **Which User Interaction for Cross-Language Information
                  Retrieval? Design Issues and Reflections.****Journal of the American Society for Information Science and
                  Technology,**
Pomerantz, J.
               and G. Marchionini. **The Digital Library as Place.****Journal of Documentation**
Porter, D., et al. **Creating CTS Collections.****Digital
                  Humanities 2006**
Pouliquen, B. et
               al. **Automatic Identification of Document Translations in Large
                  Multilingual Document Collections.****In Proceedings of the International Conference Recent Advances in Natural Language Processing (RANLP
                  2003)**
Pritchard, D.
                  **Working Papers, Open Access and Cyber-Infrastructure in
                  Classical Studies.****Literary & Linguistic Computing**[http://hdl.handle.net/2123/2226](http://hdl.handle.net/2123/2226)
Raymond, D. R. and F.
               W. Tompa. **Hypertext and the New Oxford English
                  Dictionary.****Proceedings of the ACM Conference on
...
Romanello, M.
                  **A Semantic Linking Framework to Provide Critical Value-Added
                  Services for E-Journals on Classics.****ELPUB 2008: Open Scholarship: Authority, Community, and
                  Sustainability in the Age of Web 2.0 - Proceedings of the 12th International
                  Conference on Electronic Publishing**[http://elpub.scix.net/data/works/att/401_elpub2008.content.pdf](http://elpub.scix.net/data/works/att/401_elpub2008.content.pdf)
Rosenzweig,
...
Sankar, P., et al. **Digitizing a Million Books: Challenges for Document
                  Analysis.****Document Analysis Systems VII**
Schilit, B. N., and O.
               Kolak. **Exploring a Digital Library Through Key Ideas.****JCDL '08: Proceedings of the 8th ACM/IEEE-CS Joint Conference
                  on Digital Libraries**
Schreibman,
               S. et al. **The Versioning Machine.****Literary and Linguistic Computing,**
Shirky, C. **Here Comes Everybody: the Power of Organizing without
                  Organizations**
Smith, A. **The Research Library in the 21st Century: Collecting, Preserving,
                  and Making Accessible Resources for Scholarship.****No Brief Candle: Reconceiving Research Libraries for the 21st Century,**[http://www.clir.org/pubs/reports/pub142/smith.html](http://www.clir.org/pubs/reports/pub142/smith.html)
Toselli, A., et. al.
                  **Viterbi Based Alignment between Text Images and Their
                  Transcripts.****Proceedings of the Workshop on Language Technology for Cultural
                  Heritage Data (LaTeCH 2007)**
Turing, A. **Computing Machinery and Intelligence.****Mind**
Wilhelm von
               Humboldt, **Lecture to the Prussian Academy,**#vonranke1973
Von Ranke,
               Leopold. **The Theory and Practice of History**
Zaslavsky, A. B.
               et al. **Using Copy-Detection and Text Comparison Algorithms for
                  Cross-Referencing Multiple Editions of Literary Works.****ECDL '01: Proceedings of the 5th European Conference on Research and
