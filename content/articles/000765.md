...
virtual object on physical space[https://apps.apple.com/us/app/booksnake/id1543247176.](https://apps.apple.com/us/app/booksnake/id1543247176.)
...
enables users to compare two images from different repositories side-by-side.d.high-resolution zoomable images.d.
...
from nowhere doesn't make everything equal, it just makes everything
the same size,
...
through our bodies, from our individual point of view. Humans are not simply two eyeballs attached by stalks to a brain computer, particularity and
embodiment of all vision*intellectual* critique of how these image viewers
...
Booksnake as they are when viewed in a flat-screen viewer. (There is no unmediated photograph, spaces drawn from a point of view, rather than as if
...
knowledges-kee_latina_sadoyan_2020
...
life-size artworks, wherever you are.d.
...
of Booksnake supports the IIIF v2.1 APIs. We].d..d..d.
...
virtual objects to horizontal and vertical surfaces.d._a.d._b
...
along with the physical units of measure[^: David Newberry's IIIF for Dolls
...
Dimensions ** Linking to External Services **[https://iiif.io/api/annex/services/-dimensions](https://iiif.io/api/annex/services/%23physical-dimensions)
