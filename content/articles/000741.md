...
the famous Roberto Busa’s ** Index Thomisticus **[2016]()[^: Beside the now famous first part of A Companion to
Digital Humanities
]
...
needs to focus on the *rationale **results*thomas2004*methods*hockey2004
...
Europe[^: Following Busa’s work on Saint Thomas Aquinas, many medievalist philosophers hav][^: The outcome of the
...
texts[^: All translations in this article are mine.][Computer and Medieval Data Processing]()** CAMDAP **[^: For an example of the first uses of the directory of scholars active in the CAMD]

During this process, the ** CAMDAP **similar service of information and coordination[^: Paul Tombeur was the director of one of the most important computer centers in t]
...
médiévale **[^: The most represented country in that list was France (11), then came Germany (5)]
...
participants took place at the EFR ** Francia **
...
critical rules valid for each of these genre each element of
each testimoniesa rigorous and total history
...
and cannot be solve without tracking every uses of a given word.** Francia ** Are we going to impose on scholars the immense and tedious task of going through all
...
The first one concerned what he called unnecessary duplication undertakings
...
(1913–2001), supervisor of the aforementioned 1427 Florentine catasto
...
The IRHT, created in 1937 as the first humanities’ laboratory of the CNRS, was a resource

In that context, Fossier acted as an agent of cooperation between both her institutions. In 1970, she
co-authored an article in the ** Annales ESC **crehange_etal1970
...
put in common their perplexities and their desire to search for new solutions.
...
value and most often anonymous.
...
collection of 13th-century papal registers begun in 1884 by the École de Rome and ended in the late 1990s if he benefits, one day, from a
perfect edition, he [the historian] wants in the immediate future to be able to use the sources already
stripped and asks that they be at his disposal even before they are put into final form.
...
indexesindexation documentaire
...
day documentaireclosed researchthe recorded tape or disk is no
longer of interest
...
Second, medievalists could follow certain imperativesimpératifs
...
those interested? bestmake it known that a set has been entered into the
...
rigor; some even omit to say the type of computer employed.,
clear, complete

In 1975, shortly after the Rome colloquium, Genicot published in ** Francia ** Pour une réorganisation de la recherche en histoire médiévale ** Model of Description **
...
conditions of progress. History is no exception to this law.
...
As mentioned in [Section 1.3](.3)identify existing
projects by means of a questionnaireestablish cooperation [...]
between specialized laboratories [...] in order to exchange programsencourage [...] the creation of data banks
...
computer processing for medieval historians will always remain an individual matter of bringing an agreement between already
...
that they needed: not to give, but to receive information. out to the public of medievalists, offering
them information that would touch them closely[^: The editorial
board of that publication was formerly composed of seven sc]** Le Médiéviste et l’ordinateur **

#### 2.3 The Birth of a Scientific Network in Medieval History Computing.

The first issue of ** Le Médiéviste et l’ordinateur **
...
The list of subscribers is preserved in the archives of the IRHT in Orléans. It shows that ** Le Médiéviste et l’ordinateur **
...
conference for the ten years anniversary of ** Le Médiéviste et l’ordinateur **
...
newsletter, ** Le Médiéviste et l’Ordinateur **

In 1986, Jean-Philippe Genet (1944–), one of the most active historians on the editorial committee in the 1980s,
created, with some former contributors to the newsletter, a peer-reviewed journal named ** Histoire et Mesure **

Genet’s role in the development of the computing history ** Association for History and Computing.** ** Le Médiéviste et l’ordinateur **
...
reconstruction: effects of digitalization on ideas, behaviours, products and institutions ** Mittelalterforschung in Münster in der Nachfolge des Sonderforschungsbereichs 7 ** Frühmittelalterliche Studien **[https://doi.org/10.1515/9783110242225.380](https://doi.org/10.1515/9783110242225.380)
