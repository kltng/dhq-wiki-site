...
Recent research into the nature of morphology has demonstrated the feasibility of two alternative approaches to the definition of a language’s inflectional system. Central to both approaches is the notion of an inflectional paradigm. In general terms, the inflectional paradigm[cells](#glossary)[^: See the glossary for a definition of technical terms.]*walk* includes cells such as `<WALK, {3rd singular present indicative}>``<WALK, {past}>`*walks* and *walked*.


Given this notion, one approach to the definition of a language’s inflectional system is the realizational#matthews1972#zwicky1985#anderson1992#corbett1993#stump2001*walks* is deduced from 
...
An alternative approach to the definition of a language’s inflectional 
       system is the implicative#blevins2005#blevins2006#finkel2009*hældon* 
               healed (plural)*hælde* 
...
Despite their differences, both approaches are capable of generating 
       ...
       first present a realizational analysis of Latin in the KATR language #finkel2002#evans1989
...
As we demonstrate below, the realizational approach leads to a Latin KATR 
       theory that provides a clear picture of the morphology of Latin verbs. Different audiences might find different aspects of it attractive.
         ...
         [diacritics](#glossary)[sandhi](#glossary)A **teacher** of the language can use the theory as a foundation for organizing lessons in morphology.A **student** of the language can suggest verb roots and use the theory 
...
A theory in KATR is a network of [nodes](#glossary)
...
In our case, Rule 2 of `Praise`default rule[Figure 1](#figure1)
...
`active,indicative,imperfective,present,sg,1`
                        ...
                        `laudātīerunt``Praise`provisioning#finkel2007b`VerbA`
...
By way of contrast, we also present the `VerbIO`*i*-stem third-conjugation verbs such as *facere* and *capere*.
     ...
     VerbIO: 
       ...
       9 <> == Verb:<conj3io>     
     *overriding*[morphophoneme](#glossary)*i* or an *e*, depending on surrounding context, during a postprocessing step.
...
SuffixPerson: 
         ...
         5 <> == SuffixalVowel Desinence[desinence](#glossary)*m* (Rule 1) but 
       sometimes *ō* or *ī*.
...
The last step is to remove essentially identical columns. Two columns are essentially identical if there is a one-to-one and onto mapping between the [exponences](#glossary)**distillations**.
...
We can define several kinds of principal-part systems #finkel2007a
...
Computing the adaptive principal parts produces one way to see the interrelation of the conjugations, as shown in [Figure 2](#figure2)#wikipedia2009
...
We can generate a KATR theory directly from the paradigm of [Table 2](#table2)[Table 3](#table3)[Table 4](#table4)[Figure 3](#figure3)[Figure 4](#figure4)
...
The implicative approach also has the advantage that it allows us to analyze the principal parts of the language based solely on the exponences in the paradigm chart. We have taken advantage of that ability elsewhere to characterize languages based on properties of their principal parts #finkel2007a
