...
The Black Drama collection developed by Alexander Street Press has, at the time of this work,
    ...
    of the 19th century to the present, including many previously unpublished works #bldr2005random
...
The ARTFL search system, PhiloLogic #philologic2007n-word[^: It is important to mention that this term occurs much more frequently than less ]n-word
...
For this preliminary experiment, we achieved accuracy rates ranging 85% to 92% depending on
    ...
    Weka ([[Weka3]], #weka3[^: The Weka3 system refers to Sequential Minimal Optimization (SMO) which is one of]#ruiz1998
...
The efficacy of this classification task is matched, to some degree, by the less than
    startling features most strongly associated with the two bodies of texts. [Appendix One](#appendix1)hallwaydowntowncrown,palace,politicianscorruption.
...
Classification tasks based on the gender of authors, characters, and a combination of the two
    ...
    they generate are less obviously distinctive #argamon2003#koppel2002
...
Given the ability to classify author and character genders, we will now return to the texts
    ...
    Two](#appendix2)[Appendix Three](#appendix3)chief, order,
...
This same character gender classification test on non-American authors yields feature sets
    suggesting even more disparate depictions of the sexes than among American authors. Appendices [6](#appendix6)[7](#appendix7)whichwhom.
 ...
 Argamon, Shlomo, Moshe Koppel, Jonathan
   Fine, Anat Rachel Shimoni. **Gender, Genre, and Writing Style in Formal
    Written Texts****Text**
               ...
               **Black Drama - 1850 to the Present**[http://solomon.bld2.alexanderstreet.com/](http://solomon.bld2.alexanderstreet.com/)
 Joachims, T. **Making
