...
datificação-schönberger2013e-sciencebig data
...
interpretação*mediadora*machlup1962*caráter
relacional*só realiza um valor semântico através de
processos seletivos e interpretativosálezdegómez1999*função **formatação*castiglione2009[^: Castiglione
...
Partindo da perspectiva dos estudos sociais da ciência, Bruno Latouróveis imutáveisimmutable
mobiles
...
cada vez maiores de eventos em um único ponto... globo, por definição, não é global, mas é, quase
...
recrutamento![^: Para Latour, fatos
...
algumas informações, ao mesmo tempo em que omitindo outras observacionais que não podem
...
leitura de si mesmos, do outro e do seu espaço leitura de mapas segue um
...
conjuntos de dados, informações e conhecimentos[^: Tipo
de cartografia que se baseia na elaboração ]#câmara2001
...
digitalização-schönberger2013desmaterialização toda a cadeia de produção – uma
...
como modo de representação objetiva da materialidade do espaço conhecimento geográfico virtualizado sobre o
...
papel dos especialistas nessas ferramentas na determinação da nossa imagem do mundo, da
...
frequência na Amazôniaões2016[^: O foco tem sido dar protagonismo às percepções
d]
...
projeto coordenado pelo Instituto Br]
...
fundamentados. gente tem que sentar junto
...
mapeamento, (auto)organização e conhecimento das populações locais#dávila2017
...
Acselrad, H. (org.). (2013) ** Cartografia social, terra e território ** Albagli, S.
