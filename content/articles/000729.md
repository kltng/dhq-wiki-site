...
As can be seen in [Figure 1](#figure01)[Section 3.2](#section03.2)
...
Annotation in linguistics, which can be very broadly defined as the act of associating descriptive or analytic notations with language data#ide2017#honnibal_etal2020**Natural Language Tool Kit**#bird_etal2009part of speech[Table 1](#table01)#schiller_etal1999
...
As can be seen, every word (and punctuation) is associated with a specific label, which clarifies their part of speech function within the utterance. Within DiÖ, two different sets of labels are used – a universal#schiller_etal1999#honnibal_etal2020
...
While it appears to be the rule rather than the exception that a linguistic research question working with corpora requires researchers to further (manually) annotate their data in some way (cf. #smith_etal2008#newman_etal2020rather patchy,#smith_etal2008


This is a further reason to lay out the manual annotation process of DiÖ. In contrast to the automatic annotations discussed in [Section 3.1](#section03.1)[Section 2.2](#section02.2)


[Figure 1](#figure01)[Section 2.2](#section02.2)answers[^: These language production experiments usually consist of a visual stimulus (a pi]


Another important entity within the database scheme is that of the tags themselves: these are, in contrast to the part of speech tags (see [Section 3.1](#section03.1)[^: Responses are not part of speech tagged as their smallest unit is not the word l]


Consider, for example, a researcher being interested in a specific morphological phenomenon (e.g. variation in comparative and superlative forms of adjectives, such as <dünkler>/<dunklicher> darkerdark[^: See  for further information on variation of comparative forms in German in Aust]Tagging,Tags_to_Answers[Figure 1](#figure01)


In [Figure 1](#figure01)


A further attribute of individual tags deserves more detail: that of the generation. DiÖ employs a hierarchical tagging system for manual annotations (in contrast to the flat/one-dimensional model used for automatic annotations, where any notion of hierarchy is, at best, implicit). The individual tags are organized as tag families in a parent-child relationship on different generations, wherein certain tags (the childrenparent[Figure 2](#figure02)
...
Transcription and annotation of the open settings is separated in two different interfaces.[^: For the transcription interface, which was also developed in-house, see .][Figure 4](#figure04)[Figure 5](#figure05)#shneiderman_etal2004
...
Before turning to specific examples of tagsets used within DiÖ, a brief note on the technical advantages of setting up annotations this way is in order (advantages of the semantics of the tagging system are discussed in [Section 4](#section04)#smith_etal2008
...
The first example of a tagset as used in DiÖ is concerned with the variation of unstressed <-ig>, especially in more standard-speaking contexts, and the data tagged with it resulted in the publication #lanwermeyer_etal2019[^: The tagset itself was designed by Johanna Fanta-Jende and Manuela Lanwermeyer wi]


The tagset used to arrive at the conclusions of #lanwermeyer_etal2019[Table 2](#table02)[Figure 7](#figure07)
...
As for the features of the categories laid out in [Table 3](#table03)demanding confirmationdeclaring insecurity,miscellaneous
...
The example tagged in [Figure 8](#figure08)not,
...
As has been argued that annotation, even though it is an elementary research practice in the humanities, is often severely undertheorized (cf. #lordick_etal2016merely#magnus2018
