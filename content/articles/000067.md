...
droplets,crystal,capsule,lens,charm,filter,system state,kernel,hockey puck.droplet,oil and water
...
In the area of digital images,

For tools related to text files,
...
otherwise it would be a case of a redesign rather than a new tool
...
Working from our original map of over a dozen potential metaphors ([Figure 2]()
...
are in relation to one another but not in immediate contact ([Figure 5]()
...
this metaphor, we can use the external contour of the composite droplet ([Figure 9]()
