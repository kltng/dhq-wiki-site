...
Eleven years after its endorsement by the World Wide Web Consortium, XML has been
               ...
               application domains, from standards for electronic filing of federal income tax #irs2007#goodger2001
...
Despite its success, however, XML has not lived up to many librarians' expectations
               ...
               encoding and semantic inconsistencies #shreeves2005datedc:date
...
Perhaps more surprising is the failure of XML to ensure interoperability at a
               syntactic level.[^: As a reviewer for this article noted, the meaning of
                     intero]structural metadata#hurley1999#dilauro2005#shirky2005
...
While some of the failures experienced by the Library of Congress NDIIPP tests were
               ...
               NDIIPP tests, state, 
                     ...
                     Stanford commented after their ingest of the JHU archive that they had
                        ...
                        working toward at least some common elements for these processes.#dilauro2005#dilauro2005#nelson2005
...
To date, the digital library community has treated these interoperability issues
               ...
               the additional requirements established in the profile #littman2006#keith2005
...
However, while these mechanisms may be successful in ensuring interoperability within
               ...
               interoperability at the scale envisioned by digital library projects such as Aquifer
                  #kott2006structMapstructMap[^: See http://www.loc.gov/standards/mets/mets-registered-profiles.html for the
    ]
...
One of the fundamental tenets of sociotechnical systems theory is that technological
               ...
               conceptualization of technology was concisely summarized by #akrich1992
...
We can learn a great deal about the viewpoints of a particular technology's designers
               ...
               XML, we find a relatively clear set of goals for the technology enumerated: 
                        ...
                        XML shall be straightforwardly usable over the Internet.XML shall support a wide variety of applications.XML shall be compatible with SGML.It shall be easy to write programs which process XML documents.The number of optional features in XML is to be kept to the absolute
                           minimum, ideally zero.XML documents should be human-legible and reasonably clear.The XML design should be prepared quickly.The design of XML shall be formal and concise.XML documents shall be easy to create.Terseness in XML markup is of minimal importance#bray1998support a wide variety of applications.ease of useXML documents shall be easy to create,XML documents should be human-legible and reasonably
...
This relatively small set of goals for the XML language was further elaborated upon
               ...
               community. #bosak1998extensibility, to define
...
#wwwc1999a
                  We envision applications of Extensible Markup Language (XML) where a single XML
                     ...
                     tags and attributes which they are designed to process, even in the face of
                        collisionsNamespaces in XMLNamespaces in XML#wwwc1999bNamespaces in
                  XML
...
Most of these languages employ a similar pattern for structuring content and
               ...
               metadata with various nodes within that structure. [Figure
                  1](#figure1)*for*
                  A simple digital objectDepiction of a structure and content and metadata object[Example 1](#example1)structMapdivfptrdivdivfiledivfilediv
...
It was a matter of some surprise for many in the METS community, then, when the
               ...
               METS descriptive metadata section (dmdSecrecorded events#loc2006relatedItemstructMap[^: Complete MODS and METS records for this
...
This example demonstrates two problems that have impeded the development of
               ...
               information down to the measure level?), labeling (you say `TYPE="book"``TYPE="monograph"`#dilauro2005
...
One possible response to this situation would be to say that perhaps our community
               ...
               liberation of content from local silos to enable their use by a larger community #seaman2003The
...
If libraries do wish to make progress on the issue of interoperability of structural
               metadata, they will need to recognize that, as #renear2001every significant information
                  ...
                  with many different interests.#kendall2007control vs. connection.
...
This is certainly not the case today, as can be seen if we examine the work of some
               ...
               the list of standards that they are maintaining #loc2008**Standards at the Library of Congress**
...
A heightened emphasis on standardizing translation between markup languages will mean
               ...
               Core #hillmann2005divsubchapter,mptrdiv
