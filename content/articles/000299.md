...
shaped America’s documentary record and documentary photography
...
archive at scale. Scholars such as Franco Moretti
...
Washington State and Minneapolis-Saint Paul ([Figure 2]()
...
below shows samples from each of the categories ([Figure 4]()
...
metadata fields. The unassuming field Other NumberD 915 Number
...
at once. [Figure 5]()People As SuchGroups and
...
information. For example, take the reconstructed strip of film in [Figure 6]()Elbert Peets, Washington, D.C., Principal
...
from arranging the negatives as film strips. By actually investigating the photos in [Figure 6]()
