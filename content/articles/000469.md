...
crop and label human faces from an archive of ** Time **
...
4,500 issues from ** Time ** Time.** ** Time.** ** Time ** The
...
been published as a dataset in the Journal of Cultural Analytics ** Time ** Time **
...
how the percentage of female faces found in ** Time **
...
faces were required to be extracted and labeled from ** Time **
...
visualizations of the data we extract from our ** Time.** ** PixPlot **
...
The code of this survey is split into 4 different files **instructions.php **survey.php **post.php **functions.php **instructions.php **survey.php **
...
**functions.php **functions.php **post.php **post.php **functions.php **survey.php **post.php **
