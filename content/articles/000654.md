...
Algorithmic image sorting and its visualisation are increasingly used as tools in
				...
				hermeneutic and epistemic engines in art historical image search #bell2018#googleartsandculture2011#manovich2020distant
					viewing#moretti2000#dork2018#dork2020#schnapp2012
...
The starting point for these questions is our research project on intercultural
				...
				visualisation. Following Johanna Drucker's statement – distant reading isn't#drucker2017
...
Within Google's image policy, one encounters a very standardised visual language,
				...
				perspective #rodriguez2013#vandermaaten2008
...
As noted in the introduction, by distanced vision we mean the constant dialogue of
				...
				Creswell ([[Creswell and Clark 2007|2007]]
...
The challenge that arose in our work with Google, understood by us as an epistemic
				...
				be described as medium researchsocial research#rogers2017
...
We used the artificial neural network method, specifically the Convolutional
				Neural Networks (CNN) architecture #lecun1999#szegedy2015#stanford2020*Inception*
...
The identification of image similarities is central to our intercultural image
				...
				are compared to the broadest classification system embedded within **ImageNet**#distillpub2017
...
To merge the computational methods and the visualisation of the statistical
				...
				with an interactive layout arrangement of the image corpus #yale2017
...
Overall, despite *locale*catch images#diers1997hotspot
...
On a qualitative level, the process of human perception of the climate images
				...
				characterised by constant zooming in and out, a toggling#schnapp2012At the same time, distance views, due to their
					quantitative methods, are visually more abstract and more detrimental#dork2020
...
In the previous critical description of our pipeline, the qualitative inscription
				...
				DH research. It is a circumstance that we will call more-than-distant viewing[[Moretti 2020|2000]][[Drucker 2017|2017]]distant reading isn't.
...
In a second step, we had to curate our image corpus of a global climate
				...
				used and highly formalized image space – Google Image Search. The so-called **PageRank**#searchengineland2010black box
