...
see [Mochales and Moens, 2011]()[ACL, 2018]()
...
digital media predominate (e.g., [Wegerif, 2007]()[Ravenscroft and McAlister, 2008]()[Ravenscroft 2010]()[Pilkington 2016]()
...
Our approach was also inspired by prior work on the methodology of ** Investigation by Design ** the level of the workNeither the
exact implementation of standards, nor their integration into local
communities of practice, can ever be wholly anticipated[see
also Edmond 2018]()
...
is a well-attested challenge throughout education (e.g., see [Ravenscroft et al., 2007]()[Andrews, 2009]()[Ravenscroft 2010]()sense makingstandalone
...
texts. This work (whose technical details are reported by [McAlister et al. 2014]()[Murdock et al. 2017]()
...
Previous attempts at automated argument identification (e.g., [Moens et al. 2007]()for this reasonin virtue ofhencetherefore
...
** Introduction ** Results ** Conclusions **free
runningorder of magnitude[Lawrence et al., 2012]()[Kirschner et al., 2012]()
...
relations in text. Some, such as Latent Semantic Analysis (LSA)[Word2Vec](https://code.google.com/archive/p/word2vec/)*So, our assumption was that the parts of texts that were rich in a
...
et al., (2003)]()[^: The results of this step of the topic modeling can be explored
...
argument mapping for: greater sense-making[see Chesnevar et al. (2006)]()lensfound
...
topic contained argument. [Table 1 (below)]()*Pages* that were selected from each *Volume*, following our topic modelling approach, and
...
The argument content was mapped using OVA+[ova.arg-tech.org](http://ova.arg-tech.org/)[(e.g., Figure 1)]()
...
texts we adapted a generic approach for manual argument analysis [described by Lawrence et al. (2014)]()historicalnatural[https://bit.ly/35CshTD](https://bit.ly/35CshTD)
...
authors, [Mills (1898)]()[Reid (1906)]()[Needham (1910)]()nature-nurture
...
modeling already exist in the form of ** MALLET.** ** InPhO Topic
Explorer.** ** HathiTrust Digital Library **[http://inpho.github.io/topic-explorer/htrc.html](http://inpho.github.io/topic-explorer/htrc.html)
...
for people, even after training, to determine (see [Oppenheimer & Zalta 2011]()[2017]()[Garbacz
...
** The Principles of Heredity ** General Biology ** The Nature & Development of Animal Intelligence **
