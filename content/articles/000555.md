...
Those disciplines and fields that understand themselves as primarily humanistic have
            ...
            problems or using similar approaches #fish1980#dobson2019stack


Joining the recent injunction against cleaningtidiness [privilege] the structure of a container, rather than the data
               inside it#rawson2019diversity-hiding trick,#mitchell2019#gebru2018
...
But we first need to disentangle explanation from interpretation. Recently, there has
            ...
            efforts have primarily asserted that explanation and interpretation are the same #miller2019#burckhardt1968
...
Computational models tends to reduce uncertainty by only registering that which is
            ...
            for complex reference systems, their assertion that most modeling
               ...
               through qualifying notations) rather than in the modeling itself#flanders2019
...
There are two major categories in which we might place most computational humanities
            ...
            to the creative work that it interprets but itself as a creative act #hartman1980#ramsay2014#montfort2018
...
Though it provides some level of access, the explicit presentation of data in support of
            ...
            activity of meaning making is to be found #algee-hewitt2017#allison2017
...
Tool criticism is an emergent category of analysis that provides a humanities-centric
            ...
            into the affordances of computational methods: Tool criticism
                  ...
                  process and output.#vones2018#bode2017#capitanu2016
...
In many computational fields it is a norm that researchers, especially academic
            ...
            tools. The open science**Unknowing Algorithms: On Transparency of Unopenable Black
               ...
               dealing with those parts of an artefact that one still does not know#pasmann2017a carefully paced out unknowing#pasmann2017feather knowledge,
...
The conversion of a document (text) or a set of documents into a document-term matrix
               ...
               new pliable movements through data #mackenzie2017
...
- no IDF weighting as this would render the transformer stateful. #scikit-learn2020
...
Data models, especially vectorized data models derived from text, are quite varied.
               ...
               previously unavailable aspects of the model #hamilton2016
...
Topic modeling, one of the earliest computational models used for exploratory data
               ...
               unsupervised model, the topicsextremely sensitive to parametricization, prone
                  to overfitting, and…fairly unstable#da2019*infer*
...
Scikit-learn, which provides several algorithms used to generate topic models, makes
               ...
               LDA models. These values can be queried with the n_componentscomponentsvariational parameters for topic word
                  ...
                  distribution is a Dirichlet, `components_[i, j]``j``i`#scikit-learn2020
...
There are several methods that use the output from standard LDA models to provide
               ...
               by humanists #schmidt2012#chuang2012
...
What we might want to call the data science#yu2008#jockers2010
...
The Scikit-learn multinomial implementation of Naïve Bayes uses a mechanism similar
               ...
               English-language haiku, although they used a different implementation of Naïve Bayes
                  #long2016`feature_log_prob_``coef_``feature_count_`pdfpage
