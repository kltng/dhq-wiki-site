...
methods also let us deal well with scale. For instance, while the *OLD*[^: The Biblioteca Teubneriana BTL-1 collection, for
...
textual collections: the German *elexiko*[^: In 2006, for example, Google released the first version of its Web 1T
]
...
with the same reference points, **chapter 1, section 1***Annales*
