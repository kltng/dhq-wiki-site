...
The scholarship of thirty years
                  ago[Latin-English lexicon](#andrews1850)[Wörterbuch](#freund1840)[Oxford
                  Latin Dictionary](#old)*Oxford English Dictionary**OLD*[Thesaurus Linguae Latinae](#tll)
...
Lexicographers have long used computers as an aid in dictionary production, but the
               ...
               methods also let us deal well with scale. For instance, while the *OLD*#thomisticus[^: The Biblioteca Teubneriana BTL-1 collection, for
                  instance, con][Thomas-Lexikon](#schutz1895)[Mediae Latinitatis Lexikon
                  Minus](#niermeyer1976)
...
Our work on building a Latin sense inventory from a small collection of parallel
                  texts in our digital library is based on that of [Brown et
                     al. 1991](#brown1991c)[Gale et al. 1992](#gale1992a)*prima facie**archê**beginning**empire*
...
1. knowledge-based methods ([Lesk 1986](#lesk1986)[Banerjee and Pedersen 2002](#banerjee2002)#wordnet
2. supervised corpus methods #grozea2004#miller1993#mihalcea2004
3. unsupervised corpus methods, which train classifiers on raw,#mccarthy2004[Brown et al. 1991](#brown1991c)[Tufis et al. 2004](#tufis2004)
...
Since the Perseus Digital Library contains two large monolingual corpora (the
                  ...
                  context, and several different measures for what definition of context[Gale et al. 1992](#gale1992a)
...
A second, more practical option is to assign syntactic structure to a sentence
                  ...
                  of syntactic parsing, both for phrase structure grammars ([Charniak 2000](#charniak2000)[Collins
                     1999](#collins1999)[Nivre et al.
                     2006](#nivre2006)[McDonald et al. 2005](#mcdonald2005)
...
We are currently in the process of creating a treebank for Latin, and have just
                  ...
                  the Latin Dependency Treebank[^: See http://nlp.perseus.tufts.edu/syntax/treebank/.][Pinkster (1990)](#pinkster1990)#melcuk1988*ista meam norit gloria canitiem*Propertius I.8.46that glory would know my old
                     age
