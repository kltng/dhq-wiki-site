...
ago[Latin-English lexicon]()[Wörterbuch]()[Oxford
Latin Dictionary]()*Oxford English Dictionary ** OLD*[Thesaurus Linguae Latinae]()
...
instance, con][Thomas-Lexikon]()[Mediae Latinitatis Lexikon
Minus]()
...
might more properly call computational lexicography*COBUILD English Language Dictionary*[^: See http://www.collins.co.uk/books.aspx?group=153.]*bear fruit*
...
words of Thucydides. [Figure 1]()** Translation equivalents **
...
al. 1991]()[Gale et al. 1992]()*prima facie **archê **beginning **empire*
...
with the same reference points, **chapter 1, section 1*** Annales*moore2002

In step 3, we then align these 1-1 sentences using GIZA++*est **sum1 edo1 **is **be*

![Sample word alignment from GIZA++](resources/images/salvus.jpg)

[Figure 3]()*salvum tu me esse cupisti ** Pro Plancio **you wished me to be safe **esse **sum1 **to
be **edo1 **to eat **be*[Figure 3]()

From these alignments we can calculate overall translation probabilities, which we
currently present as an ordered list, as in [Figure 4.]()
...
1. knowledge-based methods ([Lesk 1986]()[Banerjee and Pedersen 2002]()
2. supervised corpus methods
3. unsupervised corpus methods, which train classifiers on raw,[Brown et al. 1991]()[Tufis et al. 2004]()
...
context, and several different measures for what definition of context[Gale et al. 1992]()
...
of syntactic parsing, both for phrase structure grammars ([Charniak 2000]()[Collins
1999]()[Nivre et al.
...
the Latin Dependency Treebank[^: See http://nlp.perseus.tufts.edu/syntax/treebank/.][Pinkster (1990)]()*ista meam norit gloria canitiem*Propertius I.8.46that glory would know my old
age
...
illustrating a word’s exemplary use. As [Figure 1]()
