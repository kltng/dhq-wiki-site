...
depot for the **Body Language**[^: The authors
...
Paradisethingness*tremolierung***Lindau Crucifixion***tremolierung*
...
Lucida 3D Scanner was used [^: Since 2011, the Factum Foundation has been using this
...
Cycles for offline, ray-traced rendering.[^: Blender Community. 2018. Blender – a 3D modeling and rendering package. Stichtin]
...
debate ever since German sociologist Walter Benjamin  newspatina
...
stone, it changes over time. This way, an artwork knows many facesidentities**The Night Watch**
...
contribute to the diversity of identities one artwork can have. The authenticity of
                  **The Crucifixion**authenticities
...
measurements, it will always be a best guess-witlox2021freezestime-freezespristine
