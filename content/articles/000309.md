...
Given the central place of the embodied mind#sweetser2007#gibbs2006#johnson1987#enfield2009#streeck2011#kendon1972#kendon2004#mcneill1985#mcneill1992#mcneill2005#mueller1998gesture
                  studies**International Handbook on Multimodality in Human Interaction**#mueller2013#mueller2014#duncan2007#gibbs2006#jaeger2004#mittelberg2013#mueller2008
...
Indeed, human communication typically involves multiple modalities such as
               ...
               organization of a spoken dialogue situation (e.g. #bavelas1992#kendon2004#mcneill1992#mueller1998#mittelberg2016#mittelberg2014#rieser2012#mcneill1992#streeck2011#mittelberg2016
...
Drawing on this large body of gesture research across various fields of the
               ...
               human body (e.g. #tomasello1999#bourdieu1987#goldin-meadow2003#mcneill2012#bressem2013#fricke2010kinaesthemes#kendon2004locution
                  clusters#mcneill1992#mcneill2000#mcneill2005catchments#ladewig2011#mueller2010recurring gestures#cienki2005#mittelberg2010#goldin-meadow2007


In this paper, we will focus on certain kinds of co-verbal gestures, i.e. specific
               image-schematic gestalts, e.g. spirals, circles, and straight paths #cienki2013#mittelberg2010
...
Whereas the gesture research discussed above mostly relies on observational methods
               ...
               multimodal communication research #gonzalez-marquez2007#mcneill2001#mueller2013#steen2013#lu2010#beskow2011#pfeiffer2013a#pfeiffer2013
...
Both the alignment of gestures with the co-occurring speech, and the semantic
               ...
               trajectories, into a gesture signature#beecks2015#beecks2013#beecks2010Earth Mover's Distance#rubner2000Signature Quadratic Form Distance#beecks2010
...
This means that if *x, y, z**R**x, y,**z**concepts**R**extensional**movement**aggregated**coordinates**intensionally**mean*#quine1980eventaggregated states of
                  affairs#uysal2014#beecks2011#hetland2013
...
Due to the nature of trajectories whose inherent properties are rarely
                  ...
                  their coincident similar points with each other. A prominent example is the
                     Dynamic Time Warping Distance#itakura1975#sakoe1978#berndt1994
...
Although there exist further approaches for the comparison of trajectories, such
                  as Edit Distance on Real Sequences#chen2005Minimal Variance Matching#latecki2005Mutual Nearest Point Distance#fang2009#keogh2002
...
Gesture signatures can differ in size and length, i.e., in the number of relevant
                  ...
                  signature-based distance functions #beecks2013#beecks2010Earth Mover's
                     Distance#rubner2000Signature Quadratic
                     Form Distance#beecks2010
...
The Earth Mover's Distance, whose name was inspired by Stolfi and his vivid
                  ...
                  cost to move a total amount of earth from earth hills into holes #rubner2000
...
As can be seen in the definition above, the Earth Mover's Distance between two
                  ...
                  gesture signatures and follows a specific variant of the simplex algorithm #hillier1990


The idea of the Signature Quadratic Form Distance consists in adapting the
                  generic concept of correlation#rodgers1988#rovine1997*s*similarity correlation*S*1,*S*2∈S is then defined as: 
...
More details regarding the Earth Mover's Distance and the Signature Quadratic
                  ...
                  in the PhD thesis of Beecks #beecks2013b#beecks2013
...
Apart from the quality of accuracy, efficiency is another important aspect when
               ...
               super-cubic computation time complexity of the Earth Mover's Distance #uysal2014
...
This work is partially funded by the Excellence Initiative of the German federal and
               state governments and DFG grant SE 1039/7-1. This work extends #beecks2015
