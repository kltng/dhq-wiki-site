...
The capture of extremely large data sets and their availability via the Internet
                  ...
                  virtual
                    observatories#walton2005[^: See http://www.wwpdb.org/ and http://insdc.org/.]
...
#blanke2009a[^: Note in this connection the ReACH (Researching
...
While the LaQuAT project demonstrated the feasibility of such an approach, we
                    ...
                    together they would form a whole much greater than the sum of the parts #kintigh2006virtual data centre.
...
Our investigations led us to conclude that there is a need among at least some
                    ...
                    organisations#fraser2005[^: Another example from the
