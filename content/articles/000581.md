...
Notary records contain a wealth of information for understanding different aspects of
                ...
                written Spanish language underwent significant transformations #silvaprada2001#wasserman2018[^: The speed and volume of the documentary production
                            f]
...
Today, using optical character recognition (OCR), we can automatically convert
                ...
                (Fig. 2).
                    [^: The Document Analysis Group at the
                            Universitat Autòn]#vellingiriraj2016#chammas2018#granell2018
...
The challenges of converting Spanish American historical texts into machine-readable
                text have been pointed out by Hannah Alpert-Abrams. She used [Ocular](https://icebergnlp.github.io/)**Primeros Libros**#alpertabrams2016[Transkribus](https://transkribus.eu/Transkribus/)


Deep learning techniques perform better and achieve higher accuracy when large
            labeled datasets are available (e.g., ImageNet, MS COCO) #deng2009#lin2014
...
- We selected four state-of-the-art CNNs, namely, Inception-v3
            #szegedy2015#szegedy2016#he2016#simonyan2014#szegedy2017
...
Deep learning approaches have been widely used for handwritten text recognition of
            ...
            #krizhevsky2012#lechun1998#ashiquzzaman2017#tsai2016#rabby2018
...
However, applying these methods to historical documents present unique challenges due
                ...
                historic German documents, which achieved 95.6% accuracy #kolsch2018#clanuwat2019
...
Researchers tend to combine CNNs with recurrent neural networks (RNNs) to further
                ...
                CNN and RNN #granell2018#valy2018#chammas2018
...
2. InceptionInception architecture was first proposed in 2014 by Szegedy et al. The authors
                ...
                used Inception- V3 #szegedy2015#szegedy2017
...
The manuscripts scans contained noise including spurious ink
                ...
                contained in an image and increases the training speed #chamchong2009
...
We conducted all our experiments on a GeForce RTX 2080 Ti
                GPU with 12GB GPU memory. Our software was implemented using Keras #chollet2015#abadi2015[^: Tensorflow,
                            tensorflow/tensorboard, Apr 2020. Availa]#bradski2000
