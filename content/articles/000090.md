...
archives and databases. Research Infrastructures may be single-sited,distributed,virtual
...
the
underlying foundation or basic framework (of a system or organization) big, durable, well-functioning systems and
...
research infrastructure (cf. humanitiescyberinfrastructure
...
also a relatively recent move towards a *new*rockwell2010ainfrastructure turn,
...
The use of newnew,emergingexpanding.
...
While this is probably a valid description of existing infrastructure (but cf.
The
...
This kind of reasoning to some extent reinforces the sense of basic and paper
...
technology. A fairly recent example is grid computing (see e.g.** Mind the Gap **
...
consortia to be able to reach out and support.
...
tools
disciplines never fully constitute their objects; they fight over them*process*
...
better/faster/more a differenceWhat
difference does digital make?
...
Here the question of epistemic commitments (cf. conservatism
...
rotunda. The basement location gives the lab a certain atmosphere (cf.,warm
...
organized around pillars (as islands
...
well in ongoing activities or conversations.
...
architecture in the United States after the Second World War
displace (or dissimulate) the social hierarchies written into white collars and
gray flannel, in the name of human relations
While IBM represented itself as a mere maker of business
machines and calculators,logical controlsbrain
...
reality manifestations. In HUMlab, sensory impressions from the realaggressive
...
manifestations where there is ideally no frame (once you are inside
The Windows
...
Interestingly,** Glimpses of the USA **
...
translucence
Awareness involves knowing who is around,
...
Another relevant parameter is flexibility
...
Indeed, box.laboratorylabmedia lab
...
(basic *designed*adaptabilityco-evolution
...
needs. It seems reasonable to see the infrastructure turn
...
greater access, efficient problem solving, and competitive advantage ** Beyond Being There.**laboratories without walls,
...
Zotero and non-massive datasets. The NSF Blue-ribbon report on cyberinfrastructure cyberinfrastructure.
...
Computer-Human Interaction ** Reports European Roadmap for Research Infrastructures Report 2006 ** European Strategy Forum on Research Infrastructures **
Flanders, Julia and
