...
appeared on the Oricon annual top 100 single hit chart
 [http://www.uta-net.com](http://www.uta-net.com/)[http://www.utamap.com](http://www.utamap.com/)[http://mecab.sourceforge.net](http://mecab.sourceforget.net/)
...
$$Q_{\tau}(T) = \sum_{\kappa = 1}^{\kappa}{\rho_{\tau\kappa}\left( 1 - \rho_{\tau\kappa} \right)}$$\(\rho_{\tau\kappa}\)\(Q_{\tau}\)\(\kappa\ \left(\kappa=1,\dots,\kappa\right)\)\(\rho_{\tau\kappa}=0\text{ and }\rho_{\tau\kappa}=1\)\(\rho_{\tau\kappa}=0:5\)[^: This is called
Out-of-bag tests.]
...
[Table 5]()[Table
6]()[Table 5]()wawowatashi (I),[Table 6]()[Table 4]()
...
power in authorship attribution[Table
2]()
...
the titles of her songs are in Engl][Table 2]()
*yoru*
*asa*
*hiru*
*gozen*
...
no Syakaishinri-shi.** Oricon Annual Report (Oricon Year
Book) 1980-2009 **
Potthast
Martin, et al.
