...
Research in music information retrieval has produced many possibilities for
					...
					The availability of vast musical datasets like the *Million Song
						Dataset*#bertin2011*Web API*[^: Our use of the term 'big data' refers
						to datasets that are so large that c]#serrà2012bnotion of scholars reading#clement2013


Big data can also be used to create labelled instances for training
					supervised learners like neural nets (which tend to be
						data-thirsty**The Bach Doodle,**#huang2019
...
While the availability of approaches such as Spotify's has allowed for the
					...
					Krumhansl-Kessler profiles #krumhansl1982
...
For the purpose of this paper, we looked at only the two most common modes in
					...
					analyzed by *The Million Song Dataset**Web
						...
						into seven steps#laitz2003**W-W-H-W-W-W-H** and the
					minor scale consists of **W-H-W-W-H-W-W**
					#laitz2003[Figure 1](#figure01)C[Figure 2](#figure02)Cstepleading tone.tonic.
...
Many previous papers which use supervised learning to determine mode or key
					...
					at classifying 1252 classical music pieces #i̇zmirli2006#pauws2004[Figure 1](#figure01)[Figure
						2](#figure02)thinkbreak away
...
This is one aspect where our research differs from previous papers. An AI
					...
					suggest the following framework ([Figure 3](#figure03)


![Framework for supervised learning mode prediction algorithm.](resources/images/figure03.png)


As can be seen in [Figure 3](#figure03)*other**ambiguous**nontonal*
...
Where our paper differs from previous work is the handling of songs related
					to the outcome *ambiguous*[Figure 4](#figure04)[Figure 4](#figure04)[Figure 5](#figure05)tendency tone[Figure 6](#figure06)*Despacito*#fonsi2017
...
The most popular method of turning pitch data into something that can be used
					to train machine learners comes in the form of chroma
						features.*Web API*#jehan2014C*Web API*
...
Beyond chroma features, the API offers Spotify's own algorithmic analysis of
					...
					higher. The API's documentation states that *confidence*#jehan2014#serrà2012b#finley2019#mahieu2017sonata formdevelopmentthe bridge,
...
The last step in the preparation process is to transpose each chroma vector
					...
					3](#figure03)#serrà2012boptimal transposition index


In order to train a neural network for mode prediction, some previous studies
					used the mode labels from the Spotify *Web API*#finley2019KK-Profiles[Figure 7](#figure07)#krumhansl1982
...
As noted by Finley & Razi, the most common issue affecting accuracy
					...
					the mode or key is being off by a perfect musical
						...
						parallel mode errors#finley2019*Despacito*
...
The distance from the tonic to the leading tone is a major seventh interval
					...
					dissonant. Laitz defines consonant intervals as stable
						...
						augmented intervals#laitz2003most perfect,least perfectdecreasing in euphony in proportion to their
						distance from the octave and their proximity to the major
						seventh#hindemith1984
...
With a highly accurate working model for mode detection, adding the ability
					...
					progressions found within tonal music #laitz2003[Figure 8](#figure08)
...
Our much lower accuracy levels for key prediction in comparison to mode
					...
					of C major ([Figure 4](#figure04)G
...
Serrà et al.'s formula ([2008](#serrà2008)\(\overrightarrow{g_{A}}\)\(\overrightarrow{g_{B}}\)*CircshiftR*
...
Our modified version of Serrà et al.'s *OTI* formula
						([2008](#serrà2008)*(j)*, we use the function *amax* to find the highest correlation value between the desired
