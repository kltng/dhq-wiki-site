...
In this paper, we present a framework that extends the power of the digital to
                    ...
                    of this framework (see [Figure 1](#figure01)
...
Early work on Fluid Documents #chang1998#zellweger2000#bondarenko2005#hong2012#schilit1998#mehta2017


Pen-based systems that cross between physical and digital interfaces have
                        also been explored by Weibel et al. #weibel2012#yoon2014#liao2008#liao2010#tsandilas2010


Paper-augmented digital documents merge physical annotations on paper with a
                        digital representation #guimbretiere2003#haller2010#hinckley2012#holman2005#yoon2013
...
Our tool uses several computer vision techniques to aid in the OCR from the
                        ...
                        the binarization and filtering techniques presented in da Silva’s work #dasilva2006#gupta2007#dasilva2013#doermann2003#fan2001#liang2005#wordlens2010
...
Post-processing for text documents tends to be idiosyncratic to the documents
                        ...
                        from work such as perspective correction #jagannathan2005#lins2007#lu2006#pereira2007
...
Text vis is an enormous subsection of information visualization. Rather than
                        ...
                        visualizing text #havre2002#paley2002#lee2010#eick1992#hearst1995#fekete2000#havre2002#kucher2015#janicke2017
...
Perhaps the pioneering work in word-scale visualization was Tufte’s proposal
                        of Sparklines #tufte2004#brandes2013#goffin2014#goffin2015#goffin2015a#goffin2016#goffin2017#lee2010#nacenta2012#beck2017#beck2016
...
Previous studies on digital document interaction, annotations, e-readers, and
                        marginal interactions #marshall1997#cheema2016#goffin2014#mehta2017#mehta2017#goffin2014#goffin2014#cheema2016
...
**Word Space** is any portion of a document that has the printed
                    ...
                    interacted with on paper documents #marshall1997
...
**Margin space** is any area outside of the bounding box of the
                    ...
                    conducting a close reading of a document #mehta2017
...
**Canvas space** is a concept that we could loosely attribute to
                    ...
                    inserted in this space as Cheema et al. propose in AnnotateVis #cheema2016
...
We used the open source Tesseract OCR engine in the Textension prototype.
                            ...
                            engine #smith2007#smith2013#patel2012
...
The important image regions for the space insertion algorithm are
                            illustrated in [Figure 3](#figure03)**line space**) in
                            high-resolution mode we first use Hough line detection to identify
                            x-values where vertical lines exist on the page #duda1972
...
After creating an interactive, expandable document from the captured image,
                    ...
                    the document and its augmentations is provided by the layout engine (see [Figure 5](#figure05)
...
To allow for interaction with books off the shelf we wanted to cross over
                        ...
                        studies by Marshall #marshall1997#mehta2017**line space** and the **margin space**.
...
There are two ways to insert space in Textension. The first is to simply tap
                        ...
                        words (see [Figure 4](#figure04)[Figure 6](#figure06)
...
Often when digitizing analog texts OCR confidence is very important.
                        ...
                        attention to and obscure[Figure 5](#figure05)
...
**Word space** visualizations have been showing promise as
                        ways to augment digital texts #goffin2014#tufte2004[Figure
                            9](#figure09)
...
The second **word space** visualization we implemented was
                        showing the uniqueness of each word within the language (see [Figure 11](#figure11)
...
To demonstrate the possibilities of the **occlusion space**
                        ...
                        Webster’s Online Dictionary API #websters2017[Figure 5](#figure05)
...
While we designed Textension to demonstrate the usefulness and power of
                        ...
                        zoomable interface of PAD++ #bederson1994
