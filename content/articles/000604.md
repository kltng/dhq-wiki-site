...
Discussion about the semantics of visual design elements is often neglected within
               ...
               between users’ mental models of information and its digital representation #doerum2011#munzner2014#bertin1973
...
First, we illustrate the difference between the two, through the example of two
               ...
               see a contemporary representation of a historical network[^: We defaulted to a
                  contemporary representation for the non-hier]#rothschild2014
...
To describe them formally, hierarchical trees (such as Figure 1a) are a sub-category
               ...
               described by Drucker in her book Graphesis #drucker2010#drucker2010[^: Or at the right, in a right-to-left
...
On the other hand, force-directed networks (Figure 1b) are mathematical products,
               ...
               force-directed networks reject hierarchies#ahnert2020[^: Pushed to its extreme, this urge to categorize the world can be
                ]
...
In that way, network visualizations are no different than other visualizations of
               ...
               visualizations as they can reinscribe historic and contemporary power differentials#porras2017
...
In visualization literature, a growing voice argues for the consideration of
               ...
               scholarship. In previous work #lamqaddam2020#manovich2012semantic distance
...
Understanding users' existing mental models (i.e. the representation they
                  ...
                  models as a way to externalize them #zhang2008#kodama2017
