...
Afro[^: In this article we refer to Afro as a cultural component based on cultural tradi][^: From the article’s perspective, we use artistic in order refer to a field of soc][^: The perspective from which we are considering cultural systems and the transmiss]#garciacanclini1990#sedarsenghor1966#asante1988#said1978
...
In **Being and Blackness in Latin America**Uprootedness#deleuze1977#glissant1981
...
With all of these elements, we then build a topic map to show not only a list of topics related to one another, but, above all, a working network which can be askedmanaging the meaning of the information, rather than just the information.#garshol2006Guillénfillconcreteoccurrences.**Songoro Cosongo**
