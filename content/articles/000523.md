...
In order to implement a strong cooperation between AI experts and history scholars #deegan2012
...
**From an historical perspective**, ANTRACT aims to approach topics
          ...
          political ambitions #atkinson2011#bartels2004#pozner2008#veray1995#fein2004#fein2008#althaus2018#chambers2018#imesch2016#lindeperg2000#lindeperg2008**Les Actualités Françaises****Les Actualités Françaises****Les Actualités
            Françaises**#goetschel2011#maitland2015
...
**Segmentation of reports**. Each one of the 1,200 editions of the
          ...
          A report with timecode is called segmented*ffmpeg*blackdetect#bradski2000
...
Typescripts of the voice-overs have been linked to books and typescripts of each edition
          and separated with pages giving the summary of the edition (see [Figure 2](#figure02)Document
...
Once digitized, typescripts have to be separated from summaries. In order to achieve
          ...
          Inception V3 classifier #szegedy2016**2,**600 pages of summaries and 6,400 pages of
          voice-overs.
...
The ASR system is developed using the Kaldi Speech Recognition Toolkit #povey2011#povey2016
...
Identifying the people appearing in a video is undoubtedly an important cue for its
          ...
          archive such as the **Actualités Françaises**[Figure 4](#figure04)
...
The Viola-Jones algorithm #viola2004#ahonen2006#king2009#zhang2016
...
- A training module where the retrieved photos can be converted to black-and-white,
            ...
            algorithm #zhang2016#schroff2015#cao2018
...
- Simple Online and Realtime Tracking (SORT) is an object tracking algorithm, which
            can track multiple objects in real-time #bewley2016[Linzaer](https://github.com/Linzaer/Face-Track-Detect-Extract)
...
In order to make the software available as a service, we wrapped it into a RESTful web
          API, available at [http://facerec.eurecom.fr/](http://facerec.eurecom.fr/)#troncy2012*npt**xywh*
...
The application is publicly available at [http://facerec.eurecom.fr/visualizer/?project=antract](http://facerec.eurecom.fr/visualizer/?project=antract)[Figure 5](#figure05)
...
Text analysis is achieved through a textometric approach #lebart1998#macwhinney2000#elan2018#hotho2005#feinerer2008#weiss2015


Textometry is implemented by the TXM software platform #heiden2010#r2014#christ1994#schmid1994[^: Text Encoding Initiative, https://tei-c.org]
...
One of the technical innovations achieved for the project has been the consolidation of
            TXM back-to-media component #pincemin2020
...
In [Figure 6](#figure06)[Figure 7](#figure07)foule
...
Our second example is about the place of agriculture and farmers in the **Actualités françaises**[Figure 8](#figure08)paysanagricoleagriculture[Figure 9](#figure09)[Figure 8](#figure08)[Figure 9](#figure09)paysanagriculteuragricoleagriculture
...
Combining word lists (INDEX) and morphosyntactic information is very effective to
            summarize phrasal contexts. For instance, in [Figure 8](#figure08)foulefoulefoule immense#christ1994
...
For chronological investigations, we can divide the corpus into time periods in a very
            ...
            Exact Test, known as one of the best calculations to find keywords #mcenery2012[Figure 9](#figure09)foule
...
With Figure 12, we apply a statistical resonance analysis #salem2004Président[le général De] Gaulle[Figure 12](#figure01)[Figure 12](#figure12)**foule**


[Figure 13](#figure13)**Actualités françaises**#lebart1998
...
Okapi (Open Knowledge Annotation and Publication Interface) #beloued2017#motik2012
...
The Okapi's knowledge management system stores knowledge as graphs of named entities
            ...
            wikidata and so makes Okapi interoperable with the Linked Open Data ecosystem #bizer2009
...
The media analysis can be carried out manually by annotators or automatically by
            algorithms on several axes as shown in [Figure 14](#figure14)**strate
...
The user can create and remove analysis layers and their segments as well as the
            ...
            example where we are talking about the **water sports** (**concept**) in **England** (**Place**), especially the adventures of the solo sailor **Alec
              Rose** (**Person**) as indicated in the following form ([Figure 15](#figure15)
...
The other analysis layers (transcription, music detection, etc.) are provided by
            ...
            possibilities in the content as shown in [Figure 16](#figure16)
...
The generated metadata are also used as advanced criteria for looking for video
            excerpts and so allow users to constitute their thematic corpora focused on some topics.
              [Figure 15](#figure15)**Water sports****England**[Figure 17](#figure17)[Figure 18](#figure18)
...
The corpus itself is an object to be annotated, i.e., the user can add new metadata on
            ...
            between them. [Figure 19](#figure19)**Robert Manry, 48
...
At this point of the project, most of the work is dedicated to the development and tuning
          ...
          ANTRACT historians #goetschel2011
