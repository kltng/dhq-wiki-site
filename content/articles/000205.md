...
the central — often the *only*[Victoria and Albert Museum](http://collections.vam.ac.uk/)[Europeana’s](http://labs.europeana.eu/api/)[Trove](http://trove.nla.gov.au/), what?
...
information  in casual browsing
...
vague dissatistfaction state of knowledgein general, the user is
unable to specify precisely what is needed to resolve that anomaly challenges
...
behaviour in a connected space and content
...
serendipitous and enjoyable information spaces  long list or a set of thumbnailsrich scenes, full of potential objects
of interest, that the eye can take in at oncemassively parallel glimpse

From the complementary fields of interface design and information visualisation,
Shneiderman’s visual information seeking first, zoom and filter,
then details-on-demand*zoomed out*relatehistoryextract
...
materials available
surrogatemassively parallel glimpse*preview**overview*information seekingsalienttaskneeds exhaustivelimit the coverage of the overviewhas the potential to be misleading
...
or Shneiderman’s notion of exploratory information seeking
...
she argues, constitute an epistemological Trojan horse  ishumanistic interface
design, but highly mechanisticdistraction, engagement, flow
experience and pleasure-driven activity are not goal-oriented, but motivated by
the process to its critical principles
...
search alone is inadequate parallel glimpse
...
but workably compact representation of the collection as a whole. Show everything**Manly Images**tuned
...
an overview as a local or inner**Works and Networks**chaining**All Artists****Decade
...
salient surrogates solid understanding of data and
userstaskuserfragmented and correlated points of view that resist
self-evident reification
...
Local, browsable innerviews**Works and Networks****Australian Prints and Printmaking****Decade Browser****The Queenslander**#dörk2011
