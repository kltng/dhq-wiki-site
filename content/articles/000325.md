...
exploratory programming for humanistic inquiry ** A New Companion to Digital Humanities.** ** Reading Machines **
...
d’emploi **written **read*queneau1961base
...
sonnet written by another machine[^: Original French: Seule une
...
by a machine will be better appreciated by another machine
...
left to chance[^: Original French: On souhaita que
M. Starynkevitch no]
...
computer science and literary creation[^: Original French: un possible
...
is printed is sometimes delicate[^: Original French: Le recueil
imprimé est très jolimen]magic number
...
literature[^: Original French: Ce texte…s’inspire de la présentation des instructions destinée]*tree structure* here owes to mathematics, and more
...
the reader takes, there is only one real
If not, go to 15 anyway,
because you won’t see anything[^: Original French: si non,
...
conte à votre façon **
First, the computer
dialogues[^: Original French: L’ordinateur, dans un premier temps, dialogue
]
...
speech and n represents any integer value ** La cimaise et la
fraction*** M+7* in which adjectives, nouns, and verbs of La Fontaine’s
timeless fable ** La cigale et la fourmi*** Homomorphisms* came next, fixing a specific facet of a
...
sonnets of pages of text. (That is what we did for the ** Cent mille milliards de poèmes*** S+7*), that is currently impossible.[^: Original French: Toute la
...
Mathématique et les Ordinateurs.** ** Le dormeur
