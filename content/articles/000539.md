...
Very few attempts to exploit high-level features for stylometric purposes
                        ...
                        (SFG) #Halliday1994[[Argamon et al. 2007|Argamon
                        (2007)]]
...
The way in which it is possible to proceed in order to infer a geometric
                        ...
                        from [[Harris 1970|Harris (1970)]]the distribution of an element will be understood as the
...
Context vectors are then defined as the rows or the columns of the matrix
                        ...
                        as shown in [Figure 1](#figure01)
                            ...
                            \cdot \sqrt{\sum_{i=1}^n y_{i}^{2}}}$$[Figure 2](#figure02)catdogcatdoganimaldogcatcaninedogcatfelinecatdogcaninedogfelinecatcaninefelineanimal
...
According to [[Rudman 1997|Rudman (1997)]][Figure 3](#figure03)
...
Since we wanted to focus on the analysis of the semantic distribution of words,
                    we decided to exclude any possible lexical bias.[Figure 4](#figure04)scoppiorisascoppio di risaburst of laughtermanmanohandman manolittle by little,progressively
...
In this paper, we investigated the possibility that an analysis of the semantic
                    ...
                    process. Also, as highlighted in [Section 3.2.3](#section3.2)
