...
back to an engagement with the real world
...
processes: they are embedded in the fabric of history.** The Matrix: Reloaded **
...
groups doing things on the fringes, [^: For example http://www.vectorsjournal.org.]
...
a human environment that reaches beyond the archetypal end user*and*intellectual
...
Gathering, Preserving, and Presenting the Past on the Web.** ** Mechanisms: New Media and the Forensic Imagination.** ** The Access
Principle ** Philosophy / Ideology[^: See http://chnm.gmu.edu/essays-on-history-new-media/essays/.]** Digital Humanities Quarterly ** Vectors ** Journal of New Media
...
creators express their worktoo much normalizationobstructing standards development
...
Sciences.** ** Edgeless
University.** ** The Future of Learning Institutions in a Digital Age **
...
Imagination ** The Open Group Architecture Framework Version 8.1.1 **[http://www.opengroup.org/architecture/togaf8-doc/arch/](http://www.opengroup.org/architecture/togaf8-doc/arch/)
