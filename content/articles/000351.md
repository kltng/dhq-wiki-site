...
Collaboration has become a hallmark of Digital Humanities (DH) research or very often[^: See, for example,

.]

We were reminded of this during 2014-15 when we co-edited two volumes on ** Research Methods for Digital Humanities **reading and curating way I/we see it, DH is not a method. It is an
...
dimension of their work.** Collaborative Research in the Digital Humanities **
...
frequently referenced in discussions of DH collaboration[^: In February 2016,
...
Terras’ notion of othernesswhat counts
countstrue collaboration within a group
happens rarelyun-bossprimus inter
pares

The very notion of a *primus inter pares*gluck1991 the other
...
about them outputsprofessionalthe expertstranslate
...
some kind of sacrifice, a trade-off between autonomy and synergy*sacrifice*intensif[ication
of] the *concessions **submission*
to norms of behavior and *constraints*flanders2012[^: Emphasis added.]
...
order for collaboration to proceed inter pares
the precise role of dissent within our collaborative
ecology*through **despite*** Copiloting a Digital Humanities Center: A Critical
...
to the organization of professional scholarship in general professoriateamateur
...
meaningful way to use their leisure time recreationprofessoriate,crowd,
...
passwords with them.[^: In their Taboo:
...
promised at their start ** Research Methods for Creating and Curating Data in the Digital
Humanities.** ** Raising
Language Awareness Using Digital Media: Methods for Revealing Linguistic
Stereotyping **female/feminineunnaturalness to
...
crowd ** Living with the Railroads **[^: See
...
developed from (most explicitly) Bruno Latour’s and Steve Woolgar’s ** Laboratory Life.** ** Science in
Action.** ** Simians,
Cyborgs and Women.** ** The
Mangle of Practice **[^: This has continued with , , , and . There have also
been]-action ** Curating Mary
Digitally **lindhé2016
the remediation and organization of knowledge shapes
our thoughts and actionsé2016
direct attention to physical interaction and to the
materiality of the worké2016
...
relationships. Matt Hayler also p]distributed cognition*system*
...
“data” will be shaped by and for the logic of digital tools[^: For more on this phenomenon across technological use see Davis
]
...
in regular form[www.virca.hu](http://www.virca.hu/)Imagine a completely new form of relationship with your IT devices: a
...
players, in 2016, ** New Scientist **artificial intelligence phobia
...
knowledge
needed the computers for something else
...
affluent 19th century readers, may still resist being digitized algorithm's performance
...
enthusiasts in the ** Living with the Railroads **-to-reach,
...
English Departments?**day of DH*beyond **is*
...
academe*and*world-classexcellentprimumparesco
...
Algorithms ** Machine Learning ** AlphaGo ** DeepMind.com **https://deepmind.com/research/alphago/
