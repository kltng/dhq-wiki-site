...
The National Library of Finland has digitized a large proportion of the
                    historical newspapers published in Finland between 1771 and 1910[^: Ten more
                        years, 1911–1920, were opened for free use on F]#bremerlaamanen2014#kettunen2014[digi.kansalliskirjasto.fi](https://digi.kansalliskirjasto.fi/)Digi[^: https://kitwiki.csc.fi/twiki/bin/view/FinCLARIN/KielipankkiAineistotDigilibPub][^: https://korp.csc.fi/][^: Cranfield style test
                        collection is a prototypical evalua]#jarvelin2016#paakkonen2016
...
Digi is part of the growing global network of digitized newspapers and journals,
                    ...
                    unstructured mass #marrero2013#nadeau2007#nadeau2007#kokkinakis2014
...
Our goal using NER is to provide users of Digi better means for searching and
                    ...
                    newspaper collections #crane2006#neudecker2014[^: http://www.archiviolastampa.it/]*person**location**organization*#mackim2015
...
Named Entity Recognition is a tool that needs to be used for some useful purpose.
                    ...
                    of [La Stampa](http://www.archiviolastampa.it/)[Trove Names](http://trove.alveo.edu.au/)#mackim2015#bates2007#toms2000#mcnamee2011
...
If we consider possible uses of presently evaluated NER tools–FiNER, the FST, and
                    ...
                    handling #mcnamee2011#mcnamee2011#ehrmann2016b#neudecker2014#hallo2016
...
Our main research question in this article is, how well or poorly names can be
                    ...
                    results. First, the word level quality of the material is quite low #kettunen2016#kettunen2017b
...
We will not provide a review of basic NER literature; those who are interested in
                    getting an overall picture of the topic, can start with Nadeau and Sekine #nadeau2007#marrero2013
...
For recognizing and labelling named entities in our evaluation we use FiNER
                    ...
                    entities #makela2014[^: An older demo version of the tool is
                        available at http:/][^: https://www.connexor.com/nlplib/?q=technology/name-recognition][^: http://polyglot.readthedocs.io/en/latest/NamedEntityRecognition.html]#lofberg2005
...
All our taggers have been implemented as analysers of modern Finnish, although
                    ...
                    project, and the results have been good #neudecker2014#neudecker2016
...
FiNER[^: http://www.helsinki.fi/~jkuokkal/finer_dist/][^: https://github.com/flammie/omorfi]#tkachenko2013
...
The pattern-matching engine that FiNER uses, HFST Pmatch, marks leftmost
                        ...
                        set of disjuncted patterns) #linden2013#silfverberg2015#silfverberg2015


#### 2.2. ARPA


SeCo’s ARPA #makela2014
...
As there was no evaluation collection for Named Entity Recognition of 19th
                        ...
                        different decades #kettunen2016
...
We aimed for an evaluation collection of 150,000 words. To emphasize the
                        ...
                        being maximally 10% units for the whole century #kettunen2016[^: Ehrmann et al. show irregular time-based variance for Swiss
                    ]
...
The final manually tagged evaluation data consists of 75,931 lines, each line
                        ...
                        newspaper collection is estimated to be in the range of 70–75% #kettunen2016
...
FiNER uses fifteen tags for different types of entities, which is too fine a
                        ...
                        last names of persons and place names #kettunen2014#crane2006
...
The final entities show that our interest is mainly in the three most
                        ...
                        content validity condition of an experimental unit #marrero2013#urbano2011
...
Manual tagging of the evaluation corpus was done by the third author, who had
                        ...
                        character correctness rule in #packer2010
...
Among the names that FiNER does not recognize are foreign names, mostly
                            ...
                            compound names, and old names. Variation of *w/v*#kettunen2016#jarvelin2016*diakonissalaitos**diakonissa-laitos**diakonissa
                                laitos.*
...
We evaluated performance of the NER tools using the conlleval[^: http://www.cnts.ua.ac.be/conll2002/ner/bin/conlleval.txt,
                      ]Conlleval#manning1999exact-match evaluation#nadeau2007precisionrecall
                            a result is considered
                                correct only if the boundaries and classification are exactly as
                                annotated#poibeau2001
...
First only places were identified so that one location,
                            ...
                            Place Name Registry](http://www.ldf.fi/dataset/pnr/)[^: http://www.ldf.fi/dataset/pnr/]#hyvonen2011#ikkala2016[^: http://geonames.org/][^: http://wikidata.org/]
...
Here we report briefly results of three other systems that we evaluated.
                        These are Polyglot, a Finnish semantic tagger #lofberg2005
...
The Finnish semantic tagger was developed using the English Semantic
                            ...
                            as part of the UCREL Semantic Analysis System (USAS) framework #rayson2004#piao2016
...
Ehrmann et al. #ehrmann2016a#poibeau2001
...
Word level correctness of the whole digitized newspaper archive is approximately
                    70–75% #kettunen2016#kettunen2016
...
NER experiments with OCRed data in other languages usually show some improvement
                    ...
                    slightly better #packer2010#marrero2013#miller2000#alex2014#packer2010#miller2000#rodriguez2012
...
Better quality for our texts may be achievable in the near future. Promising
                    ...
                    FIN-CLARIN consortium achieved correction rate of 20–35 % #silfverberg2016[^: https://github.com/tesseract-ocr]#kettunenetal2016#koistinen2017#packer2010#packer2010
...
Four of the five taggers employed in the experiments are rule-based systems
                    ...
                    some recent work on rule-based systems for NER #kokkinakis2014#nadeau2007#neudecker2016
