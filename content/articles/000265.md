...
In a previous project (**RemDoc**#strauss1979#roscam2006**RemDoc**[^: http://www.remdoc.org]
...
Access to the four different databases is realized through federated
                        searchdistributed
                        information retrieval#jasco2004#shokouhi2011verticals.


Because of the importance of metadata for searching in the art history domain
                        #bates1996a#yee2003faceted search #tunkelang2009
...
For the development and evaluation of domain-specific search engines, it is
                    important to know the information-seeking behaviour of the target group #gossen2013
...
When designing search systems for specific target groups it is important to
                        take into account the information-seeking behaviour of the target user group
                            #gossen2013#davies2007#meho2003#hemminger2007#george2006#makri2008#vezzosi2009


The work by Bates et al. #bates1993#siegfried1993#bates1996#bates1994#bates1996a#bates1996b#bates1994#siegfried1993#bates1996a
                            “Recognize that humanities
                                ...
                                typical humanities end user.” #bates1996a
...
It could be argued that the difficulty mentioned in the last sentence does
                        ...
                        experience with web search engines and web interfaces to databases #rowlands2008#sadeh2007
                            As free, Web-based
                                ...
                                engines is blurring.#hemminger2007#george2006#beaudoin2011


On the other hand, the study by George et al. #george2006#tenopir2009
                            this is not to say that
                                humanities faculty members do not read, but they most likely read
                                books, primary materials, and manuscripts#tenopir2009


The effectiveness of faceted search for research in the art history domain
                        has been shown by Yee et al. #yee2003
...
It has been shown that there is a strong relationship between usability and
                        popularity of web search engines #dudek2007#nielsen1993thinking aloud#vanwaes2000
                            to collect data about various
                                usability aspects, navigation strategies, and cognitive aspects of
                                the searching process#vanwaes2000#spink2002#vanwaes2000
...
- Query formulation and reformulation strategies in multi-query sessions
                            are described by Lau and Horvitz #lau1999#rieh2006#kules2009
- For investigating how users process and evaluate the items returned in
                            ...
                            experiments #granka2004verticals#ponnuswami2011#spink2006#ponnuswami2011page
                                composition
...
The RemBench project consisted of two phases: First, the metadata of the four
                    ...
                    History of the Netherlands using Apache Solr.[^: http://lucene.apache.org/solr/]#ponnuswami2011Works of artArtistsPrimary
...
User-system interaction was observed using a thinking-aloud set-up #gerjets2011#vanwaes2000[^: BB FlashBack Express, http://www.bbsoftware.co.uk/BBFlashBack_FreePlayer.aspx]
...
The thinking-aloud data, the screen recordings and the notes taken by the
                        ...
                        series of all actions related to one question #sriram2004usingselecting at least one value of the facetusing[^: These interpretations were expressed by the
...
We classified the 61 questions phrased by the Rembrandt researchers in three
                        types, using the question taxonomies of Hermjakob et al. #hermjakob2000#voorhees2003which works are*all*
...
- library search: data from The European Library (TEL) search logs,
                                analysed by Verberne et al. 2010 #verberne2010[^: Subsequent duplicate queries were removed from the TEL
                         ]
- general web search in the early years of web search systems #jansen2000
- a more recent web search data set from 2006: the Microsoft Search
                                (MSN) dataset that was distributed for the WSCD 2009 workshop,[^: Workshop on Web Search Click Data: http://research.microsoft.com/en-us/um/people]#hinne2011
...
Figure 3 shows that especially the proportion of sessions with only one
                            ...
                            according to White and Drucker #white2007
...
The query modification patterns in the RemBench data were analysed and
                            compared to patterns found for web search #hinne2011#lau1999
...
In order to meet comment 1, functionality was added for searching works
                            ...
                            work by Yee et al. #yee2003dogdog
...
Three limitations of the presented user study should be acknowledged: First,
                        ...
                        were not the owners#chouldechova2013list all...how
                            many...
...
The second limitation is that the retrieval effectiveness as perceived by the
                        ...
                        trust the information retrieved and the ranking by the search engine #pan2007#keane2008*not*
...
The third limitation of the study is that all participants were students. One
                        ...
                        from the behaviour of (older) researchers #weiler2005#rowlands2008
                            heavily on search engines,
                                view rather than read and do not possess the critical and analytical
                                skills to assess the information that they find on the web#rowlands2008we are all the Google generation, the young and
