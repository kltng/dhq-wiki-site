...
]Robert Gorman StamatatosKim Luyckx
...
to attribute texts with unclear authorship, such as in the seminal study of ** The Federalist Papers ** Frederick MostellerDavid L. Wallace
...
contrasted with the dataset of[^: Compare also with , who focus on the effect of author set
size a]
...
Second, the books we have chosen vary greatly in length.Č. SlepánekA. Jirásek
...
the word form for non-delexicalised baselines, we h][^: The types of named entities are persons
