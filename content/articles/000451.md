...
Calamari[^: https://github.com/Calamari-OCR][^: Throughout this
                        paper, the term “predict” is used whenev]#breuel2017#wick2018[Reul et al., 2018a](#reul2018a)[Wick et al., 2018](#wick2018)[^: https://pypi.org/project/calamari_ocr/]
...
Currently, there exist several versions of OCRopy which was originally published
                    by Breuel (2008) (see also [Breuel et al., 2013](#breuel2013)[^: https://github.com/tmbdev/ocropy]#graves2006
...
A general approach to improve the accuracy of a model on a specific dataset
                        ...
                        model and to finetune for the specific task (see e.g. [Reul et al., 2017b](#reul2017b)@
...
Another technique to obtain more robust results is to vote the outcomes of
                        different models (see e.g. [Reul et al.,
                        2018b](#reul2018b)confidence
                            voting
