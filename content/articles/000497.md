...
Until late April of 2019, visitors of the Kunsthistorisches Museum in Vienna could
               drop in on the exhibit **Spitzmaus Mummy in a Coffin and Other
                  ...
                  from 5 November 2018 until 28 April 2019.]#brown2018
...
In recent years, audiovisual heritage institutions have invested much time and
               ...
               in practices of information retrieval more in general #whitelaw2015
...
For users, the selectiveness of catalogue descriptions poses two important problems.
               ...
               information they hold, but also for their look and feel#delpeut1999#dudley2010


The research project The Sensory Moving Image Archive (SEMIA): Boosting Creative
               Reuse for Artistic Practice and Research[^: http://sensorymovingimagearchive.humanities.uva.nl/]Users,#flanders2014[^: For further exploration of the
                  relation between searching and ][Yumibe
                  [2012]](#yumibe2012)#heftberger2009#street2012#street2013#fluckiger2017#heftberger2018#mazzanti2009#catanese2019
...
SEMIA, a two-and-a-half year project that ran until late January 2020, was a
               ...
               Netherlands Institute for Sound and Vision (television).[^: Funding was obtained
                  ...
                  al. [2013]](#kuhn2013)[^: See https://www.openbeelden.nl/. Of
...
The project consisted of two phases, whose timings partly overlapped: a first,
               ...
               development of a generous#whitelaw2015
...
In film and media studies, the visual analysis of moving images was developed as part
               of the intertwining stylometric research programmes commonly referred to as
                  statistical style analysiscinemetrics,[Buckland [2008]](#buckland2008)[Olesen
                  [2017]](#olesen2017)rigorous
...
In recent years, as digital humanities methods have proliferated, stylometric
               ...
               (recurring) objects and aspects of visual composition. Projects such as Digital
                     Formalism[^: https://www.ims.tuwien.ac.at/projects/digital-formalism][^: https://hcommons.org/deposits/item/hc:12153/]#zeppelzauer2012[^: ACTION is short
                  for Audio-visual Cinematic Toolbox for Interac]#casey2013
...
To this end, the project draws inspiration from an emerging approach to visual
               ...
               experimental work in media studies that balances between [...]
                  new media art and digital humanities scholarship#ferguson2016deforming#ferguson2017a digital humanities project that is more aleatory
                  and aesthetic than it is formal and constrained#ferguson2017
...
As previously mentioned, film and media scholars who proceed in this way oftentimes
               ...
               artists – the constellation Thomas Elsaesser once dubbed the three A's#elsaesser2009
...
For instance, in the 1970s, when film historians would use projectors and editing
               ...
               highlighted the different#testa1992
...
Ultimately, the great merit of such artistic work is that it strips archival films of
               ...
               Michael Pigott, in this context, has credited the practice with inducing illegibility.the dual purpose (and double tension) of making the image illegible
                  (again) and then attempting to read it#pigott2015[^: http://www.jimcampbell.tv/portfolio/still_image_works/illuminated_averages/index][^: http://www.salavon.com/work/Top25/]#habib2015#ferguson2017[^: http://www.brendandawes.com/projects/cinemaredux]
...
In setting up SEMIA, the project team, while familiar with the above-mentioned
               ...
               for the projects’ approach was **Match of the Day**[Figure 1](#figure01)
...
To create his work, Mul used large databases of images, for which he extracted a wide
               ...
               selected approximate rather than identical matches to include in his work #mul2018matches
...
As it happens, such metadata, in archival collections, are often also fragmentary –
               ...
               elsewhere (see [Masson and Olesen [2020]](#masson)
...
Initially, the choice for a deep learning approach seemed to fit neatly with the
               ...
               the alternative scenario, known as feature engineering,neural nets[Masson and van Noord [2019]](#masson2019)[Masson and Olesen [2020]](#masson2020)*how*
...
However, we soon decided to only partially rely on such techniques – and the
               ...
               e.g. [Uçar et al. [2017]](#ucar2017)[Arandjelović et al. [2018]](#arandjelovic2018)[Taigman et al. [2014]](#taigman2014)syntactic
...
One way of tackling this task with deep learning methods might have been to run
               ...
               focused on learning so-called disentangled
                  representations[Xiao et al. [2018]](#xiao2018)[Denton and Birodkar [2017]](#denton2017)[^: Hitherto, it has primarily been successful when
                  applied to res]
...
Our search for abstraction is evidenced in a very concrete way by what happened
               ...
               (semantic) class (we elaborate on this point in [Masson and
                  van Noord [2020]](#masson2020)lower-level
...
Arguably, this approach helped us mitigate a broader issue that the use of computer
               ...
               techniques are designed, as Adrian MacKenzie puts it, to mediate
                  ...
                  down*#mackenzie2017#mackenzie2017accuratetakes down potential[Mackenzie [2017, 7]](#mackenzie2017)
...
As mentioned earlier, we chose to focus on four broad sets of image features,
               ...
               repurposed for other tasks.[^: Specifically, we used ResNet-101; for more
                  ...
                  previous section](#section)[^: The layer we selected was the one located just
...
Our goal required that for the extraction of data, we adhered to the following
               ...
               up to the algorithm to determine similar,somewhat similar,dissimilar[Masson and van Noord [2019]](#masson2019)level
...
The next step, which we expand on in an upcoming piece, is to assess which kinds of
               ...
               groups #massonserendipitous#vanandel1994#foster2014
