...
Although (as noted above) SOL is apparently the first translation of the **Suda**#dionisotti1990**Suda**
...
the standard until the twentieth century.  The current standard edition of the **Suda**Abraham,alpha 69.**Suda**#zecchini1999
...
other works of classical scholarship.  The **Suda**#most1999[^: In
addition to Most, see the articles in  on commentaries as a genre.]**Suda****Suda's**Do-It-Yourself Commentary#mccarty2002Table of Nations[http://​www.mazzaroth.com/​TableOfNations/​TableOfNations2.htm](http://www.mazzaroth.com/tableofnations/tableofnations2.htm)[from Epsilon 38, Hebrews](http://www.stoa.org/sol-bin/search.pl?searchstr=epsilon,38&field=adlerhw_gr)**Suda****Suda****Suda****Suda**


Because SOL is also a translation, it is, in Rydberg-Cox's taxonomy, 
               a project based on providing access to texts
                  helping readers understand scholarship#rydbergcox2006**Suda****Suda**
                  scholarship of integration#boyer1990
                  scholarship of discovery#boyer1990[http://​www.apaclassics.org/​outreach/​outreach.html](http://www.apaclassics.org/outreach/outreach.html)


### Conclusions


As we have already observed, SOL's translation of the **Suda**draftlow#dickey2007[^: To be precise, the statistics
