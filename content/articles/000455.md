...
Digital editions can change long after publication: errors can be corrected; new
                    ...
                    instinctively recognize G. Thomas Tanselle’s central truth
                        ...
                        in runs of what purport to be duplicate copies#tanselle1980[^: Tanselle (2001) objects to the idea that electronic texts are in
               ]
...
By contrast, online digital resources can be expanded or corrected long after
                    their initial release[^: As is frequently noted — see for example Schreibman (2013), ¶41 and Sahle (2016)]**The
                        ...
                        drastically#mcgann1995#mcgann1996[^: These might be changes to underlying
                        technologies, such ]
...
While the open-endedness of digital resources, the potential for evolution and
                    ...
                    well-known problem of link rotcontext drift#klein2014#jones2016context
                        driftthe challenge
...
The fundamental changeability of digital resources, including digital editions,
                    ...
                    from product to process #fitzpatrick2011#fyfe2012
...
When citation guides were first faced with the problem of the mutability of
                    ...
                    should include in their citations the date on which they accessed the material
                        #gibaldi1995#turabian1996#gibaldi1998#PM2001[^: The most recent edition of the APA
...
Another way of dealing with the problem of mutating resources — the method most
                    ...
                    projects appear to deal with textual change (see [Appendix](#appendix1)revisionDescchange#TEI2019**Walt Whitman Archive**#folsomprice**Archive**#WWAC2019[^: The blog also provides
                        descriptions of additions and mod]revisionDesc**The Whitman
                        Archive****Archive****Archive****William Blake Archive**#eaves2017**Archive**
...
Nor do change logs offer any way to get back to prior versions of a resource; a
             ...
             ]#pierazzo2015[^: RCSs can still be useful for presenting and exploring project
                  ]**A Social Edition of the
                        Devonshire MS**#siemens#wittern2013
...
The problem of versioning data is by no means unique to digital editions; it is a
                    ...
                    The W3C recommendation on **Data on the Web Best
                        ...
                        recommendationno one way#ANDS#nielsen2017[^: I collaborated with Daniel Paul
...
Versionversioning#reiman1987[^: On the prominence of documentary editing in
                        the digital ]
...
Both genetic critics and those concerned with the sociology of the text[^: I cite only a few productive samples from these wide-ranging
                        ...
                        a text as a text, to what makes it into a particular version#zeller1975a means of classifying copies of a
                        Work according to one or more concepts that help account for the variant
                        texts or variant formats that characterize them#shillingsburg1991#shillingsburg1991fluid textcritical
                        constructspulsings of .
                        . . collective energy#bryant2002
...
These sophisticated frameworks for textual change may seem far from the problems
                    ...
                    editorial discourses attached to it #gabler2010[^: This is
...
This way of conceptualizing versions is at heart hierarchical, with each level in
                    effect containing[[Bowers 2005|Bowers (2005), 37-42,
                        406-411]][[Tanselle 1975|Tanselle (1975)]][[Tanselle 1975|Tanselle
...
One approach to versioning software, which has been called Calendar Versioning,
                    highlights the temporality of releases #hashemi2019[^: The
                        CalVer proposal was released in 2016, but as the aut][the Appendix](#appendix1)
...
Even generic versioning practices have tended to make the degree of difference
                    ...
                    what changes in version numbers) actually mean #preston-werner[^: Ironically, at the time of writing, the Semantic Versioning
                    ]
...
Semantic Versioning sits especially uneasily at the intersection of intellectual
                    ...
                    system prioritize[s] a mechanistic understanding of a
                        ...
                        us#ashkenas2015[^: In light of this article’s argument, it is
...
Why should scholars at the intersection of physical book study and digital
                    ...
                    will often be included in other software systems #abilgaard2015
...
The focus on versioning as a communicative interface, designed to work in a
                    ...
                    foremost as objects for *reading*#mcdonough2010
...
Given the complexity of digital editions as textual objects, one place we might
                    ...
                    bibliographical typology #kirschenbaum2002VersionReleasecomputationally
                        compatible . . . but . . . not functionally integrated#kirschenbaum2002
...
This particular division would work well for describing digital editions of the
                    ...
                    parts together appears less appropriate for the continuous publishing#witt#witt2018the digital edition 2.0#boot2011
...
In arguing for the separation of object from interface, I do not mean to imply
                    that interfaces are mere[^: See Bradley
                            (2012) for one critique of the marginali]#eggert2013#andrews2018[^: A related problem exists in the study of videogames, where many
                ]
...
Despite the entanglement of content and presentation for scholarly understanding,
                    ...
                    without intermixing instructions regarding how that content is to be
                        ...
                        separation from the standpoint of ][[Franzini et al. 2019|Franzini et al. (2019), 16]][^: The TEI Guidelines
                        credit this separation as a character]#sperberg-mcqueen2009[^: Régnier (2014), 76, argues that philologists can . . . be held responsible for t]#sperberg-mcqueen2009[^: Sperberg-McQueen declares
...
As publishing practices evolve, being able to refer to objects separate from
                    ...
                    Zundert’s vision of a networked, distributed digital
                        edition 2.0advanced services#boot2011very important#franzini2019#robinson2013[^: See, for example, Turska
...
Although the remainder of this article focuses on versioning data objects,
                    ...
                    to identify and facilitate access to a specific version of the software #smith2016[^: For an overview of the importance
...
I will turn now to a case study based on my work in creating a formal versioning
                    policy for the **Piers Plowman Electronic Archive**#duggan2019**Piers Plowman**[^: On the history of the PPEA, see Knowles and Stinson (2014). On its early publica]
...
The practices considered and developed by the PPEA offer a starting point for
                    ...
                    characteristic of the modern web #liu2004stand-offsource#TEI2019[^: Desmond Schmidt argues that stand-off
...
Kirschenbaum has claimed that despite the significant technical challenges of
                    digital preservation, its greatest challenges are ultimately — and profoundly — social#kirschenbaum2008
...
The three projects using sitewide version numbers all use conventional
                    two-segment version numbers.[^: At the time of writing, Proceedings of the Old Bailey is on version 8.0, Schnitz]**Schnitzler**#izb2019[^: However, it is ambiguous whether all content
                        changes reg]
...
**Petrus Plaoul**edition2011.10-dev-masterOctober 04,
                        2011[[Plaoul 2011|Plaoul, 2011]]**Codex Sinaiticus**#XMLDneditionrevisionDesc**Codex
                        Sinaiticus**
...
Galey, A. (2010) **The Human Presence in Digital Artifacts****Text and Genre in Reconstruction: Effects of
                        Digitization on Ideas, Behaviours, Products and Institutions**[https://www.openbookpublishers.com/reader/64/#page/104/mode/2up](https://www.openbookpublishers.com/reader/64/#page/104/mode/2up)
