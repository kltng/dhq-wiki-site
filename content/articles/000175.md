...
three-dimensional, phonographic, videographic, digital, and performative [see [Figure 1]()[Figure 2]()[Figure 3]()[Figure 4]()[Figure 5]()[Figure 6]()[Figure 7]()[^: Most printed texts (including manifestos, critical essays, and
]
...
can be illustrated with **Soneto Ecológico****Ecological Sonnet**[Figure 8]()
...
embody current principles for electronic textual editing  rationale
...
textstandard text**Rationale of HyperText**
...
Archive**[PennSound](http://writing.upenn.edu/pennsound/)
...
Manifesto**
It must be free and downloadable.It must be MP3 or better.It must be singles.It must be named.It must embed bibliographic information in the file. It must be indexed. **PennSound Manifesto**
...
The **PO.EX Digital Archive**[Figure 10]()
...
Formats Web Site  (2004-] as complete environments[^: Their
case studies include (1) computers and disks of autho]
...
Archiving, and Dissemination** 1) Old Hardware Is Preserved to Run Old Systems; 2) Old Programs
...
addressed the problems of migrating born-digital work. **Computer poetry**[Figure 11]()**Poemografias****Computer Poems**
...
By means of the concept of electronic edition or archive as knowledge siteelectronic infrastrutcture for script acts[Figure 12]()Textual foundationscontexts
and progressionsinterpretive interactionsuser enhancements
...
reading and use, on the other [see [Figure 15]()
...
files in the archive [see [Figure 18]()
...
Initiative]materialitiesmetatextualitiesparatextualities
