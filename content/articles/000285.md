...
Valuation in Late-Medieval Brittany ** registers, ecclesiastical payment
...
Archive ** HathiTrust **unjustly neglecteddistant reading ** Graphs, Maps, Trees.** ** Trees ** Origin of
...
output ones construct an interpretative
frameworkepistemologicaldo[es] not represent the past, but
our ideas about the past frameworkcategories to delimit a
...
The ** Unified Modelling Language **[^: See http://www.uml.org.][Figure 1]()
...
advantage of the possibilities of electronic media[^: In this work, the scholars applied Digital Humanities methods to
...
We shall exemplify our methodology on case studies drawn from Ann Blair’s ** Too much, to know **[^: Indeed, we will try to examine the conference proceedings of
]
...
critique ** notesdiscarding notesintegrating noteserasable surfacesloose sheets stored in bundlesfirst-ordersecond-order-ordersecond-order
...
note-taking
would be entered into the index under a keyword its principal thingsheets corresponding to each letter of the alphabetreceive new headings over time **notebook management tool elaboration **
...
compilers relied on earlier work
...
passage to a topical heading use of
...
retention the order in which they were encountered[^: This is suggested in
and confirmed in , and further in ]
...
Renaissance **duclos-mounier2014textile copy and counterfeit in the Renaissance
...
Humanities project, usually rests on three main components (see [figure 3]()[^: XML stands for eXtended Markup Language (see http://www.w3.org/standards/xml/and][^: In the field of bibliographic
