...
Initiative (TEI), an international consortium founded in 1987 (see [http://www.tei-c.org/index.xml](http://www.tei-c.org/index.xml)
...
markup method has significant disadvantages,** The Textual Condition **
...
the years (see, e.g.,** Multi-Dimensional Texts in a One-Dimensional
Medium **
...
hierarchy of content objectscontent object
...
abstraction to the mathematical concepts of setrelation,
...
paradigm — to go beyond a Web of documentsWeb of data,triples.nodesarcsverticesedges
...
The CHOIR ontology is described in considerable detail in our OCHRE manual ([http://ochre.uchicago.edu](http://ochre.uchicago.edu)[^: See OCHRE by Schloen and Schloen (2012), pp. 372–375. Previously,
...
an individual text. As we explain in our OCHRE manual
...
on different schemas that are based in turn on different ontologies (see
...
judgment. In his book ** What Computers Can’t Do.** ** The Computational Theory of Mind ** Stanford Encyclopedia of Philosophy ** Dreyfus argued
that most human knowledge and competence — particularly *expert*horst2009[^: In their 1986 book Understanding Computers and Cognition, the computer scientist]
