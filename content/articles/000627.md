...
Scholarly workflows in the Digital Humanities can benefit from the application of
               natural language processing (NLP) tools #argamon2009newswire#mcgillivray2020#shirai2020#straka2017#scannell2020
...
#shirai2020#ninjal2021core datagold-standard


Text normalization is a well-known preprocessing problem in NLP with many proposed
               solutions. For Japanese text normalization, #ikeda2016#bollman2019
...
We follow #shirai2020#maekawa2006#ninjal2021
...
To evaluate our methods, we also incorporate three other magazines made available
                  ...
                  Zasshi (鳴鹿) (1874 - 1875), and Kokumin (國民) (1887 - 1888) #tanaka2012#ninjal2021[^: The four collections make available metadata that classifies articles as either
]
...
GiNZA is a recent open-source NLP framework that advertises as an easy one-stop#ginza2021#nivre2016#straka2017#maekawa2014
...
Before proceeding to describe our workflow in detail, we offer a brief overview of
                  ...
                  rules used for producing normalized text can be viewed as an expert systemaz+あタ勉023#qiu2020
...
The fourth component consists of two characters. The first character of the
                     pair is ordinarily pronounced hatsutatsuha-hattatsuhatsutatsushitagaふshitagoふhuu.#straka2021*社會*society.
...
- A normalized value giving the agreement percentage#zeman2018[^: The labeled attachment score (or LAS) is the percentage of nodes with correctly
]
...
To evaluate this, CoNLL-U output with and without rule application is compared
                  across the 4 corpora using the BLEX, CLAS, and MLAS metrics as defined in #zeman2018#zeman2018
...
We evaluate whether the observed effect on the dependency structure of the CoNLL-U
                  ...
                  Japanese Wikipedia #asahara2018a UDPipe model trained over GiNZA
...
In keeping with the methods proposed in #shirai2020BBstart of
...
Perhaps one step in this direction are NLP methods that can flag instances of
               ...
               collection. One possibility is to allow for rule chaining,#ikeda2016#mcgillivray2020
