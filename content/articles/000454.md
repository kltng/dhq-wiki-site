...
corpora, as others have pointed out
...
methodologically un-sophisticated tools such Google Books Ngram Viewer
...
More recently, some authors HumanitiesComputational HumanitiesDH
...
different organizations, international negotiation documents, and news reports
 [t]he primary problem is volume: there are simply too many
political texts
...
tools will fail to provide satisfactory results

Natively digital texts are not exempt from the caveats above. A case illustrating
this is the work on the ** Earth Negotiations Bulletin ** HTML varieties
...
metadata information and are often rich in linguistic annotation#bański2009órkowski2009
...
either because they contribute to cleaning
...
synchronic corpora of current languages. However, when applied to messy*mus*musclemusselmouse
...
trained on a small range of text types, e.g. newswire
...
conclusions to draw from the data much of a focus on what the computational techniques
obscure as reveal
...
character detection have taken such difficulties into account
...
Officer of Health reports from London for the years from 1848 to 1972
...
Initiatives in this direction have emerged, like Tool Criticism

We will now review an example of evaluation relevant to a specific DH task[^: F1 was
...
is that, as reported before-maskari2010
...
Third Linguistic Annotation Workshop ** Mapping Topics in International Climate Negotiations: A
...
Literature ** A Companion to Digital Literary Studies ** Computational Literary Studies: A Critical Inquiry Online
