...
While questions of visual encoding – the way visual variables, such as position,
               ...
               visualizations #bertin1983#shneiderman1983#woods1984#elmqvist2011#card1999#chevalier2014#chevalier2016


This is especially problematic when considering complex and multidimensional
               datasets, as of cultural collections #windhager2018true,#drucker2011


We propose the notion of the fold, advanced by French philosopher Gilles Deleuze #deleuze2006#risam2015
...
This research is largely motivated by a recent surge of work on the visualization of
               ...
               proposed, yielding an abundance of visual interfaces and representation techniques
                  #windhager2018Overview first, zoom and filter, then details on
                  demand#shneiderman1996#dork2011#whitelaw2015#thudt2012#vanham2009#kreiseler2017#windhager2019
...
To this end, a range of techniques and methods have been proposed. The visualization
               ...
               and encodings #bertin1983#carpendale2003#woods1984#gleicher2018#sacha2017#stahnke2016#wattenberg2016#sacha2017


The iterative analysis of data can be thought of as an ongoing information practice
               that exhibits the characteristics of flow#csikszentmihalyi1990#pace2004#shneiderman1983#woods1984#elmqvist2011#chevalier2014#tversky2002#bederson2003#heer2007#chevalier2014


In all this, we are guided by a growing critical awareness about graphical interfaces
                  #drucker2011#dignazio2016#dork2013#dignazio2020#loukissas2016#risam2015#hepworth2018#parry2019#drucker2013#parry2019
...
In the following, we briefly introduce Gilles Deleuze’s concept of the fold, in which
               he links Leibniz’ baroque idea of monadology to postmodernism #deleuze2006The Fold#colebrook2002#bredekamp1988


#### Thinking through the Manifold


In **The Fold. Leibniz and the Baroque**#leibniz1898a way to differentiate matter without
                     introducing discontinuity#laerke2010allegory of the world#laerke2010#wagner1995#freitas2016#deleuze2006pleats of matterfolds in the soul,
...
While Deleuze’s treatment of the fold is rather extensive and, in parts, elusive,
                  ...
                  Latour and colleagues #latour2012#dork2014actualvirtual,virtualdigital,#freitas2016Because the world is
                        ...
                        outside of them, just like the principle of their accord.#deleuze2006


#### Operations of the Fold


For Deleuze, the three operations Explication–implication–complication#deleuze2006The Fold[Figure 1](#figure01)[Figure 1](#figure01)
...
At the intersection of the fold and monadologic theory, Deleuze introduces
                  complication as the third operation of the fold (see [Figure 1](#figure01)true foldingcomplicatio#gandillac1953complicatedcomplicated
...
The fold surprises with its infinite possibilities; the outcomes of folding
                     ...
                     remain unpredictable and serendipitous #leong2011#thudt2012
...
In the context of information visualization, interactivity has been largely viewed
               through the lens of users tasks and intents #yi2007foldsfolding[Bach et al.
                  2016](#bach2016)[Dörk et al. 2014](#dork2014)[Riehmann et al. 2018](#riehmann2018)[Zhao et
                  al. 2014](#zhao2014)
...
Designing visualizations along the fold means to understand information spaces as
               ...
               more light on the in-betweenscalable
                  exploration#bludau2020#dignazio2020#drucker2011#loukissas2016
...
Arguably, explication and implication as the first two operations of the fold are
                  ...
                  dispersing, etc. In particular, semantic zoom #perlin1993[Figure 2](#figure02)
...
- **a)** An interactive mechanism common in network
                     visualizations is selecting a node in a graph to trigger an explication, which
                        unfolds[Morris 2018](#morris2018)[https://www.deutsche-biographie.de/graph?id=sfz53095](https://www.deutsche-biographie.de/graph?id=sfz53095)#historische2010
- **b)** The explication in a temporal streamgraph stretches
                     ...
                     preserving its context [e.g., [Baur et al. 2012](#baur2012)[Cuenca et al. 2018](#cuenca2018)[Morawa et al. 2014](#morawa2014)[Riehmann et al. 2018](#riehmann2018)[Slack et al.
                        2005](#slack2005)**Touch the Time**[https://www.uni-weimar.de/projekte/vr-scratch/videos/TTT.mp4](https://www.uni-weimar.de/projekte/vr-scratch/videos/TTT.mp4)#riehmann2018
- **c)** The visualization of hierarchical data demonstrates
                     ...
                     provide sufficient space for the newly unfolded subbranches [e.g., [Slack et al. 2005](#slack2005)#wattenberg2008Alice**Alice in Wonderland**[https://www.jasondavies.com/wordtree/?source=alice-in-wonderland.txt](https://www.jasondavies.com/wordtree/?source=alice-in-wonderland.txt%20)#davies
...
- **a)** A linear timeline arranges events solely on the
                     ...
                     using, for example, multidimensional scaling, as in the Time Curves technique
                        ([https://aviz.fr/~bbach/timecurves](https://aviz.fr/~bbach/timecurves)#bach2016
- **b)** The two-dimensional visualization of a dataset as a
                     scatterplot (top) can be gradually complicated by the introduction of
                     flower-like glyphs encoding multiple dimensions per element [e.g., [Kammer et al. 2018](#kammer2018)[Stefaner et al. 2014](#stefaner2014)[Goldenberg 2017](#goldenberg2017)[Stefaner et al. 2014](#stefaner2014)[https://projects.interacta.io/country-tsne](https://projects.interacta.io/country-tsne)#rokotyan2019**Understanding
                        the data**
- **c)** An egocentric network centered around one node (top)
                     can be a starting point #vanham2009[Ortiz 2013](#ortiz2013)**Six degrees of Francis Bacon**[http://www.sixdegreesoffrancisbacon.com](http://www.sixdegreesoffrancisbacon.com/)#warren
...
Considering the examples above, the fold’s operations help to identify the
                  ...
                  Building on Deleuze’s writing and related visualization research [e.g., [Elmqvist et al. 2011](#elmqvist2011)
...
The spectrum of dynamic changes to individual elements and entire arrangements
                     ...
                     a blooming flower, the additional data dimensions in [Figure 3](#figure03)
...
Humanistic data is oftentimes shaped by various forms of uncertainty,
                     subjectivity, and ambiguity #drucker2011#hullman2019
...
Although this research mainly focused on the implementation of the fold through a new
               ...
               Deleuze’s infinite folds, the common approach to data as given#drucker2011#dignazio2020#dork2013#hullman2011
...
As data visualization continues to expand its relevance in the digital humanities,
               ...
               interpretation #drucker2011#sengers2006
...
Parry, Kyle. **Reading
                  ...
                  Humanities**[https://dhdebates.gc.cuny.edu/read/untitled-f2acf72c-a469-49d8-be35-67f9ac1e3a60/section/bd5a43c1-bbfe-4c5c-8c0d-c3db1776eb99#ch13](https://dhdebates.gc.cuny.edu/read/untitled-f2acf72c-a469-49d8-be35-67f9ac1e3a60/section/bd5a43c1-bbfe-4c5c-8c0d-c3db1776eb99#ch13)
