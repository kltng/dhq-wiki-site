...
1.2. Bibliographic identification of the reviewed SDE..8. Identification and citation.
...
the changes URLaccepted[^: For more details see Wikipedia’s permalink strategy: https://en.wikipedia.org/w/][^: For the Wikipedia permalink strategy see: https://en.wikipedia.org/w/index.php?t]`<revisionDesc>`[^: https://tei-c.org/release/doc/tei-p5-doc/en/html/ref-revisionDesc.html
]
...
see the website bibleserver.com which aligns mo]
...
by a digital paradigm in their theory, method and practice[^: I received a copy of the
...
1754/1755 ** Benutzerhinweis **[^: https://quellen.perspectivia.net/en/portal/user_guide [20.
...
the HTML document via so-called meta-tags.`<span>`
...
whole, it has been considered as granular addressing.addressing markupfragment identifier[^: See also the projects e-codices (http://www.e-codices.unifr.ch/en) and Fragmenta]
...
idfragment identifier ** Text Encoding for Interchange **
declaration`<refsDecl>`[^: See also: https://www.npmjs.com/package/CETEIcean and https://github.com/TEIC/CE]
...
centuries[^: The Homer Multitext Project was the first big test case for CTS
]
...
often considered as being finalstatic,
...
Online **[^: https://www.oldbaileyonline.org/static/Legal-info.jsp
]** The
