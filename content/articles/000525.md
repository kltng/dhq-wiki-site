...
Amongst the many theoretical questions about text, there is a philosophical, or
                    ...
                    question is perhaps ‘What *is*text is best represented as an ordered
                            ...
                            is#deroseetal1990humanists are trying to represent what
                            they all agree are non-hierarchical structures#schmidt2010
...
Methods of textual criticism have been developed for many purposes, including for
                    ...
                    ranging from ultra-diplomatic to so-called students*new*interactive dynamic presentation#pichlerandbruvik2014*entirely*


Many of the innovations are due to the discipline of text encoding (#tei2007#hockey2000#huitfeldt1994#pichler1995interactiontransparencyWhich of the many versions made available
...
But is the view that text is a hierarchical object #deroseetal1990#schmidt2010
...
If we start from a widely accepted tripartite division of what exists into
                        ...
                        written documents, the products from writing, as *objects**concrete,
                            ...
                            bank,[^: Some may object that we frequently use text and
                                ]#hockeyetal1999#huitfeldtetal2012typeimmaterial[^: Some of the
                            challenges that conceptions of text as a]documenttexttextsurface
                            grammartext#wittgenstein2009
...
Some of the arguments which speak against the view that texts are some kind
                        ...
                        that texts may be eventscarriersobjects*entirety*#kanzian2015bearerstext event
...
In the last couple of paragraphs I have proposed a way of looking at the
                        ...
                        level and cease to exist *as a text**text*[^: The point of mind-dependency is discussed by
                                 fo]*constituting*#gadamer1960[^: It is interesting to note
...
Text encoding can record data about the document carrier, the document as
                        ...
                        document, pertains to the third.[^: Also the term text
                                technology (cf. TEXT Technolo]*text*#biggsandhuitfeldt1997bearers


What are then the implications of our philosophical investigation for our
                        question whether hierarchical or rather *non*as sucha protocol of perception, mapping and interpretation#sahle2015*us*hierarchicalnon-hierarchical*actions*An ‘OHCO structure’
                                    isnot a model of the text,
                                    but a possible model of its expression#buzzetti2002Text is a hierarchical *ordering**non-**both**with meaning**symbolized*#wittgenstein1963
...
If this wasn’t true, and consequently: if it wasn’t true that we can
                        ...
                        example is editorial work on the Wittgenstein **Nachlass****Nachlass**diplomaticlinearizednormalizedinteractive dynamic
                                presentation#pichlerandbruvik2014**Nachlass**XML*XML**source*[^: A simple example from Wittgenstein Nachlass Ms-106 can be used to exemplify
    ]
...
The version of the comment on Augustine’s account of language acquisition that
                    ...
                    includes the following passage: In this picture of
                            ...
                            which the word stands.#wittgenstein2009*in and of themselves*
...
In this paper, I have tried to show that the debate about hierarchical vs.
                    non-hierarchical markup can be resolved by a reflection on the depth grammar#wittgenstein2009logical grammar#wittgenstein1963textdocument*our***Nachlass**[^: I am indebted to many
