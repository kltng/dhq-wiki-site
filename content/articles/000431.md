                    ...
                    upload the contents of whole libraries at a time. Kevin Kelly, co-founder of
                        **Wired**
                        [o]nce books are digital, books
                            ...
                            single, isolated book#kelly2012#aiden2013
...
Projects that make available great amounts of data, however, pose what Matthew
                    Wilkens calls a problem of
                        ...
                        We don’t read any faster than we
                            ...
                            … we need to decide what to ignore.#wilkens2011
...
The field of Digital Humanities (DH) aims to offer methodological innovations to
                    ...
                    provocative call for distant reading. Moretti deemed close reading a theological exerciseread less
                        an artifact of a period
                            ...
                            interacting with information in an analog era#mayerschonberger2013**The Making of Americans***not-readable*#don2007#kirschenbaum2007
...
Els Stronks has opined we should make the gap between close and distant as wide
                    ...
                    the results gained by computational analysis #stronks2013
                        [t]he availability of voluminous
                            electronic data, one might conclude, makes it even more necessary to
                            cultivate the faculty of analyzing data closely and critically#rosen2011#moretti2009#earhart2015


Moretti's argument in **Slaughterhouse of Literature**close
                        reading,#igarashi2015
...
A brief survey of how different scales of analyses are connected in actual
                    ...
                    US novel #so2019**Reading Machines**
                        algorithmic criticism,#ramsay2011
                        The critic who endeavors to put
                            forth a reading,#ramsay2011**PMLA**not reading,#booth2017#drucker2017#piper2017


For a good overview of papers combining close and distant reading from 2005-2015,
                    see #janicke2015**Information Seeking Mantra**
                        Overview first, zoom &
                            filter, details on demand#shneiderman1996top-down**The Longue Durée of Literary Prestige**#mcgrath2018#lee2018


Stanford Lit Lab pamphlet 4 #heuser2012
                        ...
                        hypothesis-testing mode of
                            interpretation#heuser2012meaning problem
                        quantitative interpretation and
                            humanly meaningful qualitative interpretation#liu2013#algeehewitt2016#guldi2018
...
We believe that this mostly literary-historical body of work since Moretti,
                    especially concerning the 
                        great unread#moretti2000ainformation
                        overload
                        uncharted expanse#moretti2000
                        great unread#cohen1999#jockers2013testingcorrecting
...
Close reading is an umbrella term for an assortment of reading strategies
                        ...
                        K. Wimsatt, and Monroe C. Beardsley. Inspired by I.A. Richards (author of
                            **Practical Criticism**
                            affective fallacy#wimsatt1949
                            intentional fallacy#wimsatt1946
                            heresy of paraphrase#brooks1947[^: Other seminal works to mention in
                            this respect are C]
...
Distant reading is the practice of aggregating and processing information
                        ...
                        reader to read these texts #drucker2013Readingpractically unreadably


In his book **Distant Reading**problemspossess
                            distinctive features at every possible scale of analysis#allison2011#allison2011macroanalysis#jockers2013
...
The text corpus used in the research described in this article comes from
                        Reddit, a social content aggregation website and the self-styled front
                            ...
                            a bulletin of user-submitted
                                text, links, photos, and videos #duggan2013
                            social voting site#gilbert2013*reddit.com/r/PoliticalDiscussion*. The single posts in
...
While investigations using Reddit data often aim at uncovering trends across
                        single discussions and even across discussion forums (subreddits) (cf. #zhang2017
...
A common phenomenon in discussions in general is that the sub-questions
                        ...
                        to discourse function in Reddit discussions #zhang2017
...
Yet, the role of irony, emotion, and humor in this thread warrants a close
                        ...
                        contemporary (online) culture has been described by Ian Bogost as the 
                            escape from having to choose
                                between earnestness and disdain,#bogost2016**The Ambivalent Internet**close reading
...
One technique that fulfills both requirements is Latent Dirichlet Allocation
                        (LDA) topic modeling #blei2003language
...
Given the co-occurrence matrix, the aim is to find, for each LDA topic, the
                        ...
                        normalisation, applied on the co-occurrence matrix ([Figure 2](#figure02)
...
For each manual/LDA pair of classes with highest co-occurrence, we generate a
                        mapping from LDA classes to manual annotation classes ([Figure 3](#figure03)[Figure 3](#figure03)
...
Using the mapping, the LDA classes are translated into manual annotation
                        classes ([Figure 4](#figure04)guess*common*
...
Based on the close reading strategy described above, we identify fifteen
                        classes of posts ([Table 1](#table01)*What characteristics should a president have
...
By assigning colors to the classes that relate to the same question or
                        ...
                        and see how these discussions develop throughout the thread ([Figure 5](#figure05)*Democrats didn’t show up. Republican turnout fairly
...
Following application of the LDA topic modeling technique and the process to
                        ...
                        number of topics in the LDA model. [Figure 6](#figure06)
...
In order to resolve the problem of overspecification, we look at a
                        ...
                        the number of topics with the lowest absolute difference in accuracy. [Figures 7](#figure07)[8](#figure08)
...
To evaluate how well the LDA model overlaps with the manual annotations it is
                        ...
                        topic models are presented in [Table 2](#table02)
...
Close reading digs for complexity, opacity, irony, and ambiguity: values that
                    ...
                    in a time that tends to privilege the full picture
                        Editing towards meaning is a
                            ...
                            information, which accumulates in a significant pattern#drucker1997
