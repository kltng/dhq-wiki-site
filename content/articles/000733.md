...
Cuneiform provides unique challenges for object detection algorithms, particularly OCR methods. Cuneiform tablets, on which the 
                   ...
                   (also WinkelhakenDiagonal#cammarosano_2014#cammarosano_et_al_2014#bramanti_2015#taylor_2015
...
From the inception of research in cuneiform studies, tablets were difficult to represent in a modern 2D publishing format. Two 
                   solutions were found:
                     ...
                     When possible, 2D images of cuneiform tablets were taken. However, for most of the field's history, such images were  
                           ...
                           the history of early photography and cuneiform studies, see #brusius_2015The second solution was creating hand-copies, 2D black and white line art made by scholars of the tablets' strokes. This 
...
In recent years, the quality of 2D images has risen significantly, while the costs of production and reproduction dropped. A 
                   ...
                   Digital Library Initiative](https://cdli.ucla.edu/)[Electronic Babylonian Library](https://www.ebl.lmu.de/)[Yale Babylonian Collection](https://babylonian-collection.yale.edu/)#earl_et_al_2011#hameeuw_willems_2011#collins_et_al_2019#dahl_hameeuw_wagensonner_2019
...
Previous research of identifying cuneiform signs or strokes have used mostly 3D models. Two research groups have developed programs 
                   ...
                   [CuneiformAnalyser](https://www.hethport.uni-wuerzburg.de/HPM/hpm.php?p=3djoins)#fisseler_et_al_2013#rothacker_et_al_2015[GigaMesh](https://gigamesh.eu/?page=home)#mara_et_al_2010#fisseler_et_al_2014#mara_kromker_2013#bogacz_gertz_mara_2015a#bogacz_gertz_mara_2015b#bogacz_howe_mara_2016#bogacz_mara_2018#kriege_et_al_2018


Work on hand-copies includes transforming raster images of hand-copies into vector images (SVG) #massa_et_al_2016#rusakov_et_al_2019#dencker_et_al_2020Rusakov#rusakov_et_al_2020#bogacz_mara_2022
...
There are different types of computational models for object detection, ranging from the purely mathematical to deep learning 
                   models #wevers_smits_2019Mathematical models


Deep learning models#girshick_et_al_2014
...
There are two main types of convolutional neural networks: two-stage detectors and single-stage detectors 
                         #jiao_et_al_2019#girshick_et_al_2014#redmon_et_al_2016#mishra_2022
...
YOLO, short for You Only Look Once, is a family of convolutional neural network architectures that was first introduced 
                               in 2015 by Joseph Redmon#redmon_et_al_2016#jocher_et_al_2020[^: See Ultralytics/Yolov5 (2021) 
                               Yolov5, GitHub, av]
...
Region-based Convolutional Neural Networks (R-CNN) were first introduced in 2014 by Ross Girshick#girshick_et_al_2014


![The components of the R-CNN detector, from .](resources/images/figure02.png)


A year later, Girshick#girshick_2015


Building on the improvements of Fast R-CNN, Faster R-CNN was introduced just three months later 
                               #ren_et_al_2015Bi[^: See Bi, A. (2020)  
...
To train an artificial neural network, a dataset divided into training, validation, and test subsets needs to be created. In 
                        ...
                        for each class is at least a thousand images #cho_et_al_2016[^: See Approboflowcom (2021) 
...
Furthermore, our model is not period-dependent, meaning that some of the tablets we have chosen are over a thousand years apart (see 
               ...
               left on the clay tablet #edzard_1980#labat_1988
...
The subsequent step, identification of constellations of strokes as cuneiform signs, is under development by part of the authors 
               #gordin_romach_2022[demo](https://www.ben-digpasts.com/demo)#yamauchi_et_al_2018#cohen_et_al_2004#gordin_et_al_2020#punia_et_al_2020[ORACC](http://oracc.org/)#gutherz_et_al_2023
...
In addition, our results worked well on very high quality 2D images, curated by an expert #wagensonner_2015
...
The task of the epigrapher is to decipher the ancient writing surface — not merely to decipher the script or any linguistic element 
               ...
               diplomatic approach to texts has a long history in medieval scholarly practice #duranti_1998#bertrand_2010desideratumSitz im Leben
...
For that end, an interdisciplinary group of scholars dealing with ancient language processing and machine learning for ancient languages 
               #anderson_et_al_2023#sommerschield_et_al_2023
...
In order to ease the process of data creation for the next steps of the project, we developed three image and label processing 
                     ...
                     project.[^: See 
                     https://github.com/adelajelinkova/cuneiform/tree/main/]#chollet_pecinovsky_2019
