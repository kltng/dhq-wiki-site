...
A story, simply put, is a sequence of events. This definition has been in place
                    at least as early as Aristotle’s **Poetics**#frawley1992#genette1972#herman2012#labatt2005#leitch1986#reed1973[^: Of these, the classic work is Gérard Genette’s
                            Disco]#baroni2016#hansen2017#phelan2017#richardson2019
...
Despite these definitional challenges, researchers have been productively using
                    ...
                    his exhaustive and insightful overview of the state of the field, **Computational Modelling of Narrative**#mani2013#ogata2019


Despite this substantial scholarly footprint and exciting advances, [t]he flow of influences has historically been from
                        narratolology to computation,#mani2013
...
One single-author study that has managed to scale by dint of years of laborious
                    coding, consistent revision, and substantial institutional support is the
                        Digital YoknapatawphaDYDYdeep atlases[http://faulkner.iath.virginia.edu/](http://faulkner.iath.virginia.edu/)DY#burgers2020#railton2015#robbins2016
...
Historically, there have been two important observations about narrative. The
                    ...
                    Russian Formalists, is the separation of the fabulasyuzhet#baroni2016#forster1927#shklovskii1990Narrative
                        sequences…are semantic and not semiotic in nature#prince2016#prince2016#fludernik2005deep structure,sequence is assimilated into the broader question of intersequentiality and
...
Translating narratological insights into computational methods poses a
                    ...
                    complex tasks including: natural language processing #delmonte2017#muzny2017#xie2019#bartalesi2016#bogel2014#leonid2017#wallace2012#barros2019#nijila2018#lakoff2010#baber2011#focilarias2018#gutierrez2018#seonwoo2018
...
Still, there have been significant attempts to generate a functional model for
                    doing narrative analyses using digital methods. For example,
                        PlotVis#brown2013heureCLÉACATMA#meisterNarrelations#schwan2019ProppLearner#finlayson2017#finlayson2017[^: Finlayson’s more recent related work is
                        extremely promis]
...
Other recent investigations of narrative have relied more on natural language
                    ...
                    Among these is the aptly named, Syuzhetpositive
                        and negative sentiments are activated across the text#jockers2017#swafford2015plotmulti-dimensional relations between predicates with their arguments
                        containing relations between the change-of-state and its goal#takeuchi2016Yarn#padia2019
...
Finally, there has been a spate of projects that use film as a basis of narrative
                    analysis. As Eric Hoyt et al. explain, [o]f all narrative
                        ...
                        for computational analysis#hoyt2014#sharma2013ScripThreads#hoyt2014Story Curves#kim2018
...
Faulkner Studies has always had a special relationship with narratology. Because
                    ...
                    time, so much so that it is somewhat of a cottage industry #going1958#harris1993#inge1970#nebeker1971#perry1979#reed1974#schwab1991#stewart1958#volpe2003#wilson1972**William
                        Faulkner on the Web****The Sound and the
                        Fury: a Hypertext Edition**#stoicheffDY**Absalom, Absalom!**#railtonrourk2003[^: Unfortunately, neither
                        digital text currently functions.]


In its sheer openness and scale, DY[^: As
                        of this writing the exact numbers are 2,152 locations]#alvarado2018
...
Included in this data set are also a number of variables that allow for the study
                    ...
                    fictions had to be entered into a relational database containing the entities:
                        ...
                        Entity Relationship Diagram Digital Yoknapatawpha DatabaseEntity
                            Relationship Diagram **Digital Yoknapatawpha**Chart showing relationship between entities.#mani2013**Red Leaves,**hunt
                        [A](1) In the middle of the afternoon he came face to
                            ...
                            ashore and crash away into the undergrowth. #faulkner1995Indian,DY
...
For DY, the scale of an event is defined as, 1 setting, 1
                        ...
                        Event#railton2015DY#chatman1978
...
Along with delimiting events, another challenge is ordering them. For the
                    ...
                    order #richardson2012


This is not always the case though. There are occasionally
                        orphan**The Sound and the Fury**the matter is too minute to warrant further discussion#stewart1958DY[^: This approach precludes the possibility of simultaneity,
                       ]
...
On occasion, computation was used to provide a rough sort of events, but, by and
                    ...
                    logic programming to infer the most probable order of events for **A Rose for Emily**#burg2000[^: Their findings are intriguing as a proof of
                        concept for ]**The Mansion**#railton2015
...
Taking the narrative data and turning it into visualizations presents its own
                    ...
                    complex narrative techniques as everything from the frozen
                        moment#riojellifffe2001#skei1999
                        There is no such thing really as was because the past
                            ...
                            instant in which he does something.#faulkner1965
...
At first blush, it would appear that there is no accepted standard for
                    ...
                    the appendix of **Morphology of the Folktale**#propp1979#railtonrourk2003#stoicheff#liu2013#munroe2009#padia2019#tanahashi2012first scientific investigation and
                        systematic exploration of this visualization technique,#kim2018
...
Along with chronological data, DYWho/what is responsible as the source of this
                            Event?#railton2015*Narrated**Told**Remembered**Hypothesized**Narrated**consciousness***Light in August****Ulysses**
