...
humanities-based research question. In their anthology, incomprehension persists.
...
archival television data. Collaboration in DH is often, as at building
...
technology and software production.*and*the other
...
already published in computer science outlets ([^: However, computer science papers are not (easily) collected, let alone
]
...
discipline field of inquiry with a
...
All terms can be situated on a *continuum*cross-trans- disciplinary norms and practices
...
Feminism***diverse*haraway1988greased poles dilemmapartial visionssituated knowledge
...
computer sciences, a (double) self-reflexive account[^: About 12 people have been involved in this project, i.c. in the
]
...
digital technology in the humanities and arts ** IyouweweCSMS in the making
...
ourselves. That is, as disciplines[Table 1]()
...
need from within large collections (usually stored on computers) data
...
Humanities research is sometimes defined as lonely scholar ** Cinema Journal ** Television and New Media ** Society for Cinema and Media Studies **
...
disciplines, provides the starting point, the point zero
...
content. Consequently, iMMix mainly supports known itemknown item search systemexploratory search system
...
experience with the search system and someone with a limitedRussia
...
is formulating the initial research question for your papersubjunctive
...
(Contextualizing Media Researchers’ Data) ([figure 2]()
