...
Robert Weimann has suggested that bridging the discontinuousnegotiation,
...
blocking[^: See also  on the irreversibility of
theatrical transcodi]

Recent work in the theory of dramatic narrative, however, offers an alternative
by not foreclosing performance from the gaze of the critic (#nünning2008
...
reading toward performance play and production,
representational acting and
presentational playing
design for performance,
grammar toward performance geography
...
many character-spaces ** Hamlet **character-space, of
...
link). words passedimplicitif two characters spoke to each otherwere in each other’s presence
by writing a computer program to
count how many lines each pair of characters in ** Romeo and Juliet **
...
not yet a realistic possibility act.some words
...
natural[^: So, for example,  specify that
...
and quantitat]actorstranslation.*a priori*[Figure 1]()
...
the Oxford Shakespeare shown in [Figure 2]()
...
network the movement of the
social visible to the reader of the socialvisibleactor.reactivate, distributed, suggested, influenced,
...
counting the number of lines of A
spoken immediately after B, and vice versa, and summing them*response*strongweakstrongweak
...
hairball-ish,similar network densities, which suggests similar story structures
...
and waste,** Hamlet***thanatos*bradley1909#McAlindon2013 the
inexpressibly horrible
excess ** Hamlet **scatteringtotal
disproportion ** Rabelais
and his World.** ** A Midsummer Night’s
Dream **
...
readily apparent in the persistent example of friendsclose friendsacquaintances
...
the friend of your friend is likely also to be your friend and spoke[Figure 1]()
...
more dense than the play’s average of 7.57 connections per scene ([Figure 4]()
...
distance between affectively close[Figure 9]()
...
Andronicus ** Romeo and Juliet **[Figures 10-14]()
...
fatal conclusion to ** Romeo and Juliet***frisson*[Figure 15]()
...
her own suicide as being wound in a knot intrinsicate[Figure 12]()** Othello **being wrought, / perplexed in the extremeperplexedenmeshednet.perplexedto
...
performances of the play, show the extent to which Othello is perplexed in the extreme[Figures 16-20]()
...
To extend the visual homology, the network of Act 5, Scene 2 in ** Hamlet **[Figures
21-26]()
...
timehis form and pressure.form and pressureplaying.suit the action to the word, the word to the
action*topos*** Winter’s Tale ** There was speech in their dumbnesse, Language in
...
through the language arranged in the space of the line on the page [Figure 27]()
** Hamlet **reading eye is a scanning mechanism as
well as a linear decoder#McGann1991two-axisimpressions of activity of activity
...
network attempts to capture based on the text’s language ([Figure 28]()
Buchel / DeWitt Sketch of the Swan Theatre (1595).[Figures 29-30]()
C. Walter Hodges’ rendition of the Globe Theatre.
C. Walter Hodges’ rendition of the Globe Theatre. enormously active, dynamic blocking planalmost violently active
and mobile, rather like a rugby league match to the word, word to the action.
...
22]()translationword-by-word, line-by-linestage geography.relationships with each other,
...
description of the social world as patches of order in a sea of disorder[^: Also note : Universality or order are not the rule but the
]boundaries between order and
disorder
imagining the uncertain messengers
that pass between different orders or between order and disorder of complexitysea
...
poor visual landscape the mass of
quali-quantitative data
visual datascape,partsactors
