...
feet;
it seems most correct]*χώρα*** Peri Musikês ** On Music **first places*ταῖς πρώταις χώραις*vanophuijsen1987[^: For competing notations, see , cf.
.] technicus*χώρα***sedes **seat; place
...
on articulating metrical tendencies, such as colometric patterns **caesurae***τομαί***sedes **[^: Caesura (cutting), as in a pause or word break in a verse, with τομή as the Gree]-types,concentration of
occurrences (of specific metrical shapes) in but a few of the possible
positions of
expectancy[^: For localization of word-types in iambic trimeter, see  and .]
...
by*sedes **hapax **dis
legomena*mclennan1977[^: Cf. .][^: Other digital analyses of metrical Greek language focus more
exclusively o]
...
Mapping a word to its lemma is not trivial[^: The idea of
grouping words according to a definable equivalence relation i]x1234[^: That is, for the purpose of
statistics. For the purpose of interpretation,]true[^: Source code for cltk.lemmatize.grc.]** Iliad **
...
automatic scansion. For ancient syllabific]sedes
...
and the sedes.sedessedessedes

Our metric of expectancy is the zμσzsedeszsedes
...
by ordering rows by lemma and z
...
review of predominant definitions of formula in context of o] group of words which is
regularly employed under the same metrical conditions to express a given
essential idea expression qui est régulièrement
employée, dans les mêmes conditions métriques, pour exprimer une certaine
idée essentielle*πατρίδα γαῖαν*(to one’s)
fatherland.*πατρίδα γαῖαν*** Iliad **bucolic diaeresissedes[^: Iliad 2.140, 158, 174, 454, 4.180, 5.687,
...
flexibility*qua*expandedcontracted.sedes
...
moments in the text*Sedes* expectancy may
...
πατρὸς σοῖο*** Iliad ** Priam’s first words are a
...
σκυδμαινέμεν*allenhornblower2020*πατρίδα γαῖα **δέξαι
ἄποινα*** Iliad***δέχθαι
...
Third, the fact that otherwise formulaic ** Iliad **sedes ** Iliad **
...
between different passages based on the sedessedes

![Matrix of sedes intertextuality by expectancy.](resources/images/figure10.png)

Passages that feature the same lemma in the same sedes*πατρίδα*sedesz-codicegeneric modelsedes-esemplareindividual model*σελήνη*moonsedesxxz ** Iliad ** Fall of Troy **
...
SEDES to create a CSV file of the]sedesworks of Athena*ἔργα δ᾽ Ἀθηναίη*** Iliad ** Od **
