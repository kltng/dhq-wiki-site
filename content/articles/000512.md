...
*paratext **marginalia **mark-up*audenaert2010
...
official functions in libraries (for access) and archives (for context)[^: One exception is the
...
since the order of words and even of verses is often scrambled beyond recognition.
...
cultural artifacts. The IIIF consortium adopts the principles of [Linked Data](http://linkeddata.org/)[Architecture of the Web](http://www.w3.org/TR/webarch/)[Shared Canvas data model](https://iiif.io/model/shared-canvas/1.0)[JSON-LD](http://www.w3.org/TR/json-ld/)
