...
a voice and allowed to speak, in their essential character people their voice,
...
often understood as that which is given, or as already existing  corpus corpus
...
which machines combine with humans to perform tasks
...
join a research project run by a DH scholar in their university  it outreal
...
heuristic for production) to digital texts and performances provides the invisible scaffolding for
...
rhetorical challenges of living in a digital age-on, experiential, and project-based learning through doing based literacytech skills stakes evaluation of digital media and
...
gate-keeping methodologies and should be treated as such**People, Ideas, and Things**
...
Mrs. Jake Bowen, and does not include the woman's first name.**Imagining: Creating Spaces for Indigenous Ontologies****People, Ideas, and Things**this procedure [of data construction] involved much rhetorical
...
the photographs and build the initial metadata [^: For examples, see
