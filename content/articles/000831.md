---
title: "The Eras Tour: Machine Learning for Dating
                    Historical Texts from Greco-Roman Egypt"
id: 000831
authors: ["Danushka Bandara", "Fatima Chowdhury", "Jack Stow", "Adrian Gallant", "Habibul Huq", "Giovanni Ruffini"]
volume: 019
issue: 4
date: 2025-12-12
type: article
keywords: ["corpora", "cs", "data analytics"]
author_keywords: ["Greek"]
language: en
word_count: 7381
source: raw/articles/000831.xml
---
...
**Volume 019, Issue 4** (2025-12-12) | article | 7,381 words

**Keywords:** [[corpus-methods-dhq]], cs, [[data-analytics-dhq]]
...
Accurate dating of historical texts and manuscripts remains a critical challenge
                    ...
                    alternatives #omayio_2022#jull_1995#castro_2004#omayio_2022#omayio_2022#van-schaik_2013
...
The dataset for this study consists of a one-hot encoded matrix of person and
                    ...
                    earliest (*y*1) and latest (*y*2)
                    possible writing dates. Since many records contain exact years (*y*1 = *y*2), a regression model to
                    predict a specific year of authorship was best fit. However, for texts with
                    uncertain dates (*y*1 ̸= *y*2),
...
Recent advancements in computational techniques have significantly enhanced the
                    dating of historical texts and manuscripts. #moscato_2022#pavlopoulos_2024#hellwig_2019#yu_2019


Handwritten document recognition has also progressed, with #ullah_2022#wahlberg_2016#he_2014#hamid_2018#koopmans_2024


#kumar_2011#ren_2023#dhali_2020
...
The website Trismegistos, accessible at [https://www.trismegistos.org](https://www.trismegistos.org)#depauw_2018#broux_2015#depauw_2009
...
The dataset obtained from Trismegistos comprises a comprehensive collection
                        ...
                        represented by binary values, with 10
...
In addition to the features, the dataset contains corresponding labels that
                        ...
                        variable serves as the approximate start date (*y*1),
                        while another serves as the approximate end date (*y*2). When *y*1 equals *y*2,
...
The labels (year of writing) included 29,250 rows, containing the dependent
                        variables (*y*1 and *y*2) that the
...
The mean values for the earliest *y*1 and latest *y*2 recorded dates were approximately -119 and 146,
                        respectively (see Figure 1 for the distribution of earliest and latest
                        dates).


![Distribution of Earliest Dates (y1) &
                            Distribution of Latest Dates (y2)](resources/images/figure01.png)
...
![Figure 2: Top 10 Most Frequently Occurring Features Related to (i) Person
                            & (ii) Place](resources/images/figure02.png)


To determine the most appropriate modeling approach, the distribution of
                        exact (*y*1 = *y*2) and non-exact
                            (*y*1 ̸= *y*2) year matches in
                        both raw and filtered datasets were assessed. In the raw dataset, it was
                        found 16,698 rows where *y*1 = *y*2 and 12,550 rows where *y*1 ̸= *y*2. After filtering, the dataset contained 5,239 rows
                        where *y*1 = *y*2 and 3,326 rows
                        where *y*1 ̸= *y*2. This higher
...
Since regression was chosen, a target column that handles both cases: when
                            *y*1 equals *y*2 (a single
                        year) and when *y*1 does not equal *y*2 (a range of years) was created. The target variable, y target,
                        was set to *y*1 in cases where the two values were
                        equal. When they differed, the y target was assigned the midpoint of *y*1 and *y*2, as the midpoint
                        provides a reasonable estimate for a range when an exact year is
                        unavailable. This new target column replaced *y*1 and
                            *y*2 as the ground truth label. All other ground
...
![Top 10 most important features for the Random Forest Model](resources/images/figure03.png)


![Top 10 most important features for the XGBoost model](resources/images/figure04.png)
...
![Explained Variance Ratio By Singular Value Decomposition
                                Components](resources/images/figure05.png)
...
![Actual vs. Predicted Years - Neural Network](resources/images/figure06.png)


![Actual vs. Predicted Years - 10-Fold Ensemble](resources/images/figure07.png)
...
![Figure 8: Training and validation loss over epochs (log scale) and Training
                            and validation mean absolute error over epochs (log scale)](resources/images/figure08.png)
...
Assael, Y., Sommerschield, T.,
                    Cooley, A., Shillingford, B., Pavlopoulos, J., Suresh, P., Herms, B., Grayston,
                    J., et al. (2025) **Contextualizing ancient texts with
                        generative neural networks****Nature**[https://doi.org/10.1038/s41586-025-09292-5](https://doi.org/10.1038/s41586-025-09292-5)
Broux, Y., and Depauw, M.
                    (2015) **Developing onomastic gazetteers and prosopographies
                        for the ancient world through named entity recognition and graph
                        visualization: Some examples from trismegistos people****Social Informatics. SocInfo 2014.
                        Lecture Notes in Computer Science**
Castro, K., Vandenabeele, P.,
                    Rodríguez-Laso, M., Moens, L., De Schryver, S., and Van Hooydonk, G. (2004)
                        **Micro-raman analysis of coloured lithographs****Analytical and Bioanalytical Chemistry**
Depauw, M. (2018) **Trismegistos. optimizing interoperability for texts from the
                        ancient world****Crossing Experiences in Digital Epigraphy. From Practice to
                        Discipline**
Depauw, M., and Van
                    Beek, B. (2009) **People in Greek documentary papyri. First
                        results of a research project****The Journal of
                        Juristic Papyrology**
Dhali, M.A., Jansen, C.N., de
                    Wit, J.W., and Schomaker, L. (2020) **Feature-extraction
                        methods for historical manuscript dating based on writing style
                        development****Pattern Recognition
                        Letters**[https://www.sciencedirect.com/science/article/pii/S0167865520300386](https://www.sciencedirect.com/science/article/pii/S0167865520300386)
Hamid, A., Bibi, M., Siddiqi,
                    I., and Moetesum, M. (2018) **Historical manuscript dating
                        using textural measures****2018 International
                        Conference on Frontiers of Information Technology (FIT)**
He, S., Sammara, P., Burgers, J., and
                    Schomaker, L. (2014) **Towards style-based dating of
                        historical documents****2014 14th
                        International Conference on Frontiers in Handwriting Recognition**
Hellwig, O. (2019) **Dating Sanskrit texts using linguistic features and neural
                        networks****Indogermanische Forschungen**
Jull, A.J.T., Donahue, D.J.,
                    Broshi, M., and Tov, E. (1995) **Radiocarbon dating of
                        scrolls and linen fragments from the Judean desert****Radiocarbon**
Koopmans, L., Dhali, M.A.,
                    and Schomaker, L. (2024) **Performance analysis of
                        handwritten text augmentation on style-based dating of historical
                        documents****SN COMPUT. SCI.**[https://doi.org/10.1007/s42979-024-02688-6](https://doi.org/10.1007/s42979-024-02688-6)
Kumar, A., Lease, M., and
                    Baldridge, J. (2011) **Supervised language modeling for
                        temporal resolution of texts****Proceedings of
                        the 20th ACM International Conference on Information and Knowledge
                        Management**[https://doi.org/10.1145/2063576.2063892](https://doi.org/10.1145/2063576.2063892)
Moscato, V., Craig, H.,
                    Haque,M.N., Huang, K., Sloan, J., and Corrales de Oliveira, J. (2022) **Multiple regression techniques for modelling dates of first
                        performances of Shakespeare-era plays****Expert
                        Systems With Applications**[https://doi.org/10.1016/j.eswa.2022.116903](https://doi.org/10.1016/j.eswa.2022.116903)
Omayio, E.O., Indu, S., and
                    Panda, J. (2022) **Historical manuscript dating: Traditional
                        and current trends****Multimedia Tools and
                        Applications**[https://doi.org/10.1007/s11042-022-12927-8](https://doi.org/10.1007/s11042-022-12927-8)
Pavlopoulos, J.,
                    Konstantinidou, M., Marthot-Santaniello, I., Essler, H., and Paparigopoulou, A.
                    (2024) **Dating Greek papyri with text regression****Proceedings of the 61st Annual Meeting of the
                        Association for Computational Linguistics**[https://doi.org/10.18653/v1/2023.acl-long.556](https://doi.org/10.18653/v1/2023.acl-long.556)
Ren, H., Wang, H., Zhao, Y., and
                    Ren, Y. (2023) **Time-aware language modeling for historical
                        text dating****Findings of the Association for Computational Linguistics:
                        EMNLP 2023**[https://aclanthology.org/2023.findings-emnlp.911/](https://aclanthology.org/2023.findings-emnlp.911/)
Ullah, Z., and Jamjoom, M.
                    (2022) **An intelligent approach for Arabic handwritten
                        letter recognition using convolutional neural network****PeerJ Computer Science**[https://doi.org/10.7717/peerj-cs.995](https://doi.org/10.7717/peerj-cs.995)
Van
                    Schaik, S. (2013) **Dating early Tibetan manuscripts: A
                        paleographical method****Scribes, Texts and
                        Rituals in Early Tibet and Dunhuang**
Wahlberg, F., Wilkinson,
                    T., and Brun, A. (2016) **Historical manuscript production
                        date estimation using deep convolutional neural networks****2016 15th International Conference on Frontiers in Handwriting
                        Recognition (ICFHR)**[https://doi.org/10.1109/ICFHR.2016.0048](https://doi.org/10.1109/ICFHR.2016.0048)
Yu, X., and Huangfu, W. (2019)
                        **A machine learning model for the dating of ancient
                        Chinese texts****2019 International Conference
                        on Asian Language Processing (IALP)**[https://doi.org/10.1109/IALP48816.2019.9037653](https://doi.org/10.1109/IALP48816.2019.9037653)
