...
purposes. Many techniques and resources, e.g. Sentiwordnet-termism
...
passionsComédie Larmoyantesmallersentiments
...
Agreement is calculated following the metric *agr*wiebe2005
...
emotions (and other psychological properties) in text[^: LIWC has been updated and expanded in 2015 (LIWC2015, see ). However, since the ]
...
practices, and some specific emotions, e.g. anger, anxiety, sadness[^: The LIWC output consists of: 1. General
...
evaluation of the performance of the software Dutch LIWC
