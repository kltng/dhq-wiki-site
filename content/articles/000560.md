...
such as Heinrich Wölfflin’s (1864-1945) ** Formalism **iconographical-iconological method ** Mnemosyne Atlas.** ** Atlas.** ** Atlas **
...
** Rijksmuseum ** Night Watch ** Operation Night Watch.** ** The Next Rembrandt.** ** Virtuelle Mauer/ReConstructing the Wall.** ** Arts and Culture
...
** Against Digital Art History **beauty ** Is There a Digital Art History?**
...
images has been a prevalent computer vision task shift[Takami et al.
(2014)]()
...
2014]() different geometrical layouts or change the
...
hundreds of thousands, millions, or billions? setting the edge pixels
as background and the non-edge pixels as foreground
...
shifting the focus from images to image processing techniques. In ** Is There a Digital Art History?**digitizeddigitalDigitizedtext mark up,
...
the Renaissance and Baroque period ** Mnemosyne Atlas **t-SNE Map.** **t-SNE Map **
...
networks from which it gains meaning and value
...
meaning of the respective data collection
some of the important semantic information about the real world Sets S1, S2, ..., Sn..., R is a relation
on these n sets if it is a set of n-tuples each of which has its first element
from S1, its second element from S2, and so on;secretarysecretary
...
data without considering their specific needs ** Mnemosyne Atlas.** ** Atlas **...intended to shed
...
reactions to the meaning of this type pf digitization of the humanities would I entrust my life’s work
to a computer just so I could be made irrelevant upon multiple forms of visual
...
computational processing have been slow to emerge
...
supplement to his (the user’s) memory life **t-SNE Map **
...
shaped informational aesthetics [...] and data-driven narratives
...
Bilderfahrzeuge ** Mnemosyne Atlas.** ** Atlas.** ** Atlas ** Atlas **images of
great, symbolic, intellectual, and emotional power ** Atlas ** have now
...
reading ** Mnemosyne Atlas **social memory, the origin of artistic expression and the psychological drama
...
environment... is this?What is this
like?*Secretary (entity) works for engineer (entity)* indicates
...
adding descriptive attributes to entities such as name, color, or height
...
Warburg’s ** Mnemosyne Atlas **memex
...
specific artist, this process is referred to as style transfer
...
purpose, use, and substance of objects
...
based search in digital datasets...we will not be able to give names to all of the variations
...
compelling and drastic editing of images construct images, first generating
...
the style of Cézanne and generated by*What is style? Which
...
identity, purpose, use, and substance of objects synthesize different
...
freely altered or even imputed from other images[Esser et al. (2018a)]()
...
studied which regions are seen by the network when producing an image caption
...
images without any human supervision using neural networks input
image to a much smaller dimensional representation which can store...
information about the input data distribution[Doersch (2016)]()[Goodfellow et al.
(2014)]()
...
for solving a given task (i.e., object recognition)
...
Imagenet, ** Large Scale Visual Recognition Challenge 2016 **[http://image-net.org/challenges/LSVRC/2016/index](http://image-net.org/challenges/LSVRC/2016/index)
...
Computing Surveys ** The Next Rembrandt **[https://www.nextrembrandt.com/](https://www.nextrembrandt.com/)
