---
title: "Analyser les emboîtements d’échelles
...
date: 2018-04-06
type: article
keywords: ["geospatial", "globalDH", "ecocriticism"]
author_keywords: []
language: en
word_count: 7657
source: raw/articles/000367.xml
---

# Analyser les emboîtements d’échelles
               spatio-temporelles d’un territoire forestier : du système d’information géographique
               à la méthode

**Authors:** Marie Delcourte-Debarre

**Volume 012, Issue 1** (2018-04-06) | article | 7,657 words
...
La Géographie n’est que l’Histoire dans l’espace, comme
                           l’Histoire n’est que la Géographie dans le temps #reclus1905 temporalisant  traditionnellement
...
Un premier état des forêts anciennes a été réalisé sur le secteur de
                        ...
                        en contrat Cifre par le conseil régional #debarre2016


![Un territoire d’étude, l’Avesnois](resources/images/carte%201.jpeg)
...
Les chercheurs en sciences naturelles, en sciences humaines et sociales #gregory2007#dumenieu2015#buridant2013#dardignac2011
...
En France, quelques études sur les forêts anciennes ont été pionnières :
                        celles menées par Jean-Luc Dupouey et Daniel Vallauri sur la carte de
                           Cassini #vallauri2012#georges-leroy2009
...
![Répartition temporelle des sources écrites et nombre de lieux par
                           siècle](resources/images/graphique%201.jpg)
...
Quatre cartographies ont donc été sélectionnées et ont subi des traitements
                           informatiques[^: Logiciels de SIG QGis (OpenSource) et ArcMap.]
...
- La carte de Cassini (1749-1790) est levée au 1:86 400e et présente une sémiologie normalisée pour
                           ...
                           forestiers. En effet, ces derniers forment des bouquets#vallauri2012
...
Pour chacune de ces quatre cartes, deux couches SIG ont été créées : l’une
                        pour les polygones forêtstoponymesforêt
...
Si tel est le cas, ces entités décalées**La Puissance**


![Les  entités décalées  : le cas schématique de  La Puissance](resources/images/figure%201.jpg)


Le massif **La Puissance****Bois
                              Georges**entités décalées
...
![La dynamique des lieux : le cas des bois de Beaurieux et du
                              Parc](resources/images/figure%202.jpg)
...
Cette dernière est en effet très aléatoire d’une source à l’autre comme
                           le montre le cas des bois de Beaurieux et du Parc : 
                              sur la carte de Claude Masse (1730), apparaissent les bois de
                                 Beaurieux et du Parc ;sur Cassini (1749-1786), seul le bois du Parc est visible ; sur État-major (1834-1866), le toponyme bois de Beaurieux est
                                 précisé : sur Occupation du sol[^: Les noms de forêts ou toponymes
                                    proviennent ]globalelimites internes
...
Cette méthode permet de mettre en place un système d’information générique
                        ...
                        fois les dimensions temporelle et spatiale de cette information #butez2013[^: Laboratoire de Recherche Historique Rhône Alpes UMR
                           5]
...
Une plateforme a été mise en place au sein de laquelle on peut stocker, de
                        ...
                        historiques. Cette documentation est accessible sur le site principal du projet[^: http://symogih.org/.]
...
La dimension géographique a été intégrée dès les débuts du projet SyMoGIH
                        ...
                        comme pour la représentation de l’information historique #butez2013
...
Dans le modèle SyMoGIH, tous les événements ou informations descriptives qui
                        ...
                        soit de type contenuinformation


![Les classes d’objets de la méthode SyMoGIH](resources/images/Tableau%201.jpg)


SyMoGIH comprend des objets historiques regroupant une collection ou une
                        classe d’individus (exemple : collection **Acteurs
                           collectifs**abbaye de Liessiesabbaye de Maroillesabbaye du Val de Mons
                            essence #beretta2012#beretta2012
...
![Modèle conceptuel de données pour la gestion des données
                           géo-historiques](resources/images/Figure%203.jpg)
...
Le named place (NaPl)lieulieucontenusinformations
...
Pour traiter les évolutions spatio-temporelles du lieu au cours de son
                        histoire, la méthode SyMoGIH introduit une deuxième entité, la forme
                           concrète du lieu*concrete time
                           specific form.*
...
Quant aux géométries, elles n’interviennent qu’en dernier lieu en tant que
                        ...
                        géométrie est ainsi documentée #butez2013


![Les métadonnées de la carte ancienne dans la base d’hébergement de
                           projets (BHP)](resources/images/figure%204.jpg)
...
- Surface d’infrastructure :  Surface terrestre
                                 ...
                                 l’activité économique d’une région, d’un pays
...
Tous ces NaPl ont donc fait l’objet d’une localisation relative en
                           ...
                           1492, **le bosquet de la Follye se trouvant sur le
                              prevoste de Bavay Archives Départementales du Nord B 9491
                                 f°1r°.**


![Modèle conceptuel de données : la localisation relative des
                              lieux](resources/images/Figure%205.jpg)


Ce Type d’Information 140 contient un ensemble de rôles : typerêtre la directionlocalisé[^: http://www.symogih.org/.]
...
Exemple : le parc du Quesnoy (lieu localisé) est inclus (inclusion
                           ...
                           obligatoirement de coordonnées géographiques, d’une *spatial localization*
...
![Modèle logique de la base de données](resources/images/figure%206.jpg)
...
La table activiteactivitéstype_activiteactivitegroupe
                              Identifiant 1 → exploitation (bois d’œuvre, de marine,
                                 d’industrie etc.)Identifiant 2 → usage (pâturage des équidés, des bovins, des
                                 porcins etc.)Identifiant 3 → entretien (traitements sylvicoles, âge des
                                 peuplements, révolution etc.)Identifiant 4 → proto-industrie (bois pour les forges,
                                 verreries, fourneaux etc.Identifiant 5 → délit-conflit (délits forestiers et conflits
                                 d’usage)


La table unite_de_connaissanceannee_debutannee_finimbrication_agentenvironnementevenement
...
Ainsi, par géométrie
                              soit il s’agit de polygones vectorisés sur les sources
                                 ...
                                 de ses sources,soit le polygone est produit sous une forme ovoïde à partir
                                 d’une superficie ancienne (en arpent, en mencaudée, en bonnier
                                 etc.) donnée dans les sources écrites et convertie en hectare, lorsqu’aucune géométrie n’est disponible ou ne peut être
...
Dans les deux premiers cas, les géométries peuvent être identifiées par
                           ...
                           système d’information historique via des contenusinformationsTnamed-place
...
![Modèle conceptuel de données : l’existence d’un objet
                              (TyIn141)](resources/images/figure%207.jpg)
...
Il s’agit d’une information qui met en relation un objet, un NaPl par
                           ...
                           son existence : exemple le début de l’existence d’un lieuforme concrètelieuforme concrètecaractériserconcerner
...
L’exemple des bois de Beaurieux et du Parc évoqué précédemment est assez
                           ...
                           identique jusqu’en 1866 mais ce sont les limites internescitationsbois de Beaurieux
...
Les résultats de ce travail sont issus d’un long travail d’amélioration
                     ...
                     restructuration des données (de la création des lieuxformes
                        concrètes
...
Butez, Charlotte. **Un
                  SIG collaboratif pour la recherche historique, conception d’un atlas historique
                  numérique et d’une plateforme de travail collaborative à partir de la méthode
                  SyMoGIH****Géomatique Expert**
Beretta, Francesco, Vernus,
               Pierre. **Le projet SyMoGIH et la modélisation de l’information :
                  une opération scientifique au service de l’histoire****Les Carnets du LARHRA**
Buridant, Jérôme *et al.***Fractionnement des paysages forestiers et diversité
                  floristique: le poids de l’histoire. L’exemple des fragments forestiers du bocage
                  de la Thiérache (Nord-Est de la Picardie)****Forêts
                  et Foresterie, Mutations et Décloisonnements**
Dardignac, Cécile, Le
               Jeune, Yann. **Évolution des masses forestières en île de France,
                  réflexions méthodologiques et exemples d’application****Environnement, Forêt et Société, XVI-XXe siècle****Cahier d’Études**
Debarre Marie. **Espaces forestiers et sociétés en Avesnois (XIVe–début du XVIIIe siècle). Étude du
                  paysage**
Dumenieu Bertrand. **Un système d’information géographique pour le suivi d’objets
                  historiques urbains à travers l’espace et le temps**
Georges-Leroy Murielle
                  *et al.***Le massif forestier, objet pertinent pour la recherche
                  archéologique. L’exemple du massif forestier de Haye
               (Meurthe-et-Moselle)****Revue Géographique de
                  l’Est**
Gregory Ian N. **Historical GIS: Structuring, Mapping and Analysing Geographies of the Past****Progress in Human Geography**
Reclus, Élisée. **L’homme et la Terre**
 Vallauri, Daniel,
               Granier, Évelyne., Dupouey, Jean-Luc. **Les forêts de Cassini,
