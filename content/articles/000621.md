...
entails[2016, intro.]()[^: Many of these cited works are from online articles or
books which]mere use of digital tools for the purpose of humanistic researchstudy
of digital artifacts, new media, or contemporary culture humanities
digital humanities fielda set of vectors of inquiry that are defined by
their tensions, alignments, and oppositionsthat
matters,socially oriented worksubtleties
of our research to others within the expanded field of inquiry

This project is rooted in the principles of critical design;reflexive critical design critical design,

In short, my digital project ** Loss **
data

### Reflexive and Experimental Critical Design: A Sociologically-Informed Approach

David Berry and Anders Fagerjord argue for a critical reflexivity[2019]()
...
world. My work here is thus critical design, ways[^: See for example:]
...
I’ve outlined above: In the aforementioned facial recognition project by work do
...
within ‘emotions’ can be applied to photographs of people’s faces the outlines of a worldviewclassifie[d] people
...
negotiates between historical modes of criticism and emergent forms of critical making[2017]()
...
themselves, through a close-reading of the software’s code and processes[2019]()emotions*others’*cct2020
...
al.’s [[2016]() matters,not just *for **are *schrier2016

Many of those who advocate for games for social change place a great deal of emphasis on
those procedural arguments — fixating on how *processes **mechanics*schrier2016
...
digital humanities, homing in on a DH that matters*in
its use*jagoda2020
...
a time that has been labelled the post-truth era **the Misinformation Age,**
...
in order to erase [thing] from [your life or society]?nodes ** Loss***through *
...
different entities[^: see for example:]nodesfriends ** Anatomy of
an AI System **
...
phenomena by presupposing the existence of permanent structures subjacent to change…on the understanding of the structures that mutually dependent human beings
...
referring to webs,linkages,dependencies,networks,assemblages,precarious*matsutake
...
the gap between reality as it is and reality as it ought to be ** Loss***as it is **might or ought to
...
Finally, the reflexive, critical interrogation of the design of ** Loss ** Loss ** Loss.** Loss.** ** Loss **
...
different in that the data — ** Loss **data,
