...
In 2004, John Gruber, a user interface designer and blogger, released a new markup
            ...
            to look at a Markdown-formatted document#gruber2004
...
Markdown's simplicity arises from its composition and plain text file format. The
            ...
            Markdown-formatted document should be publishable as-is, *as plain
               ...
               permit the text to be rendered legibly, and nothing more#allen2012any text representation
            consisting of plain text plus added information such as a language identifier, font
            size, color, hypertext links, and so on#allen2012editorial method of text transcription that is both 'faithful to the text of its
               source' and is 'easier to read than the original documents'#tenen2017system-centric ideals,#tenen2017


Plain text exposes the structure of digital encoding and resists what N. Katherine
            Hayles calls the flickering signifier.flickering signifiers#hayles1999flicker#gitelman2002textual lamination#tenen2017
...
Markup languages, like Markdown, also allow writers to structure plain-text documents
            ...
            markup languages function by interspersing plain text data with sequences of characters
               that represent the additional data structure#allen2012real
            content.
...
The separation of form and content comes with challenges. Chief amongst these is the
            ...
            variations quickly emerged #teamvivaldi2018flavorsI believe Markdown's success is *due
               to*#gruber2014
...
During the flurry of activity to expand Markdown, John MacFarlane, Professor of
            ...
            Markdown flavors and outputs them to different formats #macfarlene2020
...
Pandoc permitted Markdown to serve as a viable option for various genres of writing, but
            ...
            computing is the application of minimalist principles to computing#gil2015amoral modulor,#oroza2020The moral modulor is
            ...
            for his children or his family,His condition allows him to discriminate
               against the superfluous or the useless#oroza2016architecture of necessityminimizesWhat do
               we need?#gil2015a


Minimal computing includes a myriad of definitions and practices. According to Jentery
            Sayers, the minimalI did not
               account for all the minimals or their particulars here#sayers2016minimal computing is in the eye of the beholder#gil2015a
...
Due to the often-ambiguous definitions of minimal computing, we must turn to
            ...
            their self-referential nature #bateson2008This is minimal computing.
...
As we look for a genealogyminimal knowledge with the production of
               a minimal artifact, without creating necessary friction for the readers#gil2015auser-friendlyhaptic fallacythe belief that electronic objects are
            immaterial simply because we cannot reach out and touch them#kirschenbaum2003minimal design#sayers2016
...
Markdown as a digital humanities practice is noticeable for not just its technical
            ...
            these roles, markup is often taken for granted as merely the code behind the text#dilger2010
...
Readers may wonder why I focus on TeX and not other markup languages, such as HTML or
            TEI. Markup languages emerged in the 1960s when users used markups or flagsstandard code in which any text
               received from an outside source can be assumed to be#kay1967#goldfarb1999
...
In this paper, TeX's development and community provide a case study and catalyst for the
            ...
            myriad of texts that bemoaned word processors #warner2002
...
To understand Markdown-based scholarship in the digital humanities and growing advocacy
            ...
            Bruno Latour's criticism of modernity concludes — We have never been digital#haigh2006
...
Given markup's popularity amongst programmers and technical writers, it may be tempting
            ...
            faculty as an Assistant Professor of Mathematics in 1963 #walden2019


Knuth began writing his magnum opus, **The Art of Computer
               Programming****The Art of Programming**#knuth2007
...
Knuth's work on typography formed the basis for TeX, and he dedicated his 1977–1978
            ...
            across platforms and geared towards academic work #tex2021
...
Despite TeX’s advantages, it had a steep learning curve. Seeking to assist newcomers,
            ...
            his doctoral dissertation that popularized logical design,#reid1981Scribe liberated from inflexible formatting
            controlTeX for the masses#mittelbach2004**LaTeX: A Document Preparation System**In turning TeX into LaTeX, I have tried to convert a
            ...
            comfortable and gets you to the grocery store with no fuss#lamport1986
...
Word processing had emerged during the 1970s as an organizational paradigm for
            centralizing corporate information #haigh2006
...
It … seemed no more sensible to use a computer to edit than to travel to the shopping
            ...
            specialized fields, and eventually into an inexpensive office commonplace. #haigh2006
...
If TeX remained a novel typographical system, its impact on the academic community would
            ...
            green-screeners or otherwise#kirschenbaum2016
...
By the late 1990s and early 2000s, TeX’s users formed a counterpublic united through
            ...
            queer identity and challenge Jürgen Habermas' bourgeois#warner2002#habermas2015subaltern counterpublics#fraser1990
...
Michael Warner draws on Fraser’s conception to make evident how texts' circulations are
            ...
            being only in relation to texts and their circulation. It exists *by
               virtue of being addressed*#warner2002poetic#warner2002
...
As corporations embraced word processing during the 1990s, desktop publishing
            ...
            Tickell, neoliberalism has two distinct phases of state mobilization: a roll-backroll-out.roll-out,#peck2002


Neoliberal market ideology, as Fred Turner shows, intersected with advocacy for
            deregulation by cybercultural entrepreneurs #turner2006
...
TeX resulted in a worldwide community of users, developers, and user groups evolved,
            ...
            later, and is an important branch in the development of desktop publishing. #beeton2018
...
The concentrated community backlash to business practices was in part due to Knuth’s
            ...
            of Stanford#beeton2018MetaFont for Lunch Brunch#beeton2018**TUGBoat**
...
As mentioned earlier, concerns about word processing's growing influence in the academic
            ...
            what you getencourages better writing#lamport1986LaTeX was designed to free
            you from formatting concerns, allowing you to concentrate on writing. If, while writing,
            you spend a lot of time worrying about form, you are probably misusing LaTeX#lamport1986WYSIWYG programs [that] replace LaTeX's logical design with visual
               design#lamport1986
...
Later guides for LaTeX — which became the de facto flavor of TeX — would reassert claims
            ...
            formatting as a substitute for good writing#warbrick1988**An Introduction to
            ...
            inefficient tool for preparing text for communication with others,#cottrell1999
...
The conflation of TeX with logical design focused on content creation rather than
            ...
            appearance of their documents but to concentrate on getting the right content #latexprojectThis has two results,authors wasting their time
               with designs; and a lot of badly designed documents!#latexproject
...
In short, by the late 1990s and early 2000s, a counterpublic emerged through blogs,
            ...
            can be postulated, can a text address a public#warner2002
...
Echoing Gil's later remark that minimal computing advocates should orient themselves
            around the question of what we need,should indeed be the simplest thing that could possibly work#vanzundert2012free
...
Third, TeX shows that plain-text scholarship is not significantly more future-proof or
            ...
            readable ten, fifteen, twenty years from now.may go the way of WordPerfect in the future#tenen2014plain sequence of characters
...
Finally, plain-text scholarship provides little security for vulnerable political
            ...
            developed at Columbia University's Group for Experimental Methods in the Humanities #gil2015b#angelopoulou2019#checkoway2010
