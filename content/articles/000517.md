...
The Digital Humanities constitute an intersectional community of praxis, in which the
          application of computing technologies in various subdisciplines in the
            *Geisteswissenschaften*#hockey2004#lecun2015#schmidhuber2015
...
In the Digital Humanities too, the potential of computer vision is nowadays increasingly
          ...
          flagship journal #wevers2020#arnold2019
...
The present paper must be understood against the wider scholarly background of music
            ...
            own right. #buckley1998#baldassarre2007#baldassarre2008


Music iconography deliberately adopts a "methodological plurality" #baldassarre2007*Répertoire International d'Iconographie Musicale*[https://ridim.org/](https://ridim.org/)#green2013
...
Music iconography has an important tradition of focused studies targeting the deep,
            ...
            analogy to similar developments in literary studies #wevers2020#arnold2019
...
The methodology for the present paper largely derives from machine learning and more
          ...
          interpretations from raw visual stimuli #ballard1982#lecun2015#russakovsky2015
...
One major hurdle is that computer vision nowadays strongly gravitates towards so-called
            ...
            respect is the influential ImageNet dataset #russakovsky2015#hertzmann2018#crowley2014#van2015#seguin2018#bell2019
...
It is a well-known limitation that convolutional neural networks require large amounts
            ...
            address this issue, the community has released several public datasets over the years
              #xiang2014#russakovsky2015#mensink2014#strezoski2017#lin2014#he2016#szegedy2015#simonyan2014
...
Computer vision researchers interested in the artistic domain have attempted to
            ...
            datasets #mensink2014#strezoski2017#sabatelli2018#sabatelli2018#mensink2014#strezoski2017
...
Previous studies have demonstrated the feasibility of "pretraining": with this
            ...
            (i.e. art history, in the present case). The popular Pascal-VOC dataset #everingham2010#lin2014[Figure
              1a](#figure01)
...
Popular object detectors such as YOLO #redmon2018#ren2017[Figure 1](#figure01)[Figure
              1b](#figure01)
...
All examples in [Figure 1](#figure01)#redmon2018#lin2014#mensink2014#strezoski2017
...
To increase the interoperability of the dataset, individual instruments have been
            ...
            musical instruments, aggregating data and metadata from multiple heritage institutions
              #dolan2017[^: https://web.archive.org/save/https://www.mimo-international.com/MIMO/][Table
              1](#table01)
...
Using the conventional method of rectangular bounding boxes, we have manually annotated
            ...
            within the open-source [Cytomine](https://cytomine.be)#marée2016[Figure 2](#figure02)
...
1. Representation[Figure
                3a](#figure03)[Figure
                3b](#figure03)[Figure 3b](#figure03)
2. Quality[Figure 3c](#figure03)
3. Boxes[Figure 3d](#figure03)
...
The label imbalance described in the previous paragraph is a significant issue for
            ...
            all images, but with the "hypernym" labels of the instrument categories (see [Figure 5](#figure05)
...
Each version of the dataset comes with its own training, development and testing
            ...
            images per split in each version is summarized in [Table 2](#table02)#pedregosa2011
...
Next, we tackled this task as a standard machine-learning classification problem for
            ...
            All of these networks were pretrained on the Rijksmuseum dataset #mensink2014#sabatelli2018#simonyan2014#szegedy2015#he2016#sabatelli2018#kingma2014


In [Table 2](#table01)[Table 3](#table03)
...
For the second benchmark experiment we report the results that we have obtained on the
            ...
            represented in the first image of each row of [Figure 7](#figure07)#redmon2018#lin2014#kingma2014[^: There is no officially published reference for RMSprop, but scholars
           ]


To assess the performance of the neural network, we follow the same evaluation protocol
            that characterizes object detection problems in CV #lin2014#everingham2010#gonthier2018[Table 5](#table05)[Figure 7](#figure07)[Figure 8](#figure08)
...
- RMFAB/RMAH
- IconArt*WikiArt: Visual Art Encyclopedia*[https://www.wikiart.org/](https://www.wikiart.org/)#gonthier2018[https://wsoda.telecom-paristech.fr/downloads/dataset/](https://wsoda.telecom-paristech.fr/downloads/dataset/)
...
Following these differences, we have applied the single-instrument detector to the
              RMFAB/RMAH[Table 6](#table06)[Figure 10](#figure10)
...
We first consider the classification results. The confusion matrix reported in [Table 4](#table04)*acc=73.66;
              F1=70.29**acc=27.02;
              F1=6.67*
...
When making our way down the frequency list in [Table 5](#table05)*AP(IoU ≥ 10)=0.55; AP(IoU ≥ 50)=0.46*
...
The results from the previous question call into question which visual properties the
            ...
            so-called "saliency maps" that can be extracted from a trained model #boyarski2017[Figure 9](#figure09)


The maps in [Figure 9](#figure09)[Figure
              9](#figure09)
...
One evident direction from future research is more advanced transfer learning, where
          ...
          for instance, by MIMO #dolan2017


One crucial final remark is that AI has an amply attested tendency not only to be
          sensitive to biases in the input data but also to amplify them #zou2018
