...
percussum*** Cyn.** A.**magno laudum percussus amore **struck by a great desire for glory ** A.***percutio*I strike*amor*desire[^: Because Latin is a
...
verbal paral]** Thebaid ** Tesserae ** Aeneid***et al.*** Tesserae ** Bellum
Civile ** Aeneid ** Tesserae ** Bellum Civile **
...
reuse provided by ** Tesserae.** ** Tesserae **
...
current stage of development, ** Tesserae***arma*warfare ** Aeneid*** Arma uirumque cano…*I sing of arms and the man…*Amores, Arma graui numero
...
Greek ** Aeneid ** Iliad ** Odyssey.** ** Tesserae **
...
5. The ** Tesserae.** ** Tesserae **

Within these acknowledged limitations, ** Tesserae ** Tesserae ** Tesserae ** Index
Thomisticus.** ** Tesserae **

Latin poetry scholars have traditionally divided the super-genre ** Thebaid ** Vergilian ** Punica **st century BCE
...
century BCE to the 6th century CE ([Table 1]()[^: The dates of texts mostly follow
...
phrases as the search unitlemma as the matching feature20 stop words, determined by frequency in the ** Tesserae **scores calculated by stema maximum distance of 10, calculated by frequencyno score cutoff[^: These parameters are explained at http://tess−dev.caset.buffalo.edu/html/help_ad]** Tesserae **
...
interpretively significant text reuse*C*7, *C*8, *C*9, *C*10, and
*C*11 (counts of score 7, 8, 9, 10,
and 11; [Table 8]()[9]()composite count*C ** C*11 hits. Because the
...
non-standardized forms ([Table 3]()[^: The r values are also sorted chronologically by
sour]*r* values graphically, partitioning
the pairs by source text ([Figure 07]()[Figure 12]()[Figures
13–15]()[Tables 5–7]()
...
4]()centrality*r* than a text more peripheral to the literary tradition of Latin
hexameter poetry.
...
The centrality scores conformed to expectations ([Table 4]()** Aeneid ** Ilias Latina ** Aeneid ** Georgics***r* values when paired with the other three works, thus
...
three genres: didactic, epic/panegyric, and satiric ([Figure 14]()[^: The didactic genre comprised: DRN, Georg, and
...
with 13 of 18 subsequent target texts (the exceptions are ** BC ** Ars ** Sat ** Sat ** HE **[Tables 4]()[6]()[Figure 11]()** Georgics***r*
...
> 0.000) when paired with every subsequent target text ([Tables 4]()[6]()[Figure 11]()** Ilias Latina***r* > 2.000) when
...
declining creativity over time ([Figure 15]()[Table 7]()** Georgics ** Aeneid ** Argonautica ** Thebaid ** Achilleid***r* ≥ 0.299), it was not as high as the intensity of
...
remaining intra-author pairs ([Figure 13]()[Table 5]()** Eclogues ** Aeneid***r* value (0.224). Finally, the *r* value for the pair ** Achilleid ** Punica **[^: The
...
Natura ** Paradise Lost.** ** DRN***sententiae*** DRN***r* < 0.000 when paired with 21 of 23 succeeding
target texts; [Figure 11]()*r* values resulted from pairings with other
...
Volk’s study of the ** Astronomica.** ** Georgics***r* = 0.342), followed by the ** Eclogues***r* = 0.307). Unexpectedly,
...
average (*r* < 0.000) for Lucretius’ ** De Rerum Natura ** Bellum Civile ** Argonautica ** Thebaid.** ** Cento Nuptialis ** Tesserae **
...
Statius’ poetry by the later poets ** Bellum Civile ** Gild***r* =
0.351) and ** Hon***r* =
0.278).
...
relationships between works in this super-genre[Table 3]()** Georgics ** Ilias Latina ** Metamorphoses ** Mosella.**

This is a first step in algorithmic criticism of the hexameter super-genre ** Tesserae **
on the surface, a model seems
static. In reality it is, like any form,*Tesserae* modeling is a
...
Poornima, R. Ossewaarde, C. Forstall, and S. Jacobson. ** Intertextuality In the Digital Age.** The
