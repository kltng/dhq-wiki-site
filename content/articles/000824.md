...
There are only two hard things in Computer Science: cache invalidation and naming things.
                  —commonly attributed to Phil Karlton #fowler_2009
...
Any examination of the rhetorical qualities of naming practices in code must
               ...
               metaphorically matters#lakoff_1980*how* we understand those ideas — the metaphors are neither
...
Not surprisingly, this sentiment about language’s metaphorical nature is shared by
               ...
               inducing cooperation in beings that by nature respond to symbols#burke_1969#burke_1966terministic
...
This idea of metaphor as rhetorically meaningful has persisted since classical
               ...
               rhetorical invention that are employed through examplesenthymemes#aristotle_1991
...
Further, this variety is rarely neutral: Names and naming practices can suggest
                  ...
                  crafty, speculative manner in which meaning and action are both created#chun_2011
...
According to Aristotle, there are three general contextual aims of classical
               rhetoric: forensicdeliberativeepideictic#aristotle_1991
...
The rhetorical decisions regarding names and naming in code are rarely unique and
               ...
               code text genres (for more on rhetorical genres in code, see #brock_2018procedural habitsthe specific forms of rhetoric that
               ...
               of videogame design, play, and writing about play#holmes_2017habitNon-mechanistic approaches to habit do not allow thought to unmoor itself in
               ...
               communication patterns amid an otherwise anonymous flux of Becoming. #holmes_2017ethicalhexisstate,
               disposition, bodily comportment, our habituated ‘second nature’ that guides ethical
               reasoning#aristotle_1991phronesis
...
Hans-Erik Nissen (2002) has suggested that most software developers are interested
               ...
               database schemas, and so on" #nissen_2002*ignore* the connotational features of language — especially for
...
Many programmers have made extensive use of the flexible possibilities of
               ...
               renamed "Richard" to keep that worker's identity protected #ritter_2010   public RichardIsAFuckingIdiotControl() {
...
MakeSureNobodyAccidentallyGetsBittenByRichardsStupidity() {
   ...
   base.OnLoad(e);
   }**Stack Overflow**#ritter_2010`RichardIsAFuckingIdiotControl`#mckinley_2009`IsThisTheRightPageImNotSureBecauseRichardIsDumb()`*should* work has been complicated — with apparently
...
Much of Green's advice relates to considerations of names in code as representatives
               ...
               polymorphic picture#green_2017big, polymorphic
               pictureUnder no circumstances, succumb to demands to write a glossary with
               the special purpose project vocabulary unambiguously defined#green_2017
...
Similarly, languages like Java provide developers with the opportunity to (or the
               ...
               stands the risk of being rewritten or refactored#green_2017bad
...
As a result, names as representatives of metaphor have the potential to derail those
               ...
               about the text; c.f. #fish_1982`String``Object``var``throw``throw
               up``<blockquote>``<cite>`#beck_2016
...
The procedural habits implicit in various naming practices in code are worthy of
               ...
               practices surrounding coding itself, e.g. the pejorative term code monkey#easter_2020#romano_2013#github_2022mastermain#cimpanu_2020
...
This article was originally developed for, but not published in, the short-lived
               open-source journal experiment **Push: Research & Applied Theory
                  in Writing with Source****Push**#brock_2012
