...
specific resources that I know of such as the IMB, WorldCat, etc.** Googling the Victorians,** If I type a person's name or event (especially obscure ones) into Google
...
panel discussed seven different specific digital tools at [nexthistory.org](http://nexthistory.org)tooltoolstool
...
Allocate more resources to user interface development.
