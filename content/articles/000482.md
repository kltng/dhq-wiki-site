...
have existed. Such methods are drawn from previous landscape models (ex.
...
multi–lingual and multi–ethnic individuals
...
Trinidad and Tobago appears in the logs of Columbus’ third voyage in 1498 are descended from the people
...
way to raid Arawak communities on the mainland
...
toolkits, such as the sporadic adoption and adaption of the sail
...
groups in this region participated in raiding of other settlements
...
macro–regional interaction networks
...
communities from the South American mainland into the islands[Hofman and Carlin]()
...
on regional connections from the Pacific (see

Previous work in the Caribbean region has largely focused on analyzing models of
large scale migration or colonization routes. Richard Callaghan
...
speed was set at 3 knots (see also
...
data from the periods discussed
...
and from the coast of Guyana and the Windward Islands
...
this region to gain access to pearl harvesting areas (see
