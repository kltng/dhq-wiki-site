...
Macintosh Quadra, or an IBM-compatible 486 running Windows ** The New Yorker ** Unicorn in Captivity ** New York Times Magazine **
...
over from a just-completed six-volume print facsimile project*why **why not*** Contributing Collections,**[http://www.blakearchive.org/​blake/​public/​institutions.html](http://www.blakearchive.org/blake/public/institutions.html)[^: Their full Blake
...
its speed are hard to sort out.  But the wait for me, I’m starting up[http://java.com/en/download/index.jsp](http://java.com/en/download/index.jsp)[Wikipedia, Java](http://en.wikipedia.org/wiki/Java_(programming_language))
...
represents the current state of play: [http://www.iconclass.nl/​libertas/​ic?style=index.xsl](http://www.iconclass.nl/libertas/ic?style=index.xsl)[http://www.iconclass.nl/​libertas/​aboutbb.html](http://www.iconclass.nl/libertas/aboutbb.html)[^: The rights for Iconclass software were acquired in
...
the organized information of the World Wide Web[http://www.artstor.org/index.shtml](http://www.artstor.org/index.shtml)[^: Not that ARTstor uses Iconclass, of course, or any systematic image-searching me]

And, of course, there is always automated searching.  Computers have inspired the thought that image searching could be automated in a way that would make it easy for users of, say, Corbis [http://pro.corbis.com](http://pro.corbis.com)[http://www.corbis.com/BettMann100/Archive/BettmannArchive.asp](http://www.corbis.com/bettmann100/archive/bettmannarchive.asp)[http://apimages.ap.org/](http://apimages.ap.org/)[http://www.numenta.com/](http://www.numenta.com/)learn[http://www.riya.com/](http://www.riya.com/)[http://www.blinkx.com/](http://www.blinkx.com/)[http://www.ask.com/](http://www.ask.com/)
...
van de Waal, Henri, R. H. Fuchs, E. Tholen, and L. D. Couprie, eds.  ** Iconclass: An Iconographic Classification System ** Java [programming language]**https://en.wikipedia.org/wiki/Java_(programming_language)
