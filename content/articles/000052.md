...
The biggest drag on our imaging system, however, may come from Java in general and Inote in
    ...
    its speed are hard to sort out.  But the wait for me, I’m starting up[http://java.com/en/download/index.jsp](http://java.com/en/download/index.jsp)#wikipedia_java#wikipedia_javaPerformance#wikipedia_criticismJava[Wikipedia, Java](http://en.wikipedia.org/wiki/Java_(programming_language))
