...
utility must certainly play a role[^: To paraphrase Andries Van Dam, in an
interview with the author]*seen*witnessingcombinatory
...
data scientists and engineers to solve serious
problems,
...
was called a linecontext[^: For more information please see my
...
had actually met before when they were both undergraduate]
...
at his own expense[^: For more information on
...
materials online. They did not wish to inflict line numbers on the user, or to make him program little changes in his data*Editing*
...
had multiple reactions, from cuteI don’t get it
...
machine for individual use't have
...
to accommodate multiple displays and users; it was the undoautosave[^: Nelson’s Xanadu system was also to have
infinite undo.]
...
was a straight rip-off*n* levels of the structure — a map whose level of
...
humanists weren’t paying for technologies money
