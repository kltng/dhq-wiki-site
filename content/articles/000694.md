...
The tradition of religious manuals of devotion for laypeople can be traced back to the mid-13th century (#dehamel1998#erler1999#duffy1992#duffy2011#kennedy2014[^: This was an off-shot of the Lateran Council of 1215, whose decrees demanded that]#butterworth1953#hargreaves1956#harris-matthews1980#kennedy2014#sutherland2015#sutherland2017#charzynska-wojcik2023[^: Some researchers use the term Primer in contrast to Book of Hours to differentia]#duffy1992[^: The seven Penitential Psalms are psalms 6, 31, 37, 50, 101, 129, and 142 in the ]#dehamel1998#morey2000#dehamel1998#erler1999#duffy1992#kennedy2014


The appearance of print in the second half of the 15th century, which made possible the mass-production of books, turned printed Books of Hours into the best-seller of the late medieval and early modern book trade. Books of Hours were among the first books to be efficiently mass-produced#duffy1992#butterworth1953[^: In fact, Joye’s first publication was the Primer, which was also the first Engli]
...
The technique which will be used for detecting textual dependencies between the twenty analysed texts of Psalm 6 is that of cluster analysis.[^: For a detailed discussion of different clustering methods, see  or . Comprehensi]#han2012[t]he fundamental intuition underlying cluster analysis is that data distributions contain clusters when the data objects can be partitioned into groups on the basis of their relative similarity such that the objects in any group are more similar to one another than they are to objects in other groups, given some definition of similarity#moisl2015


The literature typically divides clustering methods (algorithms) into two major categories, non-hierarchical (partitioning) and hierarchical, depending on the kind of output a given method generates #moisl2015[^: This is by no means the only possible categorization of clustering methods. Vari]given a set of nkk ≤ nk#han2012k


In contrast, hierarchical clustering methods perform a grouping of data objects into a hierarchy of clusters. Two major types of hierarchical clustering are distinguished in the literature, i.e. agglomerative hierarchical clustering and divisive hierarchical clustering #han2012dendrogram#kassambara2017#moisl2015


Cluster analysis has been successfully applied in different areas of linguistics as well as other fields ranging from document classification through data mining or speech processing to quantitative stylometry or author attribution #moisl2015#drout2011#vanderschans2020


The first limitation concerns the size of the analysed texts. The shortest text analysed here contains 154 words (texts 14, 16), the longest has 264 words (text 12), with an average word count of the twenty text analysed being 174,6 words.[^: See Majid et al.  for a recent discussion and survey of problems associated with]#majid2022revisionsdeep revisionspractically new translations#charzynska-wojcik2022


The second limitation of hierarchical cluster analysis is that it leaves to the user to decide how many clusters the data contain #moisl2015[^: See the discussion in Moisl , where various cluster-joining criteria (single lin]#moisl2015


Before applying hierarchical clustering algorithms to the texts of Psalm 6, it is also important to note certain complexities that are inherent to analysing any English text produced before spelling standardisation.[^: It is generally assumed that English spelling standardisation had not been compl][^: Gomaa and Fahmy  or Wang and Dong  offer an overview and comparison of different]#han2012#welbers2017#huang2008#welbers2017


One important consequence of representing texts as vectors in the context of documents produced before standardisation is the need for normalising spelling before any meaningful analysis can be performed. As mentioned above, the early Modern English texts analysed in this paper were produced before the standardisation of orthography. This means that, for example, the Modern English *anguish**anguisshe**anguyshe**anguysshe**avoid**auoid**auoide**auoyd**auoyde**avoide**avoyde*#baron2008#baron2009**quanteda**#benoit2018[^: Abbreviations present in the original edition have been silently expanded.]**Ortulus anime**
...
The grouping of the texts of Psalm 6 into dendrograms was performed using RStudio. The **quanteda**hclust( )**quanteda**hclust( )[^: The relationship between cosine similarity and cosine distance is captured by th]**factoextra**#kassambara2020
...
The inspection of the data represented in the hierarchical dendrogram above reveals the existence of clear groupings within the texts of Psalm 6 found in the manuals of prayer, their dependence on the existing English translations of the Psalms, as well as their mutual affinities. Quite clearly, there are three groups of texts visible, forming clusters in the dendrogram. The first cluster contains texts 01, 02, 04, and 05. The earliest among the texts in this group is Joye’s Psalter from 1530 (02), which appeared in January of 1530, a few months before **Ortulus anime**#butterworth1953**Ortulus anime**#juhasz2014#butterworth1953


The second group visible in the dendrogram consists of texts 13, 17, 10, 15, 06, and 11. Among these, there are two editions of the **Book of Common Prayer****Book of Common Prayer****Book of Common Prayer**#daniell2003#charzynska-wojcik2021[^: It is interesting to note that the wording of Coverdale’s Psalms from the 1539 B]#daniell2003#charzynska-wojcik2022#jacobs2013#norton2000#ferguson2011faithfully and truly translated out of Douche [i.e. German] and Latyn [i.e. the Vulgate]out of the common texte in Latyne


The third group of texts identifiable in the dendrogram contains nine texts within which three further subgroupings can be discerned. The first subgroup contains the texts from three primers: (07) Rouen primer from 1536, (08) Redman’s primer from 1537, and (09) **Manual of prayers****Manual of prayers**#butterworth1953cut loose#butterworth1953#butterworth1962#juhasz2014
