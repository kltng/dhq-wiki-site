...
fa]**LdoD
Archive: A Collaborative Digital Archive of the Book of Disquiet****LdoD Archive****Book of Disquiet****Book of Disquiet****LdoD Visual****LdoD Archive**

The modularity of **The Book of Disquiet**

In the **LdoD Visual****Book of Disquiet***focus-digress flow*

We have designed and implemented a web-based application to read the **LdoD****LdoD Archive**

To achieve this goal at the level of the reading interface, we integrate a set of
meta-information about the **Book of Disquiet**
...
The **LdoD Archive****Book of Disquiet******[^: The dates between brackets correspond to the editions used in the archive,
...
human-computer interaction to studies of literacy to cognitive science **The William Blake
...
Moulthrop and Dene Grigar ([2017]()
...
Besides the categories criterion, other criteria are supported by the **LdoD Archive**[2016]()
...
The **LdoD Archive**[^: Cosine similarity is a measure of similarity between two
non-zero vectors]
...
Heimerl et al. ([2014]()**LdoD Visual**
...
simulation principle,**Book of Disquiet**
