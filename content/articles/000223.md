...
Project](http://www.wwp.northeastern.edu/)
...
problem[Genderize.io](https://genderize.io/)[^: In general, names tend to shift from being
predominantly]
...
Toolkit](http://www.nltk.org/)[^: Chapter 6 of
...
major social networks.[^: Quotations are taken from the Genderize.io
website, ]
...
humanities research[^: These Python libraries include estimate.gender,
...
from [Data.gov](https://www.data.gov/)
...
The IPUMS-USA dataset, contributed by [Benjamin Schmidt](http://benschmidt.org/)[IPUMS](https://usa.ipums.org/usa/)`gender()`
...
profession with respect to gender ** American Historical Review **
...
barriers in women’s careers ** American Historical Review **
...
industries ** American Historical Review **
...
digital humanities[^: Discussing the problem
...
incorporated as a pedagogical tool within digital humanities courses[^: The download counts
reflect statistics as of November 30]
...
Geospattial Data, and Text ** Bancroft Prize.** Wikipedia **[http://en.wikipedia.org/wiki/Bancroft_Prize](http://en.wikipedia.org/wiki/Bancroft_Prize)
Bird, Steve,
