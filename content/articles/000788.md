...
Historical research prior to the 1970s and 1980s is often referred to as
                  pre-digitalpre-digital#burrows_2023#kesner_1982#aydelotte_1963#petterson_2016
...
In Padgett and Ansell’s study on the rise of the Medici family in 15th century
               ...
               manually extracting data from various published and unpublished sources #padgett_1993#wetherell_1994#brook_1981
...
With the growing interest in open access archives, many libraries in the Western
               ...
               (OCR) to digitise their collections #salmi_2021#kesner_1982#kesner_1982
...
When considering the profound impact that digital tools have on data-driven
               ...
               relationships, and construct their arguments on the other #haggerty_2011#verbruggen_2020#antunes_2021#ye_2022#wittek_2011#petz_2021#geraerts_2024#linkevicius_de_andrade_2022#elwert_2020#zbiral_2022
...
Having a paper document and creating a dataset with proper metadata are challenging
               ...
               institutions, parties and individuals #elo_2020#geraerts_2024
...
Computer-assisted historical research thus offers a wide range of possibilities for
               ...
               social network analysis #antunes_2021#petz_2021#ye_2022#geraerts_2024#linkevicius_de_andrade_2022#haggerty_2011#zbiral_2022#wittek_2011#fridlund_2013#ravenek_2017#verbruggen_2020#ravenek_2017#curran_2018#elwert_2020#jentsch_2021
...
The lack of standardised metadata for historical and archival sources makes the
               ...
               with a single statement: I am confident that the information
                  currently stored on my cards is largely accurate#aydelotte_1963


Such examples underscore a broader concern in the field: ensuring that research can
               be replicated or validated by others in order to maintain credibility #peng_2011#stodden_2014#peng_2021
...
Preprocessing is an iterative process that includes activities related to data
               ...
               also lemmatising/stemming and sometimes even removing stop words or tags #kunilovskaya_2021#garcia_2016#kunilovskaya_2021
...
These general preprocessing challenges become even more complex in the context of
               ...
               categorisation (e.g., administrative, religious or private) is crucial #matthew_2020#broadwell_2020
...
In light of these complexities, thorough documentation of the preprocessing phase
               ...
               data from both unprinted #antunes_2021#ye_2022#elo_2020#elwert_2020#petz_2021#geraerts_2024#zbiral_2022#ravenek_2017#wittek_2011#bloch_2022
...
An exemplary guide to solid preprocessing documentation designed to ensure
               ...
               Jiménez-Badillo et al. #jimenez-badillo_2020
...
The preprocessing pipeline (Figure 2) is employed to enhance the quality of the raw
               data #lee_2017#fan_2021#engel_2013#mishra_2020#mishra_2020#engel_2013


Extensive research has yielded a variety of preprocessing techniques #mishra_2020#fan_2021#mishra_2019#mishra_2020#cao_1999#baxter_1995#shanker_1996
...
Usually, cleaning is the first preprocessing step. It aims to transform raw data into
               ...
               analyses, modelling, and interpretation #rahm_2000
...
Next, one might require data reduction and scaling depending on the data
               ...
               data without losing important information #lelewer_1987#alshdaifat_2021
...
Lastly, data transformation procedures might be necessary to ensure the compatibility
               of the data with the methods used for modelling and analysis #fan_2021
...
Furthermore, it is good practice to perform exploratory data analysis (EDA) #tukey_1977
...
The notion of data preprocessing affecting the outcome of tools such as machine
                  learning models is widely known and accepted #alshdaifat_2021#zelaya_2019#zhu_2016#rinnan_2009#lee_2017#joo_2000#alshdaifat_2021#zhu_2016#rinnan_2009#joo_2000


Besides the benefits on the analysis performance, preprocessing contributes to a
                  lower risk of analysis errors and biased results #kamiran_2012#zelaya_2019#bazjanac_2007#monroe_2013
...
Several approaches to identifying the highest performance methods and their
                  ...
                  preprocessing #xu_2020#zelaya_2019#zhu_2016#engel_2013


Furthermore, distinct preprocessing methodologies may mitigate specific artefacts
                  while leaving some other effects behind #rinnan_2009#engel_2013#engel_2013
...
Thus, no preprocessing technique can be considered a gold standard that could be
                  ...
                  data nature #mishra_2020#engel_2013#mishra_2020
...
The lack of a golden preprocessing standard amplifies the relevance of a proper
               ...
               stage only. Throughout this section, the term documentation#gorgolewski_2016
...
From the reproducibility perspective, the meticulous documentation of every step in
               ...
               suitable for analysis #gibert_2016#haibe-kains_2020
...
Besides the parameters and configurations of the methods used, it is also essential
               ...
               preprocessing outcomes #chirigati_2016
...
In the literature, we can find examples of works addressing the standardisation of
               ...
               Interoperable, Reusable) data principles #jacobsen_2020#lamprecht_2020
...
There are also some domain-specific approaches, such as the data documentation
               ...
               economic, and health science data #rasmussen_2007
...
The DDI has facilitated the development of various tools and resources designed to
               ...
               range from metadata editors and converters to validation tools and repositories #blank_2004#ddi_2024a


Another example of a tool for documenting DDI metadata is the DDI Lifecycle #ddi_2024c
...
The DDI also complies with FAIR principles. The DDI Alliance and other organisations
               ...
               initiatives, such as the European Open Science Cloud (EOSC) #budroni_2019#klingner_2023
...
The data utilized was sourced from the digital repository of the **Instituto de Investigação Científica Tropical**[^: Arquivo Científico Tropical: https://actd.iict.pt/. Collection Fundos e Coleções]#bloch_2022
...
We divide our study into two main phases. First, we explore the impact of data
               ...
               models, we assessed latent Dirichlet allocation (LDA) #blei_2003#rosario_2000#yin_2014
...
Next, we employ regular expressions to remove special characters such as quotation
                  ...
                  leverage a Named Entity Recognition (NER) model #nadeau_2007#bloch_2022Maria
...
Several NER libraries and pre-trained models are available for our use, provided
                  ...
                  availability of resources, we chose to experiment with the spaCy library #srinivasa-desikan_2018#spacy_2024
...
Although this model can reach accuracy levels up to 89% because it was trained
                  ...
                  lower for documents from the 17th until the beginning of the 19th century #bloch_2022
...
Due to these entity identification issues related to the specificities of our
                  ...
                  training process is described in our previous work #bloch_2022
...
These are chunks of *n *consecutive items, such as words, in
                  ...
                  information retrieval. In this work, we leverage the Gensim library #srinivasa-desikan_2018#poulston_2015#nikolenko_2017#skorkovska_2012#poulston_2015
...
As mentioned, a few steps in our preprocessing pipeline are classified as data
                  ...
                  called the lemma #korenius_2004#sidorov_2014
...
In our experiments, we used the model coherence metric #meaney_2023
