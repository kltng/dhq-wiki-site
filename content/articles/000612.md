---
title: "Sentiment Analysis: Limits and Progress of the
               Syuzhet Package and Its Lexicons"
id: 000612
authors: ["Hoyeol Kim"]
volume: 016
issue: 2
date: 2022-06-25
type: article
keywords: ["nlp", "literary studies", "tools"]
author_keywords: ["Syuzhet", "Sentiment Analysis", "Lexicons", "Bing", "Afinn", "NRC"]
language: en
word_count: 9509
source: raw/articles/000612.xml
---

# Sentiment Analysis: Limits and Progress of the
               Syuzhet Package and Its Lexicons

**Authors:** Hoyeol Kim

**Volume 016, Issue 2** (2022-06-25) | article | 9,509 words

**Keywords:** nlp, [[literary-studies-dhq]], [[tools-infrastructure-dhq]]
...
Text mining is no longer an uncommon research method when it comes to analyzing texts
               ...
               influences our lives, our teaching, and our scholarship, and
                  digital humanists#binder2016a logocentric
                  practice.#clement2016the process of
                  extracting an author’s emotional intent from text.#kwartler2017stock markets, news articles, [and] political debates,#medhatetal2014[^: Laura Mandell expressed her qualms about sentiment analysis after reading
      ]embrace problemsas a
                  feature rather than a flaw#rhody2015use
                  algorithms in our research,find out how
                  they work.#underwood2014
...
Sentiment analysis is a subfield of natural language processing, which classifies the
               ...
               considered as eﬃcient methods due to their capability of
                  learning the text without manual feature engineering#habimanaetal2020[i]t is true that much digital humanities research
                  (especially dealing with text) uses the methods of text analysis that were in
                  fashion in computational linguistic twenty years ago.#kimandklinger2018welllike,#swafford2015[^: Check the update notes
                  for Syuzhet at https://github.com/mjock]


![The number of monthly downloads for sentiment analysis R packages (created on
                  August 17, 2021).](resources/images/figure01.png)


Figure 1 reveals that Syuzhet has been continuously downloaded as the most popular
               package for sentiment analysis in R.[^: VADER is also a popular sentiment analysis
                  tool in Python, but]#mohammad2012**Hamlet****As You Like It**six core emotional
                  arcs#reaganetal2016#haideretal2020#kimandklinger2018#welchandmihalcea2016#misuracaetal2020current benchmark studies
                  suggest that [sentiment detection] accuracyin the
                  70-80% range and that depends on genre#jockers2015#misuracaetal2020
...
Despite the low accuracy of Syuzhet, it is one of the most popular sentiment analysis
               ...
               understanding of digital tools is important since the
                  interpretive work is being guided and biased by the data and software#sinclairetal2013
...
Therefore, I decided to closely examine Syuzhet 1.0.6 to impart the limits and
               ...
               Charles Dickens’s **Our Mutual Friend****Middlemarch****Jane Eyre**
...
The term Syuzhet stems from the Russian Formalists Victor
                  Shklovsky and Vladimir Propp who divided narrative into two components, the
                     fabulasyuzhetthe latent structure of
                  narrative by means of sentiment analysisthe emotional shifts that serve as proxies for the narrative
                  movement between conflict and conflict resolution.#jockers2017b
...
The Bing, Afinn, and Syuzhet lexicons provide polarity which sorts words into
               positive or negative positions with numeric values. The Bing lexicon[^: The Bing
                  lexicon was created by Bing Liu and collaborators.][^: The
                  Afinn lexicon was created by Finn Årup Nielsen.][^: The NRC lexicon was created by
                  Saif M. Mohammad and Peter D. T]boisterous,endless,revolution.confrontannoy


![Similar results from four different lexicons](resources/images/figure02.jpg)
...
Figures 2 and 3 were created through the get_dct_transform function of Syuzhet using
               ...
               eight novels: Charles Dickens’s **Oliver Twist****Little Dorrit****Adam
                  Bede****The Mill on the Floss****Middlemarch****The Return
                  of the Native****North and
                  South****Lady Audley’s
                  Secret**


![Figure 3: Differing results from four different lexicons](resources/images/figure03.jpg)


Figure 3, however, reveals inconsistent emotional valences from four lexicons for
               eight novels: Charles Dickens’s **Our Mutual Friend****Bleak House****The
                  Woman in White****Pride and
                  Prejudice****Wuthering Heights****Jane Eyre****Villette****A Portrait of the Artist
                  as a Young Man**
...
The percent similarity for giving the same words positive or negative values between
               ...
               words avenge,enough,envyabsolute,ancient,blush
...
Despite having the same tool setting conditions, depending on the lexicon, sentiment
               ...
               not only a qualitative matteran insistently subject manner of engagement.#ramsay2011subject manner of engagement#ramsay2011
...
Syuzhet 1.0.6 has not provided a function to use custom dictionaries yet. Syuzhet
               ...
               use pre-made sentiment dictionaries, such as the psychological Harvard-IV dictionary
                  [^: See descriptions of inquirer categories and use of inquirer dictionaries:
      ]
...
The goal of opinion mining is to generate relevant information from texts for
                  ...
                  earlier) called upon the OpenNLP [^: See Apache OpenNLP developer
                     documentation: https://opennlp]openNLPdatarJava,#swafford2015good enough#jockers2015[^: See Stanford parser: http://nlp.stanford.edu:8080/parser/index.jsp.]#jockers2017aopenNLPdatarJava,
...
In table 4, I compared the parsing results from sixteen novels using Syuzhet 0.2.0
                  ...
                  Dickens’s **Our Mutual Friend**I’ll take the rest of the spell.No, no, father!#dickens1952**Middlemarch**

| Syuzhet ≤ 1.0.1 | Syuzhet ≥ 1.0.2 |
| --- | --- |
| Has Mr. Casaubon a great soul? Celia was not
                        without a touch of naive malice. | Has Mr. Casaubon a great soul? |
...
Lastly, I tested the parsing function of Syuzhet with Charles Dickens’s **Bleak House**
...
| Mrs. Rachael, I needn’t inform you who were acquainted with the late
                        ...
                        It is really of no use carrying on a deception when no object is to be
                           gained by it, said Mr. Kenge smoothly, Aunt in fact, though
                           not in law. | Mrs. Rachael, I needn’t inform you who were acquainted with the late
                           Miss Barbary’s affairs, that her means die with her and that this young
                           lady, now her aunt is dead — 
                        My aunt, sir! |
| It is really of no use carrying on a deception when no object is to
                           be gained by it, said Mr. Kenge smoothly, Aunt in fact,
                           though not in law. |


Based on the parsing result in table 7, the Textshape parser split sentences after
...
Syuzhet allocates different numeric vectors to each word/sentence based on the
                  ...
                  get_percentage_values function divides a text into an equal
                     number of chunks#jockers2017athe simpler discrete
                     cosine transformation (DCT),edge values in the smoothed version of the sentiment
                     vector#jockers2017a


I tested Syuzhet (1.0.6), SentimentAnalysis (1.3-4), sentimentr (2.7.1),
                  ...
                  the Bing lexicon, whereas VADER deploys its own lexicon.

|  | Sentences | Syuzhet | SentimentAnalysisI excluded the test results of Henry’s
                           finance-specific dictionary (HE) since they are all zero. | sentimentr | RSentiment | VADER The sentence She was happy but she is no
...
The sentiment scores of each sentence created with Syuzhet are positive, aside
                  from C. I tested B by replacing notnever,sadsadhappy


VADER and sentimentr provide functions for detecting negators (not, aren’t, no),
                  ...
                  through n-grams with high-orders based on supervised algorithms #jungetal2008She isn’t
                     happyShe is not happyToday,
                     she is not happy


Current sentiment analysis tools still need to improve through alternative
                  approaches. Lexicon-based sentiment analysis has the
                     inability to find opinion words with domain and context specific
                     orientations.#medhatetal2014
...
I selected the Syuzhet lexicon to test four different functions with Charles
               Dickens’s **Our Mutual Friend****Middlemarch****Jane Eyre****Our Mutual Friend**


![Comparison of four different functions based on the Syuzhet lexicon from
                  Charles Dickens’s Our Mutual Friend](resources/images/figure04.jpg)
...
Looking into the raw file after it was processed by the get_sentiment function using
               ...
               functions, the whole plot of **Our Mutual Friend**My Dear
                  ...
                  occasion.#dickens1952**Our Mutual Friend**This boastful handiwork of ours, which fails in its
                  ...
                  sufferer, and is a horror to the deserving and unfortunate.#dickens1952
...
![Comparison of four different functions from Book 4, Chapter 15 and 16 of Our Mutual Friend](resources/images/figure05.jpg)
...
In order to specifically examine the sentiment aspect from figure 4, I chose chapters
               ...
               with negative sentiment values, the lowest of which is (–3.5): But, not to be still further defrauded and overreached–which he would be, if
                  ...
                  warily at night, and went no more to the railway station.#dickens1952
...
Nonetheless, the foundation shapes created by the get_transformed_values and
               ...
               of chapter 15, which describes drowning–When the two were found,
                  ...
                  had relaxed, probably in falling, and his eyes were staring upward,#dickens1952when
                  a series of sentence values are combined into a larger chunk using a percentage
                  based measure, extremes of emotional valence tend to get watered down.#jockers2017a


![Comparison of four different functions based on the Syuzhet lexicon from George
                  Eliot’s Middlemarch](resources/images/figure06.jpg)


Like Dicken’s **Our Mutual Friend****Middlemarch****Middlemarch****Middlemarch****Middlemarch****Middlemarch****Middlemarch**
...
These characteristicstenacity of occupation and …
                  eagerness.ififif,affectionaffection
...
As seen in the passage above, British authors such as George Eliot, Charles Dickens,
               ...
               part which might have been considered negativepiquantlook down.**Middlemarch**


![Comparison of four different functions based on the Syuzhet lexicon from
                  Charlotte Brontë’s Jane Eyre](resources/images/figure07.jpg)


Charlotte Brontë’s **Jane Eyre****Jane Eyre****Jane Eyre**I saw Mr. Rochester shudder: a
                  ...
                  almost to distortion; but he only said — Come, be silent, Richard, and never
                     mind her gibberish: don’t repeat it,#bronte1973I wrestled with my own resolution: I wanted to be weak that I
                  ...
                  iron he would thrust her down to unsounded depths of agony,#bronte1973He [Rochester] was taken out from under the ruins,
                  ...
                  had to amputate it directly,#bronte1973**Jane Eyre**


The most negative sentence from **Jane Eyre**
...
This passage reveals that Syuzhet does not split sentences based on dashes and
               ...
               word, found,imbecileimbecileimbecile — when,


The most positive sentence from **Jane Eyre**
...
This is Jane’s positive description of Rosamond Oliver. In this part, there are 19
               ...
               be 9.8 instead of 9.05 since good-humouredgoodbut she was not profoundly interesting or thoroughly
                  impressive,not
...
Through the sentiment analysis of the three novels, the get_transformed_values and
...
Sentiment analysis has been developed with the implementation of machine learning and
               ...
               different meanings depending on the context #liu2010I am not happy to work outI am happy
                  not to work out,not[^: See MAchine Learning for LanguagE Toolkit: http://mallet.cs.umass.edu.]typically
                  pre-trained,capture general syntactical and semantic information.#doetal2019state-of-the-art performance on a large suite of sentence-level *and*#devlinetal2019#haideretal2020the real failure would not be a result that is deemed incorrectthe decision to banish#ramsay2016


It is painstaking to improve the precision, accuracy, and efficiency of digital
               ...
               for and misunderstanding of the funding necessities for DH projects by stating that
                  almost all of the works#da2019#earhartandtaylor2016


### Acknowledgements


I would like to express my appreciation to Amy Earhart, Ruihong Huang, Maura Ives,
...
Binder, J. M. (2016). **Alien Reading: Text Mining, Language Standardization, and the Humanities.****Debates in the Digital Humanities 2016,**
Brontë, C. (1973). **Jane Eyre**
Clement, T. E. (2016). **The Ground Truth of DH Text Mining.****Debates in the Digital Humanities 2016**
Da, N. Z. (2019). **The
...
Devlin, J., Chang, M. W., Lee,
               K., and Toutanova, K. (2019). **BERT: Pre-training of deep
                  bidirectional transformers for language understanding.****Proceedings of the 2019 Conference of the North American Chapter of
                  the Association for Computational Linguistics: Human Language
               Technologies**
Dickens, C. (1952). **Our Mutual Friend**
Dickens, C. (1948). **Bleak House**
Do, H. H., Prasad P. W. C., Maag A. and
               Alsadoon A. (2019). **Deep Learning for Aspect-Based Sentiment
                  Analysis: A Comparative Review.****Expert Systems with Applications**[https://doi.org/10.1016/j.eswa.2018.10.003](https://doi.org/10.1016/j.eswa.2018.10.003)
Earhart, A. E. and
               Taylor, T. L. (2016). **Pedagogies of Race: Digital Humanities in
                  the Age of Ferguson.****Debates in the Digital Humanities 2016**
Eliot, G. (1967). **Middlemarch**
Habimana, O., Li, Y., Li,
               R., Gu, X., and Yu, G. (2020). **Sentiment Analysis Using Deep
                  Learning Approaches: An Overview.****Science China Information Sciences**
Haider, T., Eger, S., Kim, E.,
               Klinger, R., and Menninghaus, W. (2020). **PO-EMO:
                  Conceptualization, Annotation, and Modeling of Aesthetic Emotions in German and
                  English Poetry.****International Conference on Language
                  Resources and Evaluation (LREC) 2020**
Jockers, M. L. (2015). Blog comment on
                  **Problems with the Syuzhet Package.****Anglophile in Academia: Annie Swafford’s Blog.**[https://annieswafford.wordpress.com/2015/03/02/syuzhet/comment-page-1/#comment-54](https://annieswafford.wordpress.com/2015/03/02/syuzhet/comment-page-1/#comment-54)
Jockers, M. L. (2017). **Introduction to the Syuzhet Package.**[https://cran.r-project.org/web/packages/syuzhet/vignettes/syuzhet-vignette.html](https://cran.r-project.org/web/packages/syuzhet/vignettes/syuzhet-vignette.html)
Jockers, M. L. (2017). **Syuzhet Package v1.0.4.****R Documentation.**[https://www.rdocumentation.org/packages/syuzhet/versions/1.0.4](https://www.rdocumentation.org/packages/syuzhet/versions/1.0.4)
Jung, Y., Choi, Y. and Myaeng, S.
               (2008). **A Study on Negation Handling and Term Weighting Schemes
                  and Their Effects on Mood-Based Text Classification.****Korean Journal of Cognitive Science**
Kim, E., and Klinger, R.
               (2018). **A Survey on Sentiment and Emotion Analysis for
                  Computational Literary Studies.****arXiv****arXiv**
Kwartler, T. (2017). **Text Mining in Practice with R**
Liu, B. (2010). **Sentiment
                  Analysis and Subjectivity.****Handbook of Natural Language Processing**[https://www.cs.uic.edu/~liub/FBS/NLP-handbook-sentiment-analysis.pdf](https://www.cs.uic.edu/~liub/FBS/NLP-handbook-sentiment-analysis.pdf)
Medhat, W., Hassan, A. and
               Korashy, H. (2014). **Sentiment Analysis Algorithms and
                  Applications: A Survey.****Ain Shams Engineering Journal**[https://doi.org/10.1016/j.asej.2014.04.011](https://doi.org/10.1016/j.asej.2014.04.011)
Misuraca, M., Forciniti,
               A., Scepi, G., and Spano, M. (2020). **Sentiment Analysis for
                  Education with R: Packages, Methods and Practical Applications.****arXiv**
...
Ramsay, S. (2016). **Humane Computation.****Debates in the Digital Humanities 2016**
Reagan, A. J., Mitchell, L.,
               Kiley, D., Danforth, C. M., and Dodds, P. S. (2016). **The
                  Emotional Arcs of Stories are Dominated by Six Basic Shapes.****EPJ Data Science**
Rhody, L. (2015). Blog comment on **Problems with the Syuzhet Package.****Anglophile in Academia: Annie Swafford’s Blog.**[https://annieswafford.wordpress.com/2015/03/02/syuzhet/comment-page-1/#comment-59](https://annieswafford.wordpress.com/2015/03/02/syuzhet/comment-page-1/#comment-59)
Sinclair, S., Ruecker, S.
               and Radzikowska, M. (2013). **Information Visualization for
                  Humanities Scholars.****Literary Studies in the Digital Age-An Evolving
                  Anthology**
Swafford, A. (2015). **Problems with the Syuzhet Package.****Anglophile in Academia: Annie Swafford’s Blog.**[https://annieswafford.wordpress.com/2015/03/02/syuzhet/](https://annieswafford.wordpress.com/2015/03/02/syuzhet/)
Underwood, T. (2014). **Theorizing Research Practices We Forgot to Theorize Twenty Years
                  Ago.****Representations**
Welch, C., and
               Mihalcea, R. (2016). **Targeted Sentiment to Understand Student
                  Comments.****Proceedings of COLING 2016, the 26th International Conference on
