...
Moreover, authorship attribution can be clearly framed as a classification
                    ...
                    contexts. Computational stylistics is an open-ended problem #craig2004*interestingness*
...
This caveat notwithstanding, we believe that our methodology, alongside other
                    ...
                    Franco Moretti #moretti2005*archive**canon*
...
Works investigating the lexical differences between authors using stylometric
                    ...
                    playwrights in #craigkinney2009#mahlberg2013*Distant
                        Reading*#moretti2005**Macroanalysis**#jockers2013#burrows2002#rybickieder2011


Sometimes collocations are extracted and analysed with concordancing tools #mahlberg2013#burrowscraig2012[^: Most well known stylometry tools offer methods for
                        dimen]
...
The two main options when trying to port multivariate analysis to syntax are the
                    following: 
                        either a top down approach to feature selection is chosen thus
                            ...
                            example see, among others, #dellorletta2011or bottom-up pattern extraction algorithms are used, which allows for
                            an open ended set of features.


These two scenarios mirror a distinction introduced by #quiniou2012*paradigmatic**syntagmatic*
...
Data is first segmented into sentences, then syntactical categories are
                    annotated by using a freely available tool, TreeTagger #schmid1994#schmid1995#stein2003
                        Le livre est sur la table.


On the PoS tagged text sequential pattern mining is applied, namely a data
                    mining technique introduced by #agrawalsrikant1995#quiniou2012[^: EREMOS  was developed
...
Thus correspondence analysis is then performed as follows: 
                        pattern vectors from all texts under analysis are imported into one
                            ...
                            frequencies into relative ones.correspondence analysis is performed using the FactoMiner tool for R
                                #husson2011contributions are extracted for each patternfiltering of pattern is performedplots and result tables are printed


Correspondence analysis (CA) is a dimensionality reduction technique developed
                    by Jean Paul Benzécri (#benzecri1977#greenacre2007#lebart1998
...
Patterns indicating a certain style in punctuation should always be taken
                        ...
                        guidelines. Nevertheless Mangiapane #mangiapane2012
...
Other interestingness measures besides correspondence analysis have been tested,
                    ...
                    same text #boukhaled2015a#boukhaled2015b
...
New experiments using this methodology on a number of other texts have been
                    ...
                    aspects of characterization in Molière's plays (#frontini2015a#frontini2015b#frontinibenard2015#frontini2015
