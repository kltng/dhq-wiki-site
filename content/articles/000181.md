...
For example, formal linguistic research into translations, paraphrases, and other
               ...
               preparatory stages for so-called bitext alignment are notoriously time-consuming #tiedemann2011
...
In antiquity, cross-referencing and text segmenting were two unrelated activities.
               ...
               poems, e.g., the **Iliad****Histories**#demoorandkorpel2007#porter2007#korpelandoesch2005#dehoopetal2009[^: The best
...
The use of numbers or letters, instead of symbols, so that sub-book units could be
               ...
               period, with the numbering of Greek lyric poetry #higbie2010#yarchinforthcoming*titloi**kephalaia*#wallraff2013#zola2012[^: My position
...
Segmenting and numbering works developed only sporadically and piecemeal through the
               ...
               locales, particularly thirteenth-century Paris #vanBanning2007#rouse2000#moore1893[^: Eusebius's canon tables are the best-attested early example (Eusebius,
         ]#zola2012
...
Ancient texts critically edited in the modern era are pinned to the scaffolding of
               ...
               sense Eusebius used κανών #wallraff2013*ought**list*
...
Canonical numbering systems are also fertile. They can change with new versions or
           ...
           ]#yarchinforthcoming**Commentary on the Psalms****Homilies on the Psalms****Dial. Tryph.**[^: Justin is also the earliest attested author to unambiguously and
               ]
...
Furnishing an electronic text with machine-actionable canonical numbers is easy, at
               ...
               (TEI) files, but documentation for `@cRef`#teiconsortium2.6.0`@cRef``@cref``data.text``<ref
...
These difficulties have been addressed by Canonical Text Services (CTS), part of a
               ...
               the name of the larger project, CITE).[^: Material in this section derives from a
                  ...
                  hierarchy of content objects*are*#smith2009#deroseetal1997
...
The third element in the URN, `greekLit`naming authoritynamespacesubnamespacenamespace#smith2009[^: See previous note.]


The fourth part, `tlg0012.tlg001`work componentanalogous to the hierarchy of the
                  Functional Requirements for Bibliographic Recordsr (FRBR).#smithandblackwell2012`tlg0012``tlg001`**Iliad**[^: CTS treats the first segment, called
                     collection or text gro]`tlg`#berkowitzetal1990[^: The two-part, seven-digit (xxxx.yyy) TLG
...
The fifth part of the CTS-URN, called the passage component`1.26``1.26-1.28`at`@ἐγὼ[1]`**Iliad**#smithandblackwell2012[^: By definition
...
FRBR describes Group 1 (creative artefacts) as a hierarchy of four entities,
               described top down as workexpressionmanifestationitemWEMIworka distinct intellectual or artistic creationan abstract entity#ifla2008**Iliad**expressionthe
...
Some points of comparison between FRBR and scholarly practice are tempting to
               ...
               FRBR #smith2009#ifla2008[^: FRBR 3.3: The structure of the model, however,
...
But the upper half is oftentimes not well understood, and precision can be
               problematic #peponakis2012#ifla2008
...
Semantic numbering schemes also have enormous potential for specificity. In theory,
               ...
               words, letters, and accents. For example, one could coin Arist., **Cat.**
                  **Categories**firstly#manningandschuetze1999#zwickyandpullum1983
