...
large enough to hold everyone who’s still in the water the perspective on
the Big Tent,tent[^: Bryan Alexander and Rebecca Frost Davis (2012)
...
humanities that takes place in the centers of gravity,
...
scaffolds, and money[^: For more articles that
...
paradigms career advance, to spark
research collaborations, or even lead to future employment

A more recent paper by Ayesha I.T. Tulloch are important for
...
Márton Demeter on inequalities in knowledge production ]
...
other agents[^: As recently as the
...
bilingual city in unceded Algonquin territory[^: Please see the full CFPs, archived at Laura
...
scholarship and teaching ** Focus on Africa ** open up the
...
really empower underrepresented communities perspectives from Africa
on Africa
...
the [ConfTool](https://www.conftool.net/)
...
for each paper (so not the best papers for each reviewer) processmatching topics according to
...
gender, there is also ] of the patriarchs[See Figure 1]()

![The Parade of Patriarchs Tweet by Steve Leahy](resources/images/figure01.jpg)

We used a Content Analysis recursive methodology
...
field of digital humanities itself has an English problem[^: For more on the (lack of)
multilingualism in digital humanities: , , , and] actively toward the creation of a more diverse,
...
(German, Italian, French and Spanish) primary language
...
conference but also underscored how equity and diversity are multiplex[^: GO::DH’s stated mission is to help break down barriers that hinder
commun]
...
and printed translation costs, accessibility measures ([see below]()
...
appearing in more conferences and events and are ava]
...
sharing which might supersede the in-person event manualdigital
...
Theory ** Bringing Languages into the DH Classroom.** Debates in Digital Humanities Pedagogy **
