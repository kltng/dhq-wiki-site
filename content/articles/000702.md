...
abstractions such as `sum()``average()`
...
highlighted or displayed is a performance usually analyzed

Schechner famously defines performance as restored
behaviortwice-behaved behavior,oncenessbroken down finely enough and analyzed,are revealed as restored behaviors
...
materially heterogeneous,a source of action that can be either
...
solution can then be transformed into physical hardware
...
puppet wants to do concept of letting the
object determine action
...
Platypus was announced to the world in November, 2020 ( Platypus
attack
...
general term for this kind of attack is Differential Power Analysis
