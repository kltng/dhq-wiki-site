...
The ease with which a user can get a CMS installed and running, particularly with the
            help of one-click installers#graham2019#logan2017#vellosolyons2021[^: In this paper, scholar is used to refer to an individual whose
               pr]*someone *
...
It is not surprising then that enthusiasm for building websites using minimal computing
            ...
            #gibbs2015[^: Contrast, for instance, the work
...
The questionable longevity of web-based projects is a common concern, particularly for
            ...
            genres #goddard2019*finish*#lincoln
...
An examination of the agenda for digital humanities workshops that *have *reconcil[ing] cultural analytics
            and research architectures with struggles for justice #gil2018#dh2016#grguric2019minimal#kashyap2017
...
In the case of minimal computing consultation, it is difficult to avoid an undercurrent
            ...
            Jekyll-based site relaunch #visconti2019should#visconti2021
...
Minimal computing is offered as a solution to multiple problems, both distinct and
            overlapping #sayers2016minimal


If the primary concern is a techno-aesthetic experiment, stripping down common tools and
            processes to the minimum of what we actually need#gil2015#gil2019
...
Creating web-based resources that do not require ongoing upkeep to remain functional —
            ...
            holy grail of digital humanities #nowviskie2010#smithies2019bells and whistlesWhat is the least amount that we need?What is the most we can do that can still be preserved?#weingart2019


### Maximizing Infrastructure for Minimal Computing


Digital humanities initiatives that have self-identified as infrastructure#dombrowski2014
...
Infrastructure need not be primarily technical. Descriptions and flowcharts about where
            ...
            difference in facilitating scholars’ independent use of minimal computing practices. The
               **Programming Historian****Building a Static Website
                  with Jekyll and GitHub Pages**#visconti2016
...
Another highly scalable form of infrastructure is detailed documentation, ideally using
            ...
            typical forms of scholarly projects as the basis for examples (as in #visconti2020


Ed ([https://elotroalex.github.io/ed/](https://elotroalex.github.io/ed/)[https://minicomp.github.io/wax/](https://minicomp.github.io/wax/)*must**must*#lincoln2021a#lincoln2021b**How Did They Make That?**#posner2013
...
## Notes & References
 ...
 Cavanaugh, Erica and Quinn Dombrowski. **Personal Entanglements
               and Graceful Relationship Degradation in Collaborative Projects.****Revealing Meaning: Feminist Methods in Digital Scholarship**
 **Minimal Computing: A Workshop.****DH 2016 Book of Abstracts**[https://dh2016.adho.org/abstracts/304](https://dh2016.adho.org/abstracts/304)
